...
export class MaskingPolicyGrant extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MaskingPolicyGrantState, opts?: pulumi.CustomResourceOptions): MaskingPolicyGrant {
        return new MaskingPolicyGrant(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'snowflake:index/maskingPolicyGrant:MaskingPolicyGrant';

    /**
     * Returns true if the given object is an instance of MaskingPolicyGrant.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is MaskingPolicyGrant {
