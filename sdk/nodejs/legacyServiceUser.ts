 ...
 *
 * > **Note** Other two user types are handled in separate resources: `snowflake.ServiceUser` for user type `service` and `snowflake.User` for user type `person`.
 *
 ...
 */
export class LegacyServiceUser extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LegacyServiceUserState, opts?: pulumi.CustomResourceOptions): LegacyServiceUser {
        return new LegacyServiceUser(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'snowflake:index/legacyServiceUser:LegacyServiceUser';

    /**
     * Returns true if the given object is an instance of LegacyServiceUser.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LegacyServiceUser {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === LegacyServiceUser.__pulumiType;
    }
     ...
     */
    declare public readonly defaultNamespace: pulumi.Output<string | undefined>;
    /**
     ...
     */
    declare public readonly defaultSecondaryRolesOption: pulumi.Output<string | undefined>;
    /**
     ...
     */
    declare public readonly defaultWorkloadIdentity: pulumi.Output<outputs.LegacyServiceUserDefaultWorkloadIdentity | undefined>;
    /**
     ...
     */
    declare public readonly loginName: pulumi.Output<string | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly parameters: pulumi.Output<outputs.LegacyServiceUserParameter[]>;
    /**
     ...
     */
    declare public /*out*/ readonly showOutputs: pulumi.Output<outputs.LegacyServiceUserShowOutput[]>;
    /**
     ...
     */
    constructor(name: string, args?: LegacyServiceUserArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: LegacyServiceUserArgs | LegacyServiceUserState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LegacyServiceUserState | undefined;
            ...
            const args = argsOrState as LegacyServiceUserArgs | undefined;
        ...
        const secretOpts = { additionalSecretOutputs: ["email", "loginName", "password"] };
        opts = pulumi.mergeOptions(opts, secretOpts);
        super(LegacyServiceUser.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface LegacyServiceUserState {
    /**
     * Specifies the action that Snowflake performs for in-progress queries if connectivity is lost due to abrupt termination of a session (e.g. network outage, browser termination, service interruption). For more information, check [ABORT*DETACHED*QUERY docs](https://docs.snowflake.com/en/sql-reference/parameters#abort-detached-query).
     */
     ...
     * (Default: `DEFAULT`) Specifies the secondary roles that are active for the user’s session upon login. Valid values are (case-insensitive): `DEFAULT` | `NONE` | `ALL`. More information can be found in [doc](https://docs.snowflake.com/en/sql-reference/sql/create-user#optional-object-properties-objectproperties).
     */
    defaultSecondaryRolesOption?: pulumi.Input<string | undefined>;
    /**
     * Specifies the virtual warehouse that is active by default for the user’s session upon login. Note that the CREATE USER operation does not verify that the warehouse exists. For more information about this resource, see docs.
     */
     ...
     * Configures the default workload identity for the user. This is used for workload identity federation to allow third-party services to authenticate as this user. Only applicable for service users and legacy service users. This field can be only used when `USER_ENABLE_DEFAULT_WORKLOAD_IDENTITY` option is specified in provider block in the `experimentalFeaturesEnabled` field. If this feature is not enabled, attempting to set this field will result in an error. The provider will not get WIF information from Snowflake.
     */
    defaultWorkloadIdentity?: pulumi.Input<inputs.LegacyServiceUserDefaultWorkloadIdentity | undefined>;
    /**
     * (Default: fallback to Snowflake default - uses special value that cannot be set in the configuration manually (`default`)) Specifies whether the user is disabled, which prevents logging in and aborts all the currently-running queries for the user. Available options are: "true" or "false". When the value is not set in the configuration the provider will put "default" there which means to use the Snowflake default for this value.
     */
     ...
     * (Default: fallback to Snowflake default - uses special value that cannot be set in the configuration manually (`-1`)) Specifies the number of minutes until the temporary lock on the user login is cleared. To protect against unauthorized user login, Snowflake places a temporary lock on a user after five consecutive unsuccessful login attempts. When creating a user, this property can be set to prevent them from logging in until the specified amount of time passes. To remove a lock immediately for a user, specify a value of 0 for this parameter. **Note** because this value changes continuously after setting it, the provider is currently NOT handling the external changes to it. External changes for this field won't be detected. In case you want to apply external changes, you can re-create the resource manually using "terraform taint".
     */
    minsToUnlock?: pulumi.Input<number | undefined>;
    /**
     * Number of statements to execute when using the multi-statement capability. For more information, check [MULTI*STATEMENT*COUNT docs](https://docs.snowflake.com/en/sql-reference/parameters#multi-statement-count).
     */
     ...
     * Outputs the result of `SHOW PARAMETERS IN USER` for the given user.
     */
    parameters?: pulumi.Input<pulumi.Input<inputs.LegacyServiceUserParameter>[] | undefined>;
    /**
     * Password for the user. **WARNING:** this will put the password in the terraform state file. Use carefully. External changes for this field won't be detected. In case you want to apply external changes, you can re-create the resource manually using "terraform taint".
     */
     ...
     * Outputs the result of `SHOW USER` for the given user.
     */
    showOutputs?: pulumi.Input<pulumi.Input<inputs.LegacyServiceUserShowOutput>[] | undefined>;
    /**
     * Specifies the name of a consumer account to simulate for testing/validating shared data, particularly shared secure views. When this parameter is set in a session, shared views return rows as if executed in the specified consumer account rather than the provider account. For more information, see [Introduction to Secure Data Sharing](https://docs.snowflake.com/en/user-guide/data-sharing-intro) and [Working with shares](https://docs.snowflake.com/en/user-guide/data-sharing-provider). For more information, check [SIMULATED*DATA*SHARING_CONSUMER docs](https://docs.snowflake.com/en/sql-reference/parameters#simulated-data-sharing-consumer).
     */
 ...
 */
export interface LegacyServiceUserArgs {
    /**
     * Specifies the action that Snowflake performs for in-progress queries if connectivity is lost due to abrupt termination of a session (e.g. network outage, browser termination, service interruption). For more information, check [ABORT*DETACHED*QUERY docs](https://docs.snowflake.com/en/sql-reference/parameters#abort-detached-query).
     */
    abortDetachedQuery?: pulumi.Input<boolean | undefined>;
