...
export class ProcedureScala extends pulumi.CustomResource {
     ...
     */
    public readonly arguments!: pulumi.Output<outputs.ProcedureScalaArgument[] | undefined>;
    /**
     ...
     */
    public readonly imports!: pulumi.Output<outputs.ProcedureScalaImport[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly parameters!: pulumi.Output<outputs.ProcedureScalaParameter[]>;
    /**
     ...
     */
    public readonly secrets!: pulumi.Output<outputs.ProcedureScalaSecret[] | undefined>;
    /**
     * Outputs the result of `SHOW PROCEDURE` for the given procedure.
     */
    public /*out*/ readonly showOutputs!: pulumi.Output<outputs.ProcedureScalaShowOutput[]>;
    /**
     ...
     * Use the fully qualified name of the method or function for the stored procedure. This is typically in the following form: `com.my_company.my_package.MyClass.myMethod` where `com.my_company.my_package` corresponds to the package containing the object or class: `package com.my_company.my_package;`.
     */
    public readonly targetPath!: pulumi.Output<outputs.ProcedureScalaTargetPath | undefined>;
    /**
