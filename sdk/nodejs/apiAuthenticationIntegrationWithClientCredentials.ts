...
export interface ApiAuthenticationIntegrationWithClientCredentialsState {
     ...
     * Outputs the result of `DESCRIBE SECURITY INTEGRATIONS` for the given security integration.
     */
    describeOutputs?: pulumi.Input<pulumi.Input<inputs.ApiAuthenticationIntegrationWithClientCredentialsDescribeOutput>[] | undefined>;
    /**
     * Specifies whether this security integration is enabled or disabled.
     */
     ...
     * Outputs the result of `SHOW SECURITY INTEGRATIONS` for the given security integration.
     */
    showOutputs?: pulumi.Input<pulumi.Input<inputs.ApiAuthenticationIntegrationWithClientCredentialsShowOutput>[] | undefined>;
}
