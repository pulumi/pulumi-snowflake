 ...
 * ```
 */
export class FileFormatOrc extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FileFormatOrcState, opts?: pulumi.CustomResourceOptions): FileFormatOrc {
        return new FileFormatOrc(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'snowflake:index/fileFormatOrc:FileFormatOrc';

    /**
     * Returns true if the given object is an instance of FileFormatOrc.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FileFormatOrc {
     ...
     */
    declare public /*out*/ readonly describeOutputs: pulumi.Output<outputs.FileFormatOrcDescribeOutput[]>;
    /**
     ...
     */
    declare public /*out*/ readonly showOutputs: pulumi.Output<outputs.FileFormatOrcShowOutput[]>;
    /**
    ...
    constructor(name: string, argsOrState?: FileFormatOrcArgs | FileFormatOrcState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FileFormatOrcState | undefined;
            ...
            const args = argsOrState as FileFormatOrcArgs | undefined;
