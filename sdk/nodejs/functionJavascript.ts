 ...
 */
export class FunctionJavascript extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FunctionJavascriptState, opts?: pulumi.CustomResourceOptions): FunctionJavascript {
        return new FunctionJavascript(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'snowflake:index/functionJavascript:FunctionJavascript';

    /**
     * Returns true if the given object is an instance of FunctionJavascript.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FunctionJavascript {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === FunctionJavascript.__pulumiType;
    }
     ...
     */
    declare public readonly arguments: pulumi.Output<outputs.FunctionJavascriptArgument[] | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly parameters: pulumi.Output<outputs.FunctionJavascriptParameter[]>;
    /**
     ...
     */
    declare public /*out*/ readonly showOutputs: pulumi.Output<outputs.FunctionJavascriptShowOutput[]>;
    /**
     ...
     */
    constructor(name: string, args: FunctionJavascriptArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: FunctionJavascriptArgs | FunctionJavascriptState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FunctionJavascriptState | undefined;
            ...
            const args = argsOrState as FunctionJavascriptArgs | undefined;
        ...
        super(FunctionJavascript.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface FunctionJavascriptState {
    /**
     * List of the arguments for the function. Consult the [docs](https://docs.snowflake.com/en/sql-reference/sql/create-function#all-languages) for more details.
     */
    arguments?: pulumi.Input<pulumi.Input<inputs.FunctionJavascriptArgument>[] | undefined>;
    /**
     * (Default: `user-defined function`) Specifies a comment for the function.
     */
     ...
     * Outputs the result of `SHOW PARAMETERS IN FUNCTION` for the given function.
     */
    parameters?: pulumi.Input<pulumi.Input<inputs.FunctionJavascriptParameter>[] | undefined>;
    /**
     * Specifies the behavior of the function when returning results. Valid values are (case-insensitive): `VOLATILE` | `IMMUTABLE`.
     */
     ...
     * Outputs the result of `SHOW FUNCTION` for the given function.
     */
    showOutputs?: pulumi.Input<pulumi.Input<inputs.FunctionJavascriptShowOutput>[] | undefined>;
    /**
     * Trace level value to use when generating/filtering trace events For more information, check [TRACE_LEVEL docs](https://docs.snowflake.com/en/sql-reference/parameters#trace-level).
     */
 ...
 */
export interface FunctionJavascriptArgs {
    /**
     * List of the arguments for the function. Consult the [docs](https://docs.snowflake.com/en/sql-reference/sql/create-function#all-languages) for more details.
     */
    arguments?: pulumi.Input<pulumi.Input<inputs.FunctionJavascriptArgument>[] | undefined>;
