 ...
 * ```
 */
export class FileFormatParquet extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FileFormatParquetState, opts?: pulumi.CustomResourceOptions): FileFormatParquet {
        return new FileFormatParquet(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'snowflake:index/fileFormatParquet:FileFormatParquet';

    /**
     * Returns true if the given object is an instance of FileFormatParquet.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FileFormatParquet {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === FileFormatParquet.__pulumiType;
    }
     ...
     */
    declare public readonly binaryAsText: pulumi.Output<string | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly describeOutputs: pulumi.Output<outputs.FileFormatParquetDescribeOutput[]>;
    /**
     ...
     */
    declare public /*out*/ readonly showOutputs: pulumi.Output<outputs.FileFormatParquetShowOutput[]>;
    /**
     ...
     */
    declare public readonly useLogicalType: pulumi.Output<string | undefined>;
    /**
     ...
     */
    declare public readonly useVectorizedScanner: pulumi.Output<string | undefined>;
     ...
     */
    constructor(name: string, args: FileFormatParquetArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: FileFormatParquetArgs | FileFormatParquetState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FileFormatParquetState | undefined;
            ...
            resourceInputs["useLogicalType"] = state?.useLogicalType;
            resourceInputs["useVectorizedScanner"] = state?.useVectorizedScanner;
        } else {
            const args = argsOrState as FileFormatParquetArgs | undefined;
            ...
            resourceInputs["useLogicalType"] = args?.useLogicalType;
            resourceInputs["useVectorizedScanner"] = args?.useVectorizedScanner;
        ...
        super(FileFormatParquet.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface FileFormatParquetState {
    /**
     * (Default: fallback to Snowflake default - uses special value that cannot be set in the configuration manually (`default`)) Boolean that specifies whether to interpret columns with no defined logical data type as UTF-8 text. Available options are: "true" or "false". When the value is not set in the configuration the provider will put "default" there which means to use the Snowflake default for this value.
     */
     ...
     * Outputs the result of `DESCRIBE FILE FORMAT` for this file format.
     */
    describeOutputs?: pulumi.Input<pulumi.Input<inputs.FileFormatParquetDescribeOutput>[] | undefined>;
    /**
     * Fully qualified name of the resource. For more information, see [object name resolution](https://docs.snowflake.com/en/sql-reference/name-resolution).
     */
     ...
     * Outputs the result of `SHOW FILE FORMATS` for this file format.
     */
    showOutputs?: pulumi.Input<pulumi.Input<inputs.FileFormatParquetShowOutput>[] | undefined>;
    /**
     * (Default: fallback to Snowflake default - uses special value that cannot be set in the configuration manually (`default`)) Boolean that specifies whether to remove white space from fields. Available options are: "true" or "false". When the value is not set in the configuration the provider will put "default" there which means to use the Snowflake default for this value.
     */
 ...
 */
export interface FileFormatParquetArgs {
    /**
     * (Default: fallback to Snowflake default - uses special value that cannot be set in the configuration manually (`default`)) Boolean that specifies whether to interpret columns with no defined logical data type as UTF-8 text. Available options are: "true" or "false". When the value is not set in the configuration the provider will put "default" there which means to use the Snowflake default for this value.
     */
    binaryAsText?: pulumi.Input<string | undefined>;
