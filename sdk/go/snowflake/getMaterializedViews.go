...
func (o GetMaterializedViewsResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetMaterializedViewsResult] {
	return pulumix.Output[GetMaterializedViewsResult]{
