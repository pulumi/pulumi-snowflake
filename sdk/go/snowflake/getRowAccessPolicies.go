...
func (o GetRowAccessPoliciesResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetRowAccessPoliciesResult] {
	return pulumix.Output[GetRowAccessPoliciesResult]{
