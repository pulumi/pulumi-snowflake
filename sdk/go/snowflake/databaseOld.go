...
//			_, err := snowflake.NewDatabaseOld(ctx, "simple", &snowflake.DatabaseOldArgs{
...
//				return err
//			}
//			_, err = snowflake.NewDatabaseOld(ctx, "with_replication", &snowflake.DatabaseOldArgs{
...
//				return err
//			}
//			_, err = snowflake.NewDatabaseOld(ctx, "from_replica", &snowflake.DatabaseOldArgs{
...
//				return err
//			}
//			_, err = snowflake.NewDatabaseOld(ctx, "from_share", &snowflake.DatabaseOldArgs{
