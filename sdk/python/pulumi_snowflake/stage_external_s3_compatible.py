...
__all__ = ['StageExternalS3CompatibleArgs', 'StageExternalS3Compatible']

@pulumi.input_type
class StageExternalS3CompatibleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['StageExternalS3CompatibleDirectoryArgs'] directory: Directory tables store a catalog of staged files in cloud storage.
        :param pulumi.Input['StageExternalS3CompatibleFileFormatArgs'] file_format: Specifies the file format for the stage.
...
class _StageExternalS3CompatibleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['StageExternalS3CompatibleCredentialsArgs'] credentials: Specifies the AWS credentials for the S3-compatible external stage.
        :param pulumi.Input[_builtins.str] database: The database in which to create the stage. Due to technical limitations (read more here), avoid using the following characters: `|`, `.`, `"`.
        :param pulumi.Input[Sequence[pulumi.Input['StageExternalS3CompatibleDescribeOutputArgs']]] describe_outputs: Outputs the result of `DESCRIBE STAGE` for the given stage.
        :param pulumi.Input['StageExternalS3CompatibleDirectoryArgs'] directory: Directory tables store a catalog of staged files in cloud storage.
        :param pulumi.Input[_builtins.str] endpoint: Specifies the endpoint for the S3-compatible storage provider.
        :param pulumi.Input['StageExternalS3CompatibleFileFormatArgs'] file_format: Specifies the file format for the stage.
        ...
        :param pulumi.Input[_builtins.str] name: Specifies the identifier for the stage; must be unique for the database and schema in which the stage is created. Due to technical limitations (read more here), avoid using the following characters: `|`, `.`, `"`.
        :param pulumi.Input[_builtins.str] schema: The schema in which to create the stage. Due to technical limitations (read more here), avoid using the following characters: `|`, `.`, `"`.
        :param pulumi.Input[Sequence[pulumi.Input['StageExternalS3CompatibleShowOutputArgs']]] show_outputs: Outputs the result of `SHOW STAGES` for the given stage.
...
@pulumi.type_token("snowflake:index/stageExternalS3Compatible:StageExternalS3Compatible")
class StageExternalS3Compatible(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: StageExternalS3CompatibleArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        !> **Caution: Preview Feature** This feature is considered a preview feature in the provider, regardless of the state of the resource in Snowflake. We do not guarantee its stability. It will be reworked and marked as a stable feature in future releases. Breaking changes are expected, even without bumping the major version. To use this feature, add the relevant feature name to `preview_features_enabled` field in the provider configuration. Please always refer to the Getting Help section in our Github repo to best determine how to get help for your questions.
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(StageExternalS3CompatibleArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = StageExternalS3CompatibleArgs.__new__(StageExternalS3CompatibleArgs)
        ...
        super(StageExternalS3Compatible, __self__).__init__(
    ...
    def get(resource_name: str,
        ...
        __props__ = _StageExternalS3CompatibleState.__new__(_StageExternalS3CompatibleState)
        ...
        __props__.__dict__["url"] = url
        return StageExternalS3Compatible(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def credentials(self) -> pulumi.Output[Optional['outputs.StageExternalS3CompatibleCredentials']]:
        """
        Specifies the AWS credentials for the S3-compatible external stage.
        """
        return pulumi.get(self, "credentials")
    ...
    @_builtins.property
    @pulumi.getter(name="describeOutputs")
    def describe_outputs(self) -> pulumi.Output[Sequence['outputs.StageExternalS3CompatibleDescribeOutput']]:
        """
        Outputs the result of `DESCRIBE STAGE` for the given stage.
        """
        return pulumi.get(self, "describe_outputs")
    ...
    @_builtins.property
    @pulumi.getter
    def directory(self) -> pulumi.Output[Optional['outputs.StageExternalS3CompatibleDirectory']]:
        """
        Directory tables store a catalog of staged files in cloud storage.
        """
        return pulumi.get(self, "directory")
    ...
    @_builtins.property
    @pulumi.getter(name="fileFormat")
    def file_format(self) -> pulumi.Output[Optional['outputs.StageExternalS3CompatibleFileFormat']]:
        """
        Specifies the file format for the stage.
        """
        return pulumi.get(self, "file_format")
    ...
    @_builtins.property
    @pulumi.getter(name="showOutputs")
    def show_outputs(self) -> pulumi.Output[Sequence['outputs.StageExternalS3CompatibleShowOutput']]:
        """
        Outputs the result of `SHOW STAGES` for the given stage.
        """
        return pulumi.get(self, "show_outputs")
