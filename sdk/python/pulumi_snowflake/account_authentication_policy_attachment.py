...
class AccountAuthenticationPolicyAttachmentArgs:
    def __init__(__self__, *,
                 authentication_policy: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a AccountAuthenticationPolicyAttachment resource.
        :param pulumi.Input[builtins.str] authentication_policy: Qualified name (`"db"."schema"."policy_name"`) of the authentication policy to apply to the current account.
        """
        pulumi.set(__self__, "authentication_policy", authentication_policy)

    @property
    @pulumi.getter(name="authenticationPolicy")
    def authentication_policy(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def authentication_policy(self, value: pulumi.Input[builtins.str]):
...
class AccountAuthenticationPolicyAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            authentication_policy: Optional[pulumi.Input[builtins.str]] = None) -> 'AccountAuthenticationPolicyAttachment':
        """
