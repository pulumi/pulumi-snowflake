...
class ProcedureScalaArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] runtime_version: The language runtime version to use. Currently, the supported versions are: 2.12.
...
class ProcedureScala(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            snowpark_package: Optional[pulumi.Input[str]] = None,
            target_path: Optional[pulumi.Input[Union['ProcedureScalaTargetPathArgs', 'ProcedureScalaTargetPathArgsDict']]] = None,
            trace_level: Optional[pulumi.Input[str]] = None) -> 'ProcedureScala':
        """
