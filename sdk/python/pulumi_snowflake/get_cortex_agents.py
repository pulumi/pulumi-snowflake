...
__all__ = [
    'GetCortexAgentsResult',
    'AwaitableGetCortexAgentsResult',
    'get_cortex_agents',
    'get_cortex_agents_output',
]

@pulumi.output_type
class GetCortexAgentsResult:
    """
    A collection of values returned by getCortexAgents.
    """
    def __init__(__self__, cortex_agents=None, id=None, in_=None, like=None, limit=None, starts_with=None, with_describe=None):
        if cortex_agents and not isinstance(cortex_agents, list):
            raise TypeError("Expected argument 'cortex_agents' to be a list")
        pulumi.set(__self__, "cortex_agents", cortex_agents)
    ...
    @_builtins.property
    @pulumi.getter(name="cortexAgents")
    def cortex_agents(self) -> Sequence['outputs.GetCortexAgentsCortexAgentResult']:
        """
        Holds the aggregated output of all cortex agent details queries.
        """
        return pulumi.get(self, "cortex_agents")
    ...
    def in_(self) -> Optional['outputs.GetCortexAgentsInResult']:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def limit(self) -> Optional['outputs.GetCortexAgentsLimitResult']:
        """
...
class AwaitableGetCortexAgentsResult(GetCortexAgentsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCortexAgentsResult(
            cortex_agents=self.cortex_agents,
            id=self.id,
            in_=self.in_,
            like=self.like,
            limit=self.limit,
...
def get_cortex_agents(in_: Optional[Union['GetCortexAgentsInArgs', 'GetCortexAgentsInArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('snowflake:index/getCortexAgents:getCortexAgents', __args__, opts=opts, typ=GetCortexAgentsResult).value

    return AwaitableGetCortexAgentsResult(
        cortex_agents=pulumi.get(__ret__, 'cortex_agents'),
...
def get_cortex_agents_output(in_: pulumi.Input[Optional[Optional[Union['GetCortexAgentsInArgs', 'GetCortexAgentsInArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('snowflake:index/getCortexAgents:getCortexAgents', __args__, opts=opts, typ=GetCortexAgentsResult)
    return __ret__.apply(lambda __response__: GetCortexAgentsResult(
        cortex_agents=pulumi.get(__response__, 'cortex_agents'),
