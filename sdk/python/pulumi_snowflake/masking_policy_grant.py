...
class MaskingPolicyGrantArgs:
    def __init__(__self__, *,
        ...
        """
        MaskingPolicyGrantArgs._configure(
    ...
    def _configure(
        ...
        if masking_policy_name is None and 'maskingPolicyName' in kwargs:
            masking_policy_name = kwargs['maskingPolicyName']
        if masking_policy_name is None:
            raise TypeError("Missing 'masking_policy_name' argument")
...
class _MaskingPolicyGrantState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] with_grant_option: When this is set to true, allows the recipient role to grant the privileges to other roles.
        """
        _MaskingPolicyGrantState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            database_name=database_name,
            enable_multiple_grants=enable_multiple_grants,
            masking_policy_name=masking_policy_name,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            MaskingPolicyGrantArgs._configure(_setter, **kwargs)
