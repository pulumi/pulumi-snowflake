...
class ViewGrantArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] on_future: When this is set to true and a schema_name is provided, apply this grant on all future views in the given schema. When
