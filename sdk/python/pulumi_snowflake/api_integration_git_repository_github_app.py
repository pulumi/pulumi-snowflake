...
__all__ = ['ApiIntegrationGitRepositoryGithubAppArgs', 'ApiIntegrationGitRepositoryGithubApp']

@pulumi.input_type
class ApiIntegrationGitRepositoryGithubAppArgs:
...
@pulumi.input_type
class _ApiIntegrationGitRepositoryGithubAppState:
    def __init__(__self__, *,
                 api_allowed_prefixes: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 api_blocked_prefixes: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 comment: pulumi.Input[Optional[_builtins.str]] = None,
                 describe_outputs: pulumi.Input[Optional[Sequence[pulumi.Input['ApiIntegrationGitRepositoryGithubAppDescribeOutputArgs']]]] = None,
                 enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 fully_qualified_name: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 show_outputs: pulumi.Input[Optional[Sequence[pulumi.Input['ApiIntegrationGitRepositoryGithubAppShowOutputArgs']]]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] api_blocked_prefixes: Lists the endpoints and resources in the HTTPS proxy service that are not allowed to be called from Snowflake.
        :param pulumi.Input[_builtins.str] comment: Specifies a comment for the integration.
        :param pulumi.Input[Sequence[pulumi.Input['ApiIntegrationGitRepositoryGithubAppDescribeOutputArgs']]] describe_outputs: Outputs the result of `DESCRIBE API INTEGRATION` for the given integration.
        :param pulumi.Input[_builtins.bool] enabled: Specifies whether this API integration is enabled or disabled.
        :param pulumi.Input[_builtins.str] fully_qualified_name: Fully qualified name of the resource. For more information, see [object name resolution](https://docs.snowflake.com/en/sql-reference/name-resolution).
        :param pulumi.Input[_builtins.str] name: Specifies the identifier (i.e. name) for the integration. This value must be unique in your account. Due to technical limitations (read more here), avoid using the following characters: `|`, `.`, `"`.
        :param pulumi.Input[Sequence[pulumi.Input['ApiIntegrationGitRepositoryGithubAppShowOutputArgs']]] show_outputs: Outputs the result of `SHOW API INTEGRATIONS` for the given integration.
        """
    ...
    def describe_outputs(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ApiIntegrationGitRepositoryGithubAppDescribeOutputArgs']]]]:
        """
    ...
    def describe_outputs(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ApiIntegrationGitRepositoryGithubAppDescribeOutputArgs']]]]):
    ...
    def show_outputs(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ApiIntegrationGitRepositoryGithubAppShowOutputArgs']]]]:
        """
    ...
    @show_outputs.setter
    def show_outputs(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ApiIntegrationGitRepositoryGithubAppShowOutputArgs']]]]):
        pulumi.set(self, "show_outputs", value)


@pulumi.type_token("snowflake:index/apiIntegrationGitRepositoryGithubApp:ApiIntegrationGitRepositoryGithubApp")
class ApiIntegrationGitRepositoryGithubApp(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: ApiIntegrationGitRepositoryGithubAppArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        > **Caution: Preview Feature** This feature is considered a preview feature in the provider, regardless of the state of the resource in Snowflake. We do not guarantee its stability. It will be reworked and marked as a stable feature in future releases. Breaking changes are expected, even without bumping the major version. To use this feature, add the relevant feature name to `preview_features_enabled` field in the provider configuration. Please always refer to the Getting Help section in our Github repo to best determine how to get help for your questions.
        ...
        :param str resource_name: The name of the resource.
        :param ApiIntegrationGitRepositoryGithubAppArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ApiIntegrationGitRepositoryGithubAppArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ApiIntegrationGitRepositoryGithubAppArgs.__new__(ApiIntegrationGitRepositoryGithubAppArgs)
        ...
        super(ApiIntegrationGitRepositoryGithubApp, __self__).__init__(
    ...
    def get(resource_name: str,
        ...
        __props__ = _ApiIntegrationGitRepositoryGithubAppState.__new__(_ApiIntegrationGitRepositoryGithubAppState)
        ...
        return ApiIntegrationGitRepositoryGithubApp(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="describeOutputs")
    def describe_outputs(self) -> pulumi.Output[Sequence['outputs.ApiIntegrationGitRepositoryGithubAppDescribeOutput']]:
        """
        Outputs the result of `DESCRIBE API INTEGRATION` for the given integration.
        """
        return pulumi.get(self, "describe_outputs")
    ...
    @_builtins.property
    @pulumi.getter(name="showOutputs")
    def show_outputs(self) -> pulumi.Output[Sequence['outputs.ApiIntegrationGitRepositoryGithubAppShowOutput']]:
        """
        Outputs the result of `SHOW API INTEGRATIONS` for the given integration.
        """
        return pulumi.get(self, "show_outputs")
