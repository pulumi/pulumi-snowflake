...
class ApiAuthenticationIntegrationWithClientCredentials(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            comment: pulumi.Input[Optional[_builtins.str]] = None,
            describe_outputs: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ApiAuthenticationIntegrationWithClientCredentialsDescribeOutputArgs', 'ApiAuthenticationIntegrationWithClientCredentialsDescribeOutputArgsDict', 'outputs.ApiAuthenticationIntegrationWithClientCredentialsDescribeOutput']]]]] = None,
            enabled: pulumi.Input[Optional[_builtins.bool]] = None,
            fully_qualified_name: pulumi.Input[Optional[_builtins.str]] = None,
            name: pulumi.Input[Optional[_builtins.str]] = None,
            oauth_access_token_validity: pulumi.Input[Optional[_builtins.int]] = None,
            ...
            oauth_refresh_token_validity: pulumi.Input[Optional[_builtins.int]] = None,
            oauth_token_endpoint: pulumi.Input[Optional[_builtins.str]] = None,
            show_outputs: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ApiAuthenticationIntegrationWithClientCredentialsShowOutputArgs', 'ApiAuthenticationIntegrationWithClientCredentialsShowOutputArgsDict', 'outputs.ApiAuthenticationIntegrationWithClientCredentialsShowOutput']]]]] = None) -> 'ApiAuthenticationIntegrationWithClientCredentials':
        """
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[_builtins.str] comment: Specifies a comment for the integration.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ApiAuthenticationIntegrationWithClientCredentialsDescribeOutputArgs', 'ApiAuthenticationIntegrationWithClientCredentialsDescribeOutputArgsDict', 'outputs.ApiAuthenticationIntegrationWithClientCredentialsDescribeOutput']]]] describe_outputs: Outputs the result of `DESCRIBE SECURITY INTEGRATIONS` for the given security integration.
        :param pulumi.Input[_builtins.bool] enabled: Specifies whether this security integration is enabled or disabled.
        :param pulumi.Input[_builtins.str] fully_qualified_name: Fully qualified name of the resource. For more information, see [object name resolution](https://docs.snowflake.com/en/sql-reference/name-resolution).
        :param pulumi.Input[_builtins.str] name: Specifies the identifier (i.e. name) for the integration. This value must be unique in your account. Due to technical limitations (read more here), avoid using the following characters: `|`, `.`, `"`.
        :param pulumi.Input[_builtins.int] oauth_access_token_validity: (Default: fallback to Snowflake default - uses special value that cannot be set in the configuration manually (`-1`)) Specifies the default lifetime of the OAuth access token (in seconds) issued by an OAuth server.
        ...
        :param pulumi.Input[_builtins.int] oauth_refresh_token_validity: Specifies the value to determine the validity of the refresh token obtained from the OAuth server.
        :param pulumi.Input[_builtins.str] oauth_token_endpoint: Specifies the token endpoint used by the client to obtain an access token by presenting its authorization grant or refresh token. The token endpoint is used with every authorization grant except for the implicit grant type (since an access token is issued directly). If removed from the config, the resource is recreated.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ApiAuthenticationIntegrationWithClientCredentialsShowOutputArgs', 'ApiAuthenticationIntegrationWithClientCredentialsShowOutputArgsDict', 'outputs.ApiAuthenticationIntegrationWithClientCredentialsShowOutput']]]] show_outputs: Outputs the result of `SHOW SECURITY INTEGRATIONS` for the given security integration.
        """
