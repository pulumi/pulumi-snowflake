...
class AccountParameterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] value: Value of account parameter, as a string. Constraints are the same as those for the parameters in Snowflake
...
class AccountParameter(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a AccountParameter resource with the given unique name, props, and options.
