...
def get_notebooks(like: Optional[_builtins.str] = None,
                  limit: Optional[Union['GetNotebooksLimitArgs', 'GetNotebooksLimitArgsDict', 'outputs.GetNotebooksLimitResult']] = None,
    ...
    :param Union['GetNotebooksLimitArgs', 'GetNotebooksLimitArgsDict', 'outputs.GetNotebooksLimitResult'] limit: Limits the number of rows returned. If the `limit.from` is set, then the limit will start from the first element matched by the expression. The expression is only used to match with the first element, later on the elements are not matched by the prefix, but you can enforce a certain pattern with `starts_with` or `like`.
...
def get_notebooks_output(like: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                         limit: pulumi.Input[Optional[Optional[Union['GetNotebooksLimitArgs', 'GetNotebooksLimitArgsDict', 'outputs.GetNotebooksLimitResult']]]] = None,
