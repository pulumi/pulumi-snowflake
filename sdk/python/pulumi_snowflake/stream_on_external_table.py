...
class StreamOnExternalTableArgs:
    def __init__(__self__, *,
                 ...
                 at: pulumi.Input[Optional['StreamOnExternalTableAtArgs']] = None,
                 before: pulumi.Input[Optional['StreamOnExternalTableBeforeArgs']] = None,
                 comment: pulumi.Input[Optional[_builtins.str]] = None,
                 copy_grants: pulumi.Input[Optional[_builtins.bool]] = None,
                 insert_only: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def at(self) -> pulumi.Input[Optional['StreamOnExternalTableAtArgs']]:
        """
    ...
    @at.setter
    def at(self, value: pulumi.Input[Optional['StreamOnExternalTableAtArgs']]):
        pulumi.set(self, "at", value)

    @_builtins.property
    @pulumi.getter
    def before(self) -> pulumi.Input[Optional['StreamOnExternalTableBeforeArgs']]:
        """
        This field specifies that the request refers to a point immediately preceding the specified parameter. This point in time is just before the statement, identified by its query ID, is completed.  Due to Snowflake limitations, the provider does not detect external changes on this field. External changes for this field won't be detected. In case you want to apply external changes, you can re-create the resource manually using "terraform taint".
        """
    ...
    @before.setter
    def before(self, value: pulumi.Input[Optional['StreamOnExternalTableBeforeArgs']]):
    ...
    def insert_only(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        (Default: fallback to Snowflake default - uses special value that cannot be set in the configuration manually (`default`)) Specifies whether this is an insert-only stream. Available options are: "true" or "false". When the value is not set in the configuration the provider will put "default" there which means to use the Snowflake default for this value.
        """
    ...
    @insert_only.setter
    def insert_only(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class _StreamOnExternalTableState:
    def __init__(__self__, *,
                 ...
                 describe_outputs: pulumi.Input[Optional[Sequence[pulumi.Input['StreamOnExternalTableDescribeOutputArgs']]]] = None,
                 external_table: pulumi.Input[Optional[_builtins.str]] = None,
                 fully_qualified_name: pulumi.Input[Optional[_builtins.str]] = None,
                 insert_only: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 schema: pulumi.Input[Optional[_builtins.str]] = None,
                 show_outputs: pulumi.Input[Optional[Sequence[pulumi.Input['StreamOnExternalTableShowOutputArgs']]]] = None,
    ...
    def describe_outputs(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['StreamOnExternalTableDescribeOutputArgs']]]]:
        """
    ...
    def describe_outputs(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['StreamOnExternalTableDescribeOutputArgs']]]]):
        pulumi.set(self, "describe_outputs", value)

    @_builtins.property
    @pulumi.getter(name="externalTable")
    def external_table(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Specifies an identifier for the external table the stream will monitor. Due to technical limitations (read more here), avoid using the following characters: `|`, `.`, `"`. For more information about this resource, see docs.
        """
        return pulumi.get(self, "external_table")
    ...
    @external_table.setter
    def external_table(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "external_table", value)
    ...
    def show_outputs(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['StreamOnExternalTableShowOutputArgs']]]]:
        """
    ...
    @show_outputs.setter
    def show_outputs(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['StreamOnExternalTableShowOutputArgs']]]]):
...
class StreamOnExternalTable(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 at: pulumi.Input[Optional[Union['StreamOnExternalTableAtArgs', 'StreamOnExternalTableAtArgsDict', 'outputs.StreamOnExternalTableAt']]] = None,
                 before: pulumi.Input[Optional[Union['StreamOnExternalTableBeforeArgs', 'StreamOnExternalTableBeforeArgsDict', 'outputs.StreamOnExternalTableBefore']]] = None,
                 comment: pulumi.Input[Optional[_builtins.str]] = None,
                 copy_grants: pulumi.Input[Optional[_builtins.bool]] = None,
                 database: pulumi.Input[Optional[_builtins.str]] = None,
                 external_table: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[Union['StreamOnExternalTableAtArgs', 'StreamOnExternalTableAtArgsDict', 'outputs.StreamOnExternalTableAt']] at: This field specifies that the request is inclusive of any changes made by a statement or transaction with a timestamp equal to the specified parameter. Due to Snowflake limitations, the provider does not detect external changes on this field. External changes for this field won't be detected. In case you want to apply external changes, you can re-create the resource manually using "terraform taint".
        :param pulumi.Input[Union['StreamOnExternalTableBeforeArgs', 'StreamOnExternalTableBeforeArgsDict', 'outputs.StreamOnExternalTableBefore']] before: This field specifies that the request refers to a point immediately preceding the specified parameter. This point in time is just before the statement, identified by its query ID, is completed.  Due to Snowflake limitations, the provider does not detect external changes on this field. External changes for this field won't be detected. In case you want to apply external changes, you can re-create the resource manually using "terraform taint".
        :param pulumi.Input[_builtins.str] comment: Specifies a comment for the stream.
        :param pulumi.Input[_builtins.bool] copy_grants: (Default: `false`) Retains the access permissions from the original stream when a stream is recreated using the OR REPLACE clause. This is used when the provider detects changes for fields that can not be changed by ALTER. This value will not have any effect during creating a new object with Terraform.
        :param pulumi.Input[_builtins.str] database: The database in which to create the stream. Due to technical limitations (read more here), avoid using the following characters: `|`, `.`, `"`.
        :param pulumi.Input[_builtins.str] external_table: Specifies an identifier for the external table the stream will monitor. Due to technical limitations (read more here), avoid using the following characters: `|`, `.`, `"`. For more information about this resource, see docs.
    ...
    def get(resource_name: str,
            ...
            copy_grants: pulumi.Input[Optional[_builtins.bool]] = None,
            database: pulumi.Input[Optional[_builtins.str]] = None,
            describe_outputs: pulumi.Input[Optional[Sequence[pulumi.Input[Union['StreamOnExternalTableDescribeOutputArgs', 'StreamOnExternalTableDescribeOutputArgsDict', 'outputs.StreamOnExternalTableDescribeOutput']]]]] = None,
            external_table: pulumi.Input[Optional[_builtins.str]] = None,
            fully_qualified_name: pulumi.Input[Optional[_builtins.str]] = None,
            insert_only: pulumi.Input[Optional[_builtins.str]] = None,
            name: pulumi.Input[Optional[_builtins.str]] = None,
            schema: pulumi.Input[Optional[_builtins.str]] = None,
            show_outputs: pulumi.Input[Optional[Sequence[pulumi.Input[Union['StreamOnExternalTableShowOutputArgs', 'StreamOnExternalTableShowOutputArgsDict', 'outputs.StreamOnExternalTableShowOutput']]]]] = None,
            stale: pulumi.Input[Optional[_builtins.bool]] = None,
            stream_type: pulumi.Input[Optional[_builtins.str]] = None) -> 'StreamOnExternalTable':
        """
        ...
        :param pulumi.Input[_builtins.bool] copy_grants: (Default: `false`) Retains the access permissions from the original stream when a stream is recreated using the OR REPLACE clause. This is used when the provider detects changes for fields that can not be changed by ALTER. This value will not have any effect during creating a new object with Terraform.
        :param pulumi.Input[_builtins.str] database: The database in which to create the stream. Due to technical limitations (read more here), avoid using the following characters: `|`, `.`, `"`.
        :param pulumi.Input[Sequence[pulumi.Input[Union['StreamOnExternalTableDescribeOutputArgs', 'StreamOnExternalTableDescribeOutputArgsDict', 'outputs.StreamOnExternalTableDescribeOutput']]]] describe_outputs: Outputs the result of `DESCRIBE STREAM` for the given stream.
        :param pulumi.Input[_builtins.str] external_table: Specifies an identifier for the external table the stream will monitor. Due to technical limitations (read more here), avoid using the following characters: `|`, `.`, `"`. For more information about this resource, see docs.
        :param pulumi.Input[_builtins.str] fully_qualified_name: Fully qualified name of the resource. For more information, see [object name resolution](https://docs.snowflake.com/en/sql-reference/name-resolution).
        :param pulumi.Input[_builtins.str] insert_only: (Default: fallback to Snowflake default - uses special value that cannot be set in the configuration manually (`default`)) Specifies whether this is an insert-only stream. Available options are: "true" or "false". When the value is not set in the configuration the provider will put "default" there which means to use the Snowflake default for this value.
        :param pulumi.Input[_builtins.str] name: Specifies the identifier for the stream; must be unique for the database and schema in which the stream is created. Due to technical limitations (read more here), avoid using the following characters: `|`, `.`, `"`.
        :param pulumi.Input[_builtins.str] schema: The schema in which to create the stream. Due to technical limitations (read more here), avoid using the following characters: `|`, `.`, `"`.
        :param pulumi.Input[Sequence[pulumi.Input[Union['StreamOnExternalTableShowOutputArgs', 'StreamOnExternalTableShowOutputArgsDict', 'outputs.StreamOnExternalTableShowOutput']]]] show_outputs: Outputs the result of `SHOW STREAMS` for the given stream.
        :param pulumi.Input[_builtins.bool] stale: Indicated if the stream is stale. When Terraform detects that the stream is stale, the stream is recreated with `CREATE OR REPLACE`. Read more on stream staleness in Snowflake [docs](https://docs.snowflake.com/en/user-guide/streams-intro#data-retention-period-and-staleness).
        :param pulumi.Input[_builtins.str] stream_type: Specifies a type for the stream. This field is used for checking external changes and recreating the resources if needed.
        """
