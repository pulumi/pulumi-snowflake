...
class FileFormatArgs:
    def __init__(__self__, *,
                 ...
                 validate_utf8: Optional[pulumi.Input[bool]] = None):
        """
        ...
        :param pulumi.Input[bool] disable_auto_convert: Boolean that specifies whether the XML parser disables automatic conversion of numeric and Boolean values from text to
        ...
        :param pulumi.Input[bool] empty_field_as_null: Specifies whether to insert SQL NULL for empty fields in an input file, which are represented by two successive
               delimiters.
        ...
        :param pulumi.Input[bool] error_on_column_count_mismatch: Boolean that specifies whether to generate a parsing error if the number of delimited columns (i.e. fields) in an input
        ...
        :param pulumi.Input[str] field_delimiter: Specifies one or more singlebyte or multibyte characters that separate fields in an input file (data loading) or
        ...
        :param pulumi.Input[str] name: Specifies the identifier for the file format; must be unique for the database and schema in which the file format is
               created.
        ...
        :param pulumi.Input[str] record_delimiter: Specifies one or more singlebyte or multibyte characters that separate records in an input file (data loading) or
               unloaded file (data unloading).
        ...
        :param pulumi.Input[bool] strip_outer_element: Boolean that specifies whether the XML parser strips out the outer XML element, exposing 2nd level elements as separate
               documents.
        ...
        :param pulumi.Input[bool] validate_utf8: Boolean that specifies whether to validate UTF-8 character encoding in string column data.
        """
    ...
    def validate_utf8(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def validate_utf8(self, value: Optional[pulumi.Input[bool]]):
...
class FileFormat(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["validate_utf8"] = validate_utf8
    ...
    def get(resource_name: str,
            ...
            timestamp_format: Optional[pulumi.Input[str]] = None,
            trim_space: Optional[pulumi.Input[bool]] = None,
            validate_utf8: Optional[pulumi.Input[bool]] = None) -> 'FileFormat':
        """
    ...
    @property
    @pulumi.getter(name="validateUtf8")
    def validate_utf8(self) -> pulumi.Output[Optional[bool]]:
        """
        Boolean that specifies whether to validate UTF-8 character encoding in string column data.
        """
        return pulumi.get(self, "validate_utf8")
