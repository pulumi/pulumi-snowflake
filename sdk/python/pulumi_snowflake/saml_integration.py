...
class SamlIntegrationArgs:
    def __init__(__self__, *,
        ...
        """
        SamlIntegrationArgs._configure(
    ...
    def _configure(
             ...
             **kwargs):
        if saml2_issuer is None and 'saml2Issuer' in kwargs:
            saml2_issuer = kwargs['saml2Issuer']
        if saml2_issuer is None:
            raise TypeError("Missing 'saml2_issuer' argument")
        if saml2_provider is None and 'saml2Provider' in kwargs:
            saml2_provider = kwargs['saml2Provider']
        if saml2_provider is None:
            raise TypeError("Missing 'saml2_provider' argument")
        if saml2_sso_url is None and 'saml2SsoUrl' in kwargs:
            saml2_sso_url = kwargs['saml2SsoUrl']
        if saml2_sso_url is None:
            raise TypeError("Missing 'saml2_sso_url' argument")
        if saml2_x509_cert is None and 'saml2X509Cert' in kwargs:
            saml2_x509_cert = kwargs['saml2X509Cert']
        if saml2_x509_cert is None:
            raise TypeError("Missing 'saml2_x509_cert' argument")
        if saml2_enable_sp_initiated is None and 'saml2EnableSpInitiated' in kwargs:
            saml2_enable_sp_initiated = kwargs['saml2EnableSpInitiated']
        if saml2_force_authn is None and 'saml2ForceAuthn' in kwargs:
            saml2_force_authn = kwargs['saml2ForceAuthn']
        if saml2_post_logout_redirect_url is None and 'saml2PostLogoutRedirectUrl' in kwargs:
            saml2_post_logout_redirect_url = kwargs['saml2PostLogoutRedirectUrl']
        if saml2_requested_nameid_format is None and 'saml2RequestedNameidFormat' in kwargs:
            saml2_requested_nameid_format = kwargs['saml2RequestedNameidFormat']
        if saml2_sign_request is None and 'saml2SignRequest' in kwargs:
            saml2_sign_request = kwargs['saml2SignRequest']
        if saml2_snowflake_acs_url is None and 'saml2SnowflakeAcsUrl' in kwargs:
            saml2_snowflake_acs_url = kwargs['saml2SnowflakeAcsUrl']
        if saml2_snowflake_issuer_url is None and 'saml2SnowflakeIssuerUrl' in kwargs:
            saml2_snowflake_issuer_url = kwargs['saml2SnowflakeIssuerUrl']
        if saml2_snowflake_x509_cert is None and 'saml2SnowflakeX509Cert' in kwargs:
            saml2_snowflake_x509_cert = kwargs['saml2SnowflakeX509Cert']
        if saml2_sp_initiated_login_page_label is None and 'saml2SpInitiatedLoginPageLabel' in kwargs:
        ...
        _setter("saml2_x509_cert", saml2_x509_cert)
        if enabled is not None:
            _setter("enabled", enabled)
        if name is not None:
            _setter("name", name)
        if saml2_enable_sp_initiated is not None:
            _setter("saml2_enable_sp_initiated", saml2_enable_sp_initiated)
        if saml2_force_authn is not None:
            _setter("saml2_force_authn", saml2_force_authn)
        if saml2_post_logout_redirect_url is not None:
            _setter("saml2_post_logout_redirect_url", saml2_post_logout_redirect_url)
        if saml2_requested_nameid_format is not None:
            _setter("saml2_requested_nameid_format", saml2_requested_nameid_format)
        if saml2_sign_request is not None:
            _setter("saml2_sign_request", saml2_sign_request)
        if saml2_snowflake_acs_url is not None:
            _setter("saml2_snowflake_acs_url", saml2_snowflake_acs_url)
        if saml2_snowflake_issuer_url is not None:
            _setter("saml2_snowflake_issuer_url", saml2_snowflake_issuer_url)
        if saml2_snowflake_x509_cert is not None:
            _setter("saml2_snowflake_x509_cert", saml2_snowflake_x509_cert)
        if saml2_sp_initiated_login_page_label is not None:
            _setter("saml2_sp_initiated_login_page_label", saml2_sp_initiated_login_page_label)
...
class _SamlIntegrationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] saml2_x509_cert: The Base64 encoded IdP signing certificate on a single line without the leading -----BEGIN CERTIFICATE----- and ending -----END CERTIFICATE----- markers.
        """
        _SamlIntegrationState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            ...
            saml2_requested_nameid_format=saml2_requested_nameid_format,
            saml2_sign_request=saml2_sign_request,
            saml2_signature_methods_used=saml2_signature_methods_used,
            saml2_snowflake_acs_url=saml2_snowflake_acs_url,
            saml2_snowflake_issuer_url=saml2_snowflake_issuer_url,
            saml2_snowflake_metadata=saml2_snowflake_metadata,
            saml2_snowflake_x509_cert=saml2_snowflake_x509_cert,
            saml2_sp_initiated_login_page_label=saml2_sp_initiated_login_page_label,
            saml2_sso_url=saml2_sso_url,
            saml2_x509_cert=saml2_x509_cert,
    ...
    def _configure(
        ...
        if saml2_digest_methods_used is None and 'saml2DigestMethodsUsed' in kwargs:
        ...
        if saml2_sign_request is None and 'saml2SignRequest' in kwargs:
            saml2_sign_request = kwargs['saml2SignRequest']
        if saml2_signature_methods_used is None and 'saml2SignatureMethodsUsed' in kwargs:
            saml2_signature_methods_used = kwargs['saml2SignatureMethodsUsed']
        if saml2_snowflake_acs_url is None and 'saml2SnowflakeAcsUrl' in kwargs:
            saml2_snowflake_acs_url = kwargs['saml2SnowflakeAcsUrl']
        if saml2_snowflake_issuer_url is None and 'saml2SnowflakeIssuerUrl' in kwargs:
            saml2_snowflake_issuer_url = kwargs['saml2SnowflakeIssuerUrl']
        if saml2_snowflake_metadata is None and 'saml2SnowflakeMetadata' in kwargs:
        ...
        if saml2_digest_methods_used is not None:
            _setter("saml2_digest_methods_used", saml2_digest_methods_used)
        if saml2_enable_sp_initiated is not None:
            _setter("saml2_enable_sp_initiated", saml2_enable_sp_initiated)
        if saml2_force_authn is not None:
            _setter("saml2_force_authn", saml2_force_authn)
        ...
        if saml2_signature_methods_used is not None:
            _setter("saml2_signature_methods_used", saml2_signature_methods_used)
        if saml2_snowflake_acs_url is not None:
            _setter("saml2_snowflake_acs_url", saml2_snowflake_acs_url)
        if saml2_snowflake_issuer_url is not None:
            _setter("saml2_snowflake_issuer_url", saml2_snowflake_issuer_url)
        if saml2_snowflake_metadata is not None:
            _setter("saml2_snowflake_metadata", saml2_snowflake_metadata)
        if saml2_snowflake_x509_cert is not None:
            _setter("saml2_snowflake_x509_cert", saml2_snowflake_x509_cert)
        if saml2_sp_initiated_login_page_label is not None:
            _setter("saml2_sp_initiated_login_page_label", saml2_sp_initiated_login_page_label)
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            SamlIntegrationArgs._configure(_setter, **kwargs)
