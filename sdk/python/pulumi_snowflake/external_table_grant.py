...
class ExternalTableGrant(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        ```sh
         $ pulumi import snowflake:index/externalTableGrant:ExternalTableGrant example 'MY_DATABASE❄️MY_SCHEMA❄️MY_OBJECT_NAME❄️SELECT❄️false❄️role1,role2❄️share1,share2'
        ```
