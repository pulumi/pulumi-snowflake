...
class CurrentOrganizationAccountArgs:
    def __init__(__self__, *,
                 abort_detached_query: pulumi.Input[Optional[_builtins.bool]] = None,
                 active_python_profiler: pulumi.Input[Optional[_builtins.str]] = None,
                 allow_client_mfa_caching: pulumi.Input[Optional[_builtins.bool]] = None,
                 allow_id_token: pulumi.Input[Optional[_builtins.bool]] = None,
                 autocommit: pulumi.Input[Optional[_builtins.bool]] = None,
                 base_location_prefix: pulumi.Input[Optional[_builtins.str]] = None,
                 binary_input_format: pulumi.Input[Optional[_builtins.str]] = None,
                 binary_output_format: pulumi.Input[Optional[_builtins.str]] = None,
                 catalog: pulumi.Input[Optional[_builtins.str]] = None,
                 catalog_sync: pulumi.Input[Optional[_builtins.str]] = None,
                 client_enable_log_info_statement_parameters: pulumi.Input[Optional[_builtins.bool]] = None,
                 client_encryption_key_size: pulumi.Input[Optional[_builtins.int]] = None,
                 client_memory_limit: pulumi.Input[Optional[_builtins.int]] = None,
                 client_metadata_request_use_connection_ctx: pulumi.Input[Optional[_builtins.bool]] = None,
                 client_metadata_use_session_database: pulumi.Input[Optional[_builtins.bool]] = None,
                 client_prefetch_threads: pulumi.Input[Optional[_builtins.int]] = None,
                 client_result_chunk_size: pulumi.Input[Optional[_builtins.int]] = None,
                 client_result_column_case_insensitive: pulumi.Input[Optional[_builtins.bool]] = None,
                 ...
                 date_input_format: pulumi.Input[Optional[_builtins.str]] = None,
                 date_output_format: pulumi.Input[Optional[_builtins.str]] = None,
                 ...
                 enable_automatic_sensitive_data_classification_log: pulumi.Input[Optional[_builtins.bool]] = None,
                 ...
                 enable_unload_physical_type_optimization: pulumi.Input[Optional[_builtins.bool]] = None,
                 enable_unredacted_query_syntax_error: pulumi.Input[Optional[_builtins.bool]] = None,
                 enable_unredacted_secure_object_error: pulumi.Input[Optional[_builtins.bool]] = None,
                 enforce_network_rules_for_internal_stages: pulumi.Input[Optional[_builtins.bool]] = None,
                 error_on_nondeterministic_merge: pulumi.Input[Optional[_builtins.bool]] = None,
                 error_on_nondeterministic_update: pulumi.Input[Optional[_builtins.bool]] = None,
                 event_table: pulumi.Input[Optional[_builtins.str]] = None,
                 external_oauth_add_privileged_roles_to_blocked_list: pulumi.Input[Optional[_builtins.bool]] = None,
                 external_volume: pulumi.Input[Optional[_builtins.str]] = None,
                 geography_output_format: pulumi.Input[Optional[_builtins.str]] = None,
                 geometry_output_format: pulumi.Input[Optional[_builtins.str]] = None,
                 hybrid_table_lock_timeout: pulumi.Input[Optional[_builtins.int]] = None,
                 initial_replication_size_limit_in_tb: pulumi.Input[Optional[_builtins.str]] = None,
                 jdbc_treat_decimal_as_int: pulumi.Input[Optional[_builtins.bool]] = None,
                 jdbc_treat_timestamp_ntz_as_utc: pulumi.Input[Optional[_builtins.bool]] = None,
                 jdbc_use_session_timezone: pulumi.Input[Optional[_builtins.bool]] = None,
                 js_treat_integer_as_bigint: pulumi.Input[Optional[_builtins.bool]] = None,
                 ...
                 min_data_retention_time_in_days: pulumi.Input[Optional[_builtins.int]] = None,
                 multi_statement_count: pulumi.Input[Optional[_builtins.int]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 network_policy: pulumi.Input[Optional[_builtins.str]] = None,
                 noorder_sequence_as_default: pulumi.Input[Optional[_builtins.bool]] = None,
                 oauth_add_privileged_roles_to_blocked_list: pulumi.Input[Optional[_builtins.bool]] = None,
                 odbc_treat_decimal_as_int: pulumi.Input[Optional[_builtins.bool]] = None,
                 password_policy: pulumi.Input[Optional[_builtins.str]] = None,
                 periodic_data_rekeying: pulumi.Input[Optional[_builtins.bool]] = None,
                 pipe_execution_paused: pulumi.Input[Optional[_builtins.bool]] = None,
                 prevent_unload_to_inline_url: pulumi.Input[Optional[_builtins.bool]] = None,
                 prevent_unload_to_internal_stages: pulumi.Input[Optional[_builtins.bool]] = None,
                 python_profiler_modules: pulumi.Input[Optional[_builtins.str]] = None,
                 python_profiler_target_stage: pulumi.Input[Optional[_builtins.str]] = None,
                 query_tag: pulumi.Input[Optional[_builtins.str]] = None,
                 ...
                 require_storage_integration_for_stage_creation: pulumi.Input[Optional[_builtins.bool]] = None,
                 require_storage_integration_for_stage_operation: pulumi.Input[Optional[_builtins.bool]] = None,
                 resource_monitor: pulumi.Input[Optional[_builtins.str]] = None,
                 rows_per_resultset: pulumi.Input[Optional[_builtins.int]] = None,
                 s3_stage_vpce_dns_name: pulumi.Input[Optional[_builtins.str]] = None,
                 search_path: pulumi.Input[Optional[_builtins.str]] = None,
                 serverless_task_max_statement_size: pulumi.Input[Optional[_builtins.str]] = None,
                 serverless_task_min_statement_size: pulumi.Input[Optional[_builtins.str]] = None,
                 session_policy: pulumi.Input[Optional[_builtins.str]] = None,
                 simulated_data_sharing_consumer: pulumi.Input[Optional[_builtins.str]] = None,
                 sso_login_page: pulumi.Input[Optional[_builtins.bool]] = None,
                 ...
                 strict_json_output: pulumi.Input[Optional[_builtins.bool]] = None,
                 ...
                 time_input_format: pulumi.Input[Optional[_builtins.str]] = None,
                 time_output_format: pulumi.Input[Optional[_builtins.str]] = None,
                 timestamp_day_is_always24h: pulumi.Input[Optional[_builtins.bool]] = None,
                 timestamp_input_format: pulumi.Input[Optional[_builtins.str]] = None,
                 timestamp_ltz_output_format: pulumi.Input[Optional[_builtins.str]] = None,
                 timestamp_ntz_output_format: pulumi.Input[Optional[_builtins.str]] = None,
                 timestamp_output_format: pulumi.Input[Optional[_builtins.str]] = None,
                 timestamp_type_mapping: pulumi.Input[Optional[_builtins.str]] = None,
                 timestamp_tz_output_format: pulumi.Input[Optional[_builtins.str]] = None,
                 timezone: pulumi.Input[Optional[_builtins.str]] = None,
                 trace_level: pulumi.Input[Optional[_builtins.str]] = None,
                 transaction_abort_on_error: pulumi.Input[Optional[_builtins.bool]] = None,
                 transaction_default_isolation_level: pulumi.Input[Optional[_builtins.str]] = None,
                 two_digit_century_start: pulumi.Input[Optional[_builtins.int]] = None,
                 unsupported_ddl_action: pulumi.Input[Optional[_builtins.str]] = None,
                 use_cached_result: pulumi.Input[Optional[_builtins.bool]] = None,
                 ...
                 week_of_year_policy: pulumi.Input[Optional[_builtins.int]] = None,
        ...
        :param pulumi.Input[_builtins.str] timestamp_ntz_output_format: Specifies the display format for the TIMESTAMP*NTZ data type. For more information, check *NTZ*OUTPUT*FORMAT docs[TIMESTAMP](https://docs.snowflake.com/en/sql-reference/parameters#timestamp-ntz-output-format).
    ...
    def abort_detached_query(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def abort_detached_query(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "abort_detached_query", value)

    @_builtins.property
    @pulumi.getter(name="activePythonProfiler")
    def active_python_profiler(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Sets the profiler to use for the session when [profiling Python handler code](https://docs.snowflake.com/en/developer-guide/stored-procedure/python/procedure-python-profiler). Valid values are (case-insensitive): `LINE` | `MEMORY`. For more information, check [ACTIVE*PYTHON*PROFILER docs](https://docs.snowflake.com/en/sql-reference/parameters#active-python-profiler).
        """
    ...
    def active_python_profiler(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "active_python_profiler", value)

    @_builtins.property
    @pulumi.getter(name="allowClientMfaCaching")
    def allow_client_mfa_caching(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Specifies whether an MFA token can be saved in the client-side operating system keystore to promote continuous, secure connectivity without users needing to respond to an MFA prompt at the start of each connection attempt to Snowflake. For details and the list of supported Snowflake-provided clients, see [Using MFA token caching to minimize the number of prompts during authentication — optional.](https://docs.snowflake.com/en/user-guide/security-mfa.html#label-mfa-token-caching) For more information, check [ALLOW*CLIENT*MFA_CACHING docs](https://docs.snowflake.com/en/sql-reference/parameters#allow-client-mfa-caching).
        """
    ...
    def allow_client_mfa_caching(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "allow_client_mfa_caching", value)

    @_builtins.property
    @pulumi.getter(name="allowIdToken")
    def allow_id_token(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def allow_id_token(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def base_location_prefix(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Specifies a prefix for Snowflake to use in the write path for Snowflake-managed Apache Iceberg™ tables. For more information, see [data and metadata directories for Iceberg tables](https://docs.snowflake.com/en/user-guide/tables-iceberg-storage.html#label-tables-iceberg-configure-external-volume-base-location). For more information, check [BASE*LOCATION*PREFIX docs](https://docs.snowflake.com/en/sql-reference/parameters#base-location-prefix).
        """
    ...
    def base_location_prefix(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "base_location_prefix", value)

    @_builtins.property
    @pulumi.getter(name="binaryInputFormat")
    def binary_input_format(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The format of VARCHAR values passed as input to VARCHAR-to-BINARY conversion functions. For more information, see [Binary input and output](https://docs.snowflake.com/en/sql-reference/binary-input-output). Valid values are (case-insensitive): `HEX` | `BASE64` | `UTF8`. For more information, check [BINARY*INPUT*FORMAT docs](https://docs.snowflake.com/en/sql-reference/parameters#binary-input-format).
        """
    ...
    def binary_input_format(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "binary_input_format", value)

    @_builtins.property
    @pulumi.getter(name="binaryOutputFormat")
    def binary_output_format(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The format for VARCHAR values returned as output by BINARY-to-VARCHAR conversion functions. For more information, see [Binary input and output](https://docs.snowflake.com/en/sql-reference/binary-input-output). Valid values are (case-insensitive): `HEX` | `BASE64`. For more information, check [BINARY*OUTPUT*FORMAT docs](https://docs.snowflake.com/en/sql-reference/parameters#binary-output-format).
        """
    ...
    def binary_output_format(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def client_enable_log_info_statement_parameters(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def client_enable_log_info_statement_parameters(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "client_enable_log_info_statement_parameters", value)

    @_builtins.property
    @pulumi.getter(name="clientEncryptionKeySize")
    def client_encryption_key_size(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    def client_encryption_key_size(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "client_encryption_key_size", value)

    @_builtins.property
    @pulumi.getter(name="clientMemoryLimit")
    def client_memory_limit(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    def client_memory_limit(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "client_memory_limit", value)

    @_builtins.property
    @pulumi.getter(name="clientMetadataRequestUseConnectionCtx")
    def client_metadata_request_use_connection_ctx(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        For specific ODBC functions and JDBC methods, this parameter can change the default search scope from all databases/schemas to the current database/schema. The narrower search typically returns fewer rows and executes more quickly. For more information, check [CLIENT*METADATA*REQUEST*USE*CONNECTION_CTX docs](https://docs.snowflake.com/en/sql-reference/parameters#client-metadata-request-use-connection-ctx).
        """
    ...
    def client_metadata_request_use_connection_ctx(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "client_metadata_request_use_connection_ctx", value)

    @_builtins.property
    @pulumi.getter(name="clientMetadataUseSessionDatabase")
    def client_metadata_use_session_database(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        For specific ODBC functions and JDBC methods, this parameter can change the default search scope from all databases to the current database. The narrower search typically returns fewer rows and executes more quickly ([more details on the usage](https://docs.snowflake.com/en/sql-reference/parameters#client-metadata-use-session-database)). For more information, check [CLIENT*METADATA*USE*SESSION*DATABASE docs](https://docs.snowflake.com/en/sql-reference/parameters#client-metadata-use-session-database).
        """
    ...
    def client_metadata_use_session_database(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "client_metadata_use_session_database", value)

    @_builtins.property
    @pulumi.getter(name="clientPrefetchThreads")
    def client_prefetch_threads(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    def client_prefetch_threads(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "client_prefetch_threads", value)

    @_builtins.property
    @pulumi.getter(name="clientResultChunkSize")
    def client_result_chunk_size(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    def client_result_chunk_size(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "client_result_chunk_size", value)

    @_builtins.property
    @pulumi.getter(name="clientResultColumnCaseInsensitive")
    def client_result_column_case_insensitive(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def client_result_column_case_insensitive(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def client_session_keep_alive_heartbeat_frequency(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    def client_session_keep_alive_heartbeat_frequency(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "client_session_keep_alive_heartbeat_frequency", value)

    @_builtins.property
    @pulumi.getter(name="clientTimestampTypeMapping")
    def client_timestamp_type_mapping(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def client_timestamp_type_mapping(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def cortex_enabled_cross_region(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "cortex_enabled_cross_region", value)

    @_builtins.property
    @pulumi.getter(name="cortexModelsAllowlist")
    def cortex_models_allowlist(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Specifies the models that users in the account can access. Use this parameter to allowlist models for all users in the account. If you need to provide specific users with access beyond what you’ve specified in the allowlist, use role-based access control instead. For more information, see [Model allowlist](https://docs.snowflake.com/en/user-guide/snowflake-cortex/aisql.html#label-cortex-llm-allowlist). For more information, check [CORTEX*MODELS*ALLOWLIST docs](https://docs.snowflake.com/en/sql-reference/parameters#cortex-models-allowlist).
        """
    ...
    def cortex_models_allowlist(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "cortex_models_allowlist", value)

    @_builtins.property
    @pulumi.getter(name="csvTimestampFormat")
    def csv_timestamp_format(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def csv_timestamp_format(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def date_input_format(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def date_input_format(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "date_input_format", value)

    @_builtins.property
    @pulumi.getter(name="dateOutputFormat")
    def date_output_format(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Specifies the display format for the DATE data type. For more information, see [Date and time input and output formats](https://docs.snowflake.com/en/sql-reference/date-time-input-output). For more information, check [DATE*OUTPUT*FORMAT docs](https://docs.snowflake.com/en/sql-reference/parameters#date-output-format).
        """
    ...
    def date_output_format(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def default_null_ordering(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def default_streamlit_notebook_warehouse(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Specifies the name of the default warehouse to use when creating a notebook. Due to technical limitations (read more here), avoid using the following characters: `|`, `.`, `"`. For more information, check [DEFAULT*STREAMLIT*NOTEBOOK_WAREHOUSE docs](https://docs.snowflake.com/en/sql-reference/parameters#default-streamlit-notebook-warehouse).
        """
    ...
    def default_streamlit_notebook_warehouse(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "default_streamlit_notebook_warehouse", value)

    @_builtins.property
    @pulumi.getter(name="disableUiDownloadButton")
    def disable_ui_download_button(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def disable_ui_download_button(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "disable_ui_download_button", value)

    @_builtins.property
    @pulumi.getter(name="disableUserPrivilegeGrants")
    def disable_user_privilege_grants(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def disable_user_privilege_grants(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "disable_user_privilege_grants", value)

    @_builtins.property
    @pulumi.getter(name="enableAutomaticSensitiveDataClassificationLog")
    def enable_automatic_sensitive_data_classification_log(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def enable_automatic_sensitive_data_classification_log(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "enable_automatic_sensitive_data_classification_log", value)

    @_builtins.property
    @pulumi.getter(name="enableEgressCostOptimizer")
    def enable_egress_cost_optimizer(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def enable_egress_cost_optimizer(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "enable_egress_cost_optimizer", value)

    @_builtins.property
    @pulumi.getter(name="enableIdentifierFirstLogin")
    def enable_identifier_first_login(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def enable_identifier_first_login(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "enable_identifier_first_login", value)

    @_builtins.property
    @pulumi.getter(name="enableInternalStagesPrivatelink")
    def enable_internal_stages_privatelink(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Specifies whether the [SYSTEM$GET*PRIVATELINK*CONFIG](https://docs.snowflake.com/en/sql-reference/functions/system_get_privatelink_config) function returns the private-internal-stages key in the query result. The corresponding value in the query result is used during the configuration process for private connectivity to internal stages. For more information, check [ENABLE*INTERNAL*STAGES_PRIVATELINK docs](https://docs.snowflake.com/en/sql-reference/parameters#enable-internal-stages-privatelink).
        """
    ...
    def enable_tri_secret_and_rekey_opt_out_for_image_repository(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def enable_tri_secret_and_rekey_opt_out_for_image_repository(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def enable_tri_secret_and_rekey_opt_out_for_spcs_block_storage(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def enable_tri_secret_and_rekey_opt_out_for_spcs_block_storage(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def enable_unhandled_exceptions_reporting(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def enable_unhandled_exceptions_reporting(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "enable_unhandled_exceptions_reporting", value)

    @_builtins.property
    @pulumi.getter(name="enableUnloadPhysicalTypeOptimization")
    def enable_unload_physical_type_optimization(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def enable_unload_physical_type_optimization(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "enable_unload_physical_type_optimization", value)

    @_builtins.property
    @pulumi.getter(name="enableUnredactedQuerySyntaxError")
    def enable_unredacted_query_syntax_error(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def enable_unredacted_query_syntax_error(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "enable_unredacted_query_syntax_error", value)

    @_builtins.property
    @pulumi.getter(name="enableUnredactedSecureObjectError")
    def enable_unredacted_secure_object_error(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def enable_unredacted_secure_object_error(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "enable_unredacted_secure_object_error", value)

    @_builtins.property
    @pulumi.getter(name="enforceNetworkRulesForInternalStages")
    def enforce_network_rules_for_internal_stages(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Specifies whether a network policy that uses network rules can restrict access to AWS internal stages. This parameter has no effect on network policies that do not use network rules. This account-level parameter affects both account-level and user-level network policies. For details about using network policies and network rules to restrict access to AWS internal stages, including the use of this parameter, see [Protecting internal stages on AWS](https://docs.snowflake.com/en/user-guide/network-policies.html#label-network-policies-rules-stages). For more information, check [ENFORCE*NETWORK*RULES*FOR*INTERNAL_STAGES docs](https://docs.snowflake.com/en/sql-reference/parameters#enforce-network-rules-for-internal-stages).
        """
    ...
    def enforce_network_rules_for_internal_stages(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "enforce_network_rules_for_internal_stages", value)

    @_builtins.property
    @pulumi.getter(name="errorOnNondeterministicMerge")
    def error_on_nondeterministic_merge(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def error_on_nondeterministic_merge(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "error_on_nondeterministic_merge", value)

    @_builtins.property
    @pulumi.getter(name="errorOnNondeterministicUpdate")
    def error_on_nondeterministic_update(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Specifies whether to return an error when the [UPDATE](https://docs.snowflake.com/en/sql-reference/sql/update) command is used to update a target row that joins multiple source rows and the system cannot determine the action to perform on the target row. For more information, check [ERROR*ON*NONDETERMINISTIC_UPDATE docs](https://docs.snowflake.com/en/sql-reference/parameters#error-on-nondeterministic-update).
        """
    ...
    def error_on_nondeterministic_update(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def external_oauth_add_privileged_roles_to_blocked_list(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Determines whether the ACCOUNTADMIN, ORGADMIN, GLOBALORGADMIN, and SECURITYADMIN roles can be used as the primary role when creating a Snowflake session based on the access token from the External OAuth authorization server. For more information, check [EXTERNAL*OAUTH*ADD*PRIVILEGED*ROLES*TO*BLOCKED_LIST docs](https://docs.snowflake.com/en/sql-reference/parameters#external-oauth-add-privileged-roles-to-blocked-list).
        """
    ...
    def external_oauth_add_privileged_roles_to_blocked_list(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def geography_output_format(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def geography_output_format(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "geography_output_format", value)

    @_builtins.property
    @pulumi.getter(name="geometryOutputFormat")
    def geometry_output_format(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def geometry_output_format(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "geometry_output_format", value)

    @_builtins.property
    @pulumi.getter(name="hybridTableLockTimeout")
    def hybrid_table_lock_timeout(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    def hybrid_table_lock_timeout(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "hybrid_table_lock_timeout", value)

    @_builtins.property
    @pulumi.getter(name="initialReplicationSizeLimitInTb")
    def initial_replication_size_limit_in_tb(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Sets the maximum estimated size limit for the initial replication of a primary database to a secondary database (in TB). Set this parameter on any account that stores a secondary database. This size limit helps prevent accounts from accidentally incurring large database replication charges. To remove the size limit, set the value to 0.0. It is required to pass numbers with scale of at least 1 (e.g. 20.5, 32.25, 33.333, etc.). For more information, check [INITIAL*REPLICATION*SIZE*LIMIT*IN_TB docs](https://docs.snowflake.com/en/sql-reference/parameters#initial-replication-size-limit-in-tb).
        """
    ...
    def initial_replication_size_limit_in_tb(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "initial_replication_size_limit_in_tb", value)

    @_builtins.property
    @pulumi.getter(name="jdbcTreatDecimalAsInt")
    def jdbc_treat_decimal_as_int(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def jdbc_treat_decimal_as_int(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "jdbc_treat_decimal_as_int", value)

    @_builtins.property
    @pulumi.getter(name="jdbcTreatTimestampNtzAsUtc")
    def jdbc_treat_timestamp_ntz_as_utc(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def jdbc_treat_timestamp_ntz_as_utc(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "jdbc_treat_timestamp_ntz_as_utc", value)

    @_builtins.property
    @pulumi.getter(name="jdbcUseSessionTimezone")
    def jdbc_use_session_timezone(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def jdbc_use_session_timezone(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "jdbc_use_session_timezone", value)

    @_builtins.property
    @pulumi.getter(name="jsTreatIntegerAsBigint")
    def js_treat_integer_as_bigint(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def js_treat_integer_as_bigint(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "js_treat_integer_as_bigint", value)

    @_builtins.property
    @pulumi.getter(name="jsonIndent")
    def json_indent(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    @json_indent.setter
    def json_indent(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "json_indent", value)

    @_builtins.property
    @pulumi.getter(name="listingAutoFulfillmentReplicationRefreshSchedule")
    def listing_auto_fulfillment_replication_refresh_schedule(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def listing_auto_fulfillment_replication_refresh_schedule(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def min_data_retention_time_in_days(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    def min_data_retention_time_in_days(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "min_data_retention_time_in_days", value)

    @_builtins.property
    @pulumi.getter(name="multiStatementCount")
    def multi_statement_count(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    def multi_statement_count(self, value: pulumi.Input[Optional[_builtins.int]]):
    ...
    def noorder_sequence_as_default(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def noorder_sequence_as_default(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "noorder_sequence_as_default", value)

    @_builtins.property
    @pulumi.getter(name="oauthAddPrivilegedRolesToBlockedList")
    def oauth_add_privileged_roles_to_blocked_list(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Determines whether the ACCOUNTADMIN, ORGADMIN, GLOBALORGADMIN, and SECURITYADMIN roles can be used as the primary role when creating a Snowflake session based on the access token from Snowflake’s authorization server. For more information, check [OAUTH*ADD*PRIVILEGED*ROLES*TO*BLOCKED*LIST docs](https://docs.snowflake.com/en/sql-reference/parameters#oauth-add-privileged-roles-to-blocked-list).
        """
    ...
    def oauth_add_privileged_roles_to_blocked_list(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "oauth_add_privileged_roles_to_blocked_list", value)

    @_builtins.property
    @pulumi.getter(name="odbcTreatDecimalAsInt")
    def odbc_treat_decimal_as_int(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def odbc_treat_decimal_as_int(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def periodic_data_rekeying(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        It enables/disables re-encryption of table data with new keys on a yearly basis to provide additional levels of data protection ([more details](https://docs.snowflake.com/en/sql-reference/parameters#periodic-data-rekeying)). For more information, check [PERIODIC*DATA*REKEYING docs](https://docs.snowflake.com/en/sql-reference/parameters#periodic-data-rekeying).
        """
    ...
    def periodic_data_rekeying(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def prevent_unload_to_inline_url(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def prevent_unload_to_inline_url(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "prevent_unload_to_inline_url", value)

    @_builtins.property
    @pulumi.getter(name="preventUnloadToInternalStages")
    def prevent_unload_to_internal_stages(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Specifies whether to prevent data unload operations to internal (Snowflake) stages using [COPY INTO location](https://docs.snowflake.com/en/sql-reference/sql/copy-into-location) statements. For more information, check [PREVENT*UNLOAD*TO*INTERNAL*STAGES docs](https://docs.snowflake.com/en/sql-reference/parameters#prevent-unload-to-internal-stages).
        """
    ...
    def prevent_unload_to_internal_stages(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "prevent_unload_to_internal_stages", value)

    @_builtins.property
    @pulumi.getter(name="pythonProfilerModules")
    def python_profiler_modules(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Specifies the list of Python modules to include in a report when [profiling Python handler code](https://docs.snowflake.com/en/developer-guide/stored-procedure/python/procedure-python-profiler). For more information, check [PYTHON*PROFILER*MODULES docs](https://docs.snowflake.com/en/sql-reference/parameters#python-profiler-modules).
        """
    ...
    def python_profiler_modules(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "python_profiler_modules", value)

    @_builtins.property
    @pulumi.getter(name="pythonProfilerTargetStage")
    def python_profiler_target_stage(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Specifies the fully-qualified name of the stage in which to save a report when [profiling Python handler code](https://docs.snowflake.com/en/developer-guide/stored-procedure/python/procedure-python-profiler). For more information, check [PYTHON*PROFILER*TARGET_STAGE docs](https://docs.snowflake.com/en/sql-reference/parameters#python-profiler-target-stage).
        """
    ...
    def python_profiler_target_stage(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "python_profiler_target_stage", value)

    @_builtins.property
    @pulumi.getter(name="queryTag")
    def query_tag(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Optional string that can be used to tag queries and other SQL statements executed within a session. The tags are displayed in the output of the [QUERY*HISTORY, QUERY*HISTORY*BY**](https://docs.snowflake.com/en/sql-reference/functions/query_history) functions. For more information, check [QUERY_TAG docs](https://docs.snowflake.com/en/sql-reference/parameters#query-tag).
        """
    ...
    @query_tag.setter
    def query_tag(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def require_storage_integration_for_stage_creation(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Specifies whether to require a storage integration object as cloud credentials when creating a named external stage (using [CREATE STAGE](https://docs.snowflake.com/en/sql-reference/sql/create-stage)) to access a private cloud storage location. For more information, check [REQUIRE*STORAGE*INTEGRATION*FOR*STAGE_CREATION docs](https://docs.snowflake.com/en/sql-reference/parameters#require-storage-integration-for-stage-creation).
        """
    ...
    def require_storage_integration_for_stage_creation(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def require_storage_integration_for_stage_operation(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def require_storage_integration_for_stage_operation(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def rows_per_resultset(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    def rows_per_resultset(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "rows_per_resultset", value)

    @_builtins.property
    @pulumi.getter(name="s3StageVpceDnsName")
    def s3_stage_vpce_dns_name(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def s3_stage_vpce_dns_name(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "s3_stage_vpce_dns_name", value)

    @_builtins.property
    @pulumi.getter(name="searchPath")
    def search_path(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    @search_path.setter
    def search_path(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "search_path", value)

    @_builtins.property
    @pulumi.getter(name="serverlessTaskMaxStatementSize")
    def serverless_task_max_statement_size(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def serverless_task_max_statement_size(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "serverless_task_max_statement_size", value)

    @_builtins.property
    @pulumi.getter(name="serverlessTaskMinStatementSize")
    def serverless_task_min_statement_size(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def serverless_task_min_statement_size(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def simulated_data_sharing_consumer(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def simulated_data_sharing_consumer(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "simulated_data_sharing_consumer", value)

    @_builtins.property
    @pulumi.getter(name="ssoLoginPage")
    def sso_login_page(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def sso_login_page(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def strict_json_output(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def strict_json_output(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def time_input_format(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def time_input_format(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "time_input_format", value)

    @_builtins.property
    @pulumi.getter(name="timeOutputFormat")
    def time_output_format(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def time_output_format(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "time_output_format", value)

    @_builtins.property
    @pulumi.getter(name="timestampDayIsAlways24h")
    def timestamp_day_is_always24h(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def timestamp_day_is_always24h(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "timestamp_day_is_always24h", value)

    @_builtins.property
    @pulumi.getter(name="timestampInputFormat")
    def timestamp_input_format(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def timestamp_input_format(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "timestamp_input_format", value)

    @_builtins.property
    @pulumi.getter(name="timestampLtzOutputFormat")
    def timestamp_ltz_output_format(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def timestamp_ltz_output_format(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "timestamp_ltz_output_format", value)

    @_builtins.property
    @pulumi.getter(name="timestampNtzOutputFormat")
    def timestamp_ntz_output_format(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def timestamp_ntz_output_format(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "timestamp_ntz_output_format", value)

    @_builtins.property
    @pulumi.getter(name="timestampOutputFormat")
    def timestamp_output_format(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def timestamp_output_format(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "timestamp_output_format", value)

    @_builtins.property
    @pulumi.getter(name="timestampTypeMapping")
    def timestamp_type_mapping(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def timestamp_type_mapping(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "timestamp_type_mapping", value)

    @_builtins.property
    @pulumi.getter(name="timestampTzOutputFormat")
    def timestamp_tz_output_format(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def timestamp_tz_output_format(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def transaction_abort_on_error(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def transaction_abort_on_error(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "transaction_abort_on_error", value)

    @_builtins.property
    @pulumi.getter(name="transactionDefaultIsolationLevel")
    def transaction_default_isolation_level(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def transaction_default_isolation_level(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "transaction_default_isolation_level", value)

    @_builtins.property
    @pulumi.getter(name="twoDigitCenturyStart")
    def two_digit_century_start(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    def two_digit_century_start(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "two_digit_century_start", value)

    @_builtins.property
    @pulumi.getter(name="unsupportedDdlAction")
    def unsupported_ddl_action(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def unsupported_ddl_action(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "unsupported_ddl_action", value)

    @_builtins.property
    @pulumi.getter(name="useCachedResult")
    def use_cached_result(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def use_cached_result(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def week_of_year_policy(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    def week_of_year_policy(self, value: pulumi.Input[Optional[_builtins.int]]):
...
class _CurrentOrganizationAccountState:
    def __init__(__self__, *,
                 ...
                 serverless_task_min_statement_size: pulumi.Input[Optional[_builtins.str]] = None,
                 session_policy: pulumi.Input[Optional[_builtins.str]] = None,
                 show_outputs: pulumi.Input[Optional[Sequence[pulumi.Input['CurrentOrganizationAccountShowOutputArgs']]]] = None,
                 simulated_data_sharing_consumer: pulumi.Input[Optional[_builtins.str]] = None,
                 sso_login_page: pulumi.Input[Optional[_builtins.bool]] = None,
                 statement_queued_timeout_in_seconds: pulumi.Input[Optional[_builtins.int]] = None,
                 statement_timeout_in_seconds: pulumi.Input[Optional[_builtins.int]] = None,
    ...
    def show_outputs(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['CurrentOrganizationAccountShowOutputArgs']]]]:
        """
    ...
    @show_outputs.setter
    def show_outputs(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['CurrentOrganizationAccountShowOutputArgs']]]]):
...
class CurrentOrganizationAccount(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            serverless_task_min_statement_size: pulumi.Input[Optional[_builtins.str]] = None,
            session_policy: pulumi.Input[Optional[_builtins.str]] = None,
            show_outputs: pulumi.Input[Optional[Sequence[pulumi.Input[Union['CurrentOrganizationAccountShowOutputArgs', 'CurrentOrganizationAccountShowOutputArgsDict', 'outputs.CurrentOrganizationAccountShowOutput']]]]] = None,
            simulated_data_sharing_consumer: pulumi.Input[Optional[_builtins.str]] = None,
            sso_login_page: pulumi.Input[Optional[_builtins.bool]] = None,
            statement_queued_timeout_in_seconds: pulumi.Input[Optional[_builtins.int]] = None,
            statement_timeout_in_seconds: pulumi.Input[Optional[_builtins.int]] = None,
            ...
            user_task_timeout_ms: pulumi.Input[Optional[_builtins.int]] = None,
            week_of_year_policy: pulumi.Input[Optional[_builtins.int]] = None,
            week_start: pulumi.Input[Optional[_builtins.int]] = None) -> 'CurrentOrganizationAccount':
        """
        ...
        :param pulumi.Input[_builtins.str] serverless_task_min_statement_size: Specifies the minimum allowed warehouse size for [Serverless tasks](https://docs.snowflake.com/en/user-guide/tasks-intro.html#label-tasks-compute-resources-serverless). Valid values are (case-insensitive): `XSMALL` | `X-SMALL` | `SMALL` | `MEDIUM` | `LARGE` | `XLARGE` | `X-LARGE` | `XXLARGE` | `X2LARGE` | `2X-LARGE` | `XXXLARGE` | `X3LARGE` | `3X-LARGE` | `X4LARGE` | `4X-LARGE` | `X5LARGE` | `5X-LARGE` | `X6LARGE` | `6X-LARGE`. For more information, check [SERVERLESS*TASK*MIN*STATEMENT*SIZE docs](https://docs.snowflake.com/en/sql-reference/parameters#serverless-task-min-statement-size).
        :param pulumi.Input[_builtins.str] session_policy: Specifies [session policy](https://docs.snowflake.com/en/user-guide/session-policies-using) for the current account.
        :param pulumi.Input[Sequence[pulumi.Input[Union['CurrentOrganizationAccountShowOutputArgs', 'CurrentOrganizationAccountShowOutputArgsDict', 'outputs.CurrentOrganizationAccountShowOutput']]]] show_outputs: Saved output for the result of `SHOW ORGANIZATION ACCOUNTS`
        :param pulumi.Input[_builtins.str] simulated_data_sharing_consumer: Specifies the name of a consumer account to simulate for testing/validating shared data, particularly shared secure views. When this parameter is set in a session, shared views return rows as if executed in the specified consumer account rather than the provider account. For more information, check [SIMULATED*DATA*SHARING_CONSUMER docs](https://docs.snowflake.com/en/sql-reference/parameters#simulated-data-sharing-consumer).
        :param pulumi.Input[_builtins.bool] sso_login_page: This deprecated parameter disables preview mode for testing SSO (after enabling federated authentication) before rolling it out to users. For more information, check [SSO*LOGIN*PAGE docs](https://docs.snowflake.com/en/sql-reference/parameters#sso-login-page).
        :param pulumi.Input[_builtins.int] statement_queued_timeout_in_seconds: Amount of time, in seconds, a SQL statement (query, DDL, DML, etc.) remains queued for a warehouse before it is canceled by the system. This parameter can be used in conjunction with the [MAX*CONCURRENCY*LEVEL](https://docs.snowflake.com/en/sql-reference/parameters#label-max-concurrency-level) parameter to ensure a warehouse is never backlogged. For more information, check [STATEMENT*QUEUED*TIMEOUT*IN*SECONDS docs](https://docs.snowflake.com/en/sql-reference/parameters#statement-queued-timeout-in-seconds).
        :param pulumi.Input[_builtins.int] statement_timeout_in_seconds: Amount of time, in seconds, after which a running SQL statement (query, DDL, DML, etc.) is canceled by the system. For more information, check [STATEMENT*TIMEOUT*IN_SECONDS docs](https://docs.snowflake.com/en/sql-reference/parameters#statement-timeout-in-seconds).
