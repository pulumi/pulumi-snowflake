...
class _OauthIntegrationForPartnerApplicationsState:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 oauth_client: pulumi.Input[Optional[_builtins.str]] = None,
                 oauth_issue_refresh_tokens: pulumi.Input[Optional[_builtins.str]] = None,
                 oauth_redirect_uri: pulumi.Input[Optional[_builtins.str]] = None,
                 oauth_refresh_token_validity: pulumi.Input[Optional[_builtins.int]] = None,
                 oauth_use_secondary_roles: pulumi.Input[Optional[_builtins.str]] = None,
                 related_parameters: pulumi.Input[Optional[Sequence[pulumi.Input['OauthIntegrationForPartnerApplicationsRelatedParameterArgs']]]] = None,
                 show_outputs: pulumi.Input[Optional[Sequence[pulumi.Input['OauthIntegrationForPartnerApplicationsShowOutputArgs']]]] = None):
        """
    ...
    def describe_outputs(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['OauthIntegrationForPartnerApplicationsDescribeOutputArgs']]]]:
        """
    ...
    def describe_outputs(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['OauthIntegrationForPartnerApplicationsDescribeOutputArgs']]]]):
    ...
    @_builtins.property
    @pulumi.getter(name="oauthClient")
    def oauth_client(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Creates an OAuth interface between Snowflake and a partner application. Valid options are: `LOOKER` | `TABLEAU_DESKTOP` | `TABLEAU_SERVER`.
        """
        return pulumi.get(self, "oauth_client")
    ...
    @oauth_client.setter
    def oauth_client(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "oauth_client", value)
    ...
    def related_parameters(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['OauthIntegrationForPartnerApplicationsRelatedParameterArgs']]]]:
        """
    ...
    def related_parameters(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['OauthIntegrationForPartnerApplicationsRelatedParameterArgs']]]]):
        pulumi.set(self, "related_parameters", value)

    @_builtins.property
    @pulumi.getter(name="showOutputs")
    def show_outputs(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['OauthIntegrationForPartnerApplicationsShowOutputArgs']]]]:
        """
    ...
    @show_outputs.setter
    def show_outputs(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['OauthIntegrationForPartnerApplicationsShowOutputArgs']]]]):
...
class OauthIntegrationForPartnerApplications(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            blocked_roles_lists: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            comment: pulumi.Input[Optional[_builtins.str]] = None,
            describe_outputs: pulumi.Input[Optional[Sequence[pulumi.Input[Union['OauthIntegrationForPartnerApplicationsDescribeOutputArgs', 'OauthIntegrationForPartnerApplicationsDescribeOutputArgsDict', 'outputs.OauthIntegrationForPartnerApplicationsDescribeOutput']]]]] = None,
            enabled: pulumi.Input[Optional[_builtins.str]] = None,
            fully_qualified_name: pulumi.Input[Optional[_builtins.str]] = None,
            name: pulumi.Input[Optional[_builtins.str]] = None,
            oauth_client: pulumi.Input[Optional[_builtins.str]] = None,
            ...
            oauth_refresh_token_validity: pulumi.Input[Optional[_builtins.int]] = None,
            oauth_use_secondary_roles: pulumi.Input[Optional[_builtins.str]] = None,
            related_parameters: pulumi.Input[Optional[Sequence[pulumi.Input[Union['OauthIntegrationForPartnerApplicationsRelatedParameterArgs', 'OauthIntegrationForPartnerApplicationsRelatedParameterArgsDict', 'outputs.OauthIntegrationForPartnerApplicationsRelatedParameter']]]]] = None,
            show_outputs: pulumi.Input[Optional[Sequence[pulumi.Input[Union['OauthIntegrationForPartnerApplicationsShowOutputArgs', 'OauthIntegrationForPartnerApplicationsShowOutputArgsDict', 'outputs.OauthIntegrationForPartnerApplicationsShowOutput']]]]] = None) -> 'OauthIntegrationForPartnerApplications':
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] blocked_roles_lists: A set of Snowflake roles that a user cannot explicitly consent to using after authenticating. By default, this list includes the ACCOUNTADMIN, ORGADMIN and SECURITYADMIN roles. To remove these privileged roles from the list, use the ALTER ACCOUNT command to set the OAUTH*ADD*PRIVILEGED*ROLES*TO*BLOCKED*LIST account parameter to FALSE. For more information about this resource, see docs.
        :param pulumi.Input[_builtins.str] comment: Specifies a comment for the OAuth integration.
        :param pulumi.Input[Sequence[pulumi.Input[Union['OauthIntegrationForPartnerApplicationsDescribeOutputArgs', 'OauthIntegrationForPartnerApplicationsDescribeOutputArgsDict', 'outputs.OauthIntegrationForPartnerApplicationsDescribeOutput']]]] describe_outputs: Outputs the result of `DESCRIBE SECURITY INTEGRATION` for the given integration.
        :param pulumi.Input[_builtins.str] enabled: (Default: fallback to Snowflake default - uses special value that cannot be set in the configuration manually (`default`)) Specifies whether this OAuth integration is enabled or disabled. Available options are: "true" or "false". When the value is not set in the configuration the provider will put "default" there which means to use the Snowflake default for this value.
        :param pulumi.Input[_builtins.str] fully_qualified_name: Fully qualified name of the resource. For more information, see [object name resolution](https://docs.snowflake.com/en/sql-reference/name-resolution).
        :param pulumi.Input[_builtins.str] name: Specifies the name of the OAuth integration. This name follows the rules for Object Identifiers. The name should be unique among security integrations in your account. Due to technical limitations (read more here), avoid using the following characters: `|`, `.`, `"`.
        :param pulumi.Input[_builtins.str] oauth_client: Creates an OAuth interface between Snowflake and a partner application. Valid options are: `LOOKER` | `TABLEAU_DESKTOP` | `TABLEAU_SERVER`.
        ...
        :param pulumi.Input[_builtins.int] oauth_refresh_token_validity: (Default: fallback to Snowflake default - uses special value that cannot be set in the configuration manually (`-1`)) Specifies how long refresh tokens should be valid (in seconds). OAUTH*ISSUE*REFRESH_TOKENS must be set to TRUE.
        :param pulumi.Input[_builtins.str] oauth_use_secondary_roles: Specifies whether default secondary roles set in the user properties are activated by default in the session being opened. Valid options are: `IMPLICIT` | `NONE`.
        :param pulumi.Input[Sequence[pulumi.Input[Union['OauthIntegrationForPartnerApplicationsRelatedParameterArgs', 'OauthIntegrationForPartnerApplicationsRelatedParameterArgsDict', 'outputs.OauthIntegrationForPartnerApplicationsRelatedParameter']]]] related_parameters: Parameters related to this security integration.
        :param pulumi.Input[Sequence[pulumi.Input[Union['OauthIntegrationForPartnerApplicationsShowOutputArgs', 'OauthIntegrationForPartnerApplicationsShowOutputArgsDict', 'outputs.OauthIntegrationForPartnerApplicationsShowOutput']]]] show_outputs: Outputs the result of `SHOW SECURITY INTEGRATION` for the given integration.
        """
