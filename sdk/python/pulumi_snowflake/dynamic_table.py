...
class DynamicTable(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if target_lag is not None and not isinstance(target_lag, DynamicTableTargetLagArgs):
                target_lag = target_lag or {}
                def _setter(key, value):
                    target_lag[key] = value
                DynamicTableTargetLagArgs._configure(_setter, **target_lag)
