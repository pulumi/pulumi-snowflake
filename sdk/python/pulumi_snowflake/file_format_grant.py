...
class FileFormatGrantArgs:
    def __init__(__self__, *,
        ...
        """
        FileFormatGrantArgs._configure(
    ...
    def _configure(
        ...
        if file_format_name is None and 'fileFormatName' in kwargs:
        ...
        if file_format_name is not None:
            _setter("file_format_name", file_format_name)
...
class _FileFormatGrantState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] with_grant_option: When this is set to true, allows the recipient role to grant the privileges to other roles.
        """
        _FileFormatGrantState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            database_name=database_name,
            enable_multiple_grants=enable_multiple_grants,
            file_format_name=file_format_name,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            FileFormatGrantArgs._configure(_setter, **kwargs)
