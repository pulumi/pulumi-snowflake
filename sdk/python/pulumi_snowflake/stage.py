...
class Stage(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        > **Deprecation** This resource is deprecated and will be removed in a future major version release. Please use one of the new resources instead: `StageInternal` | `StageExternalS3` | `StageExternalS3Compatible` | `StageExternalGcs` | `StageExternalAzure`. <deprecation>
