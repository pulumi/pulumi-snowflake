...
public final class StageInternalDescribeOutputFileFormatOrcArgs extends com.pulumi.resources.ResourceArgs {

    public static final StageInternalDescribeOutputFileFormatOrcArgs Empty = new StageInternalDescribeOutputFileFormatOrcArgs();
    ...
    private StageInternalDescribeOutputFileFormatOrcArgs() {}

    private StageInternalDescribeOutputFileFormatOrcArgs(StageInternalDescribeOutputFileFormatOrcArgs $) {
    ...
    public static Builder builder(StageInternalDescribeOutputFileFormatOrcArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StageInternalDescribeOutputFileFormatOrcArgs();
        }

        public Builder(StageInternalDescribeOutputFileFormatOrcArgs defaults) {
            $ = new StageInternalDescribeOutputFileFormatOrcArgs(Objects.requireNonNull(defaults));
        }
        ...
        public StageInternalDescribeOutputFileFormatOrcArgs build() {
            return $;
        }
    }
