...
import com.pulumi.snowflake.inputs.ProcedureJavaParameterArgs;
import com.pulumi.snowflake.inputs.ProcedureJavaSecretArgs;
import com.pulumi.snowflake.inputs.ProcedureJavaShowOutputArgs;
...
public final class ProcedureJavaState extends com.pulumi.resources.ResourceArgs {

    public static final ProcedureJavaState Empty = new ProcedureJavaState();
    ...
    private @Nullable Output<List<ProcedureJavaArgumentArgs>> arguments;
     ...
     * 
     */
    public Optional<Output<List<ProcedureJavaArgumentArgs>>> arguments() {
     ...
     */
    @Import(name="imports")
    private @Nullable Output<List<ProcedureJavaImportArgs>> imports;
     ...
     * 
     */
    public Optional<Output<List<ProcedureJavaImportArgs>>> imports() {
    ...
    private @Nullable Output<List<ProcedureJavaParameterArgs>> parameters;

    /**
     * @return Outputs the result of `SHOW PARAMETERS IN PROCEDURE` for the given procedure.
     * 
     */
    public Optional<Output<List<ProcedureJavaParameterArgs>>> parameters() {
    ...
    /**
     * @return The language runtime version to use. Currently, the supported versions are: 11.
     * 
     */
     ...
     */
    @Import(name="secrets")
    private @Nullable Output<List<ProcedureJavaSecretArgs>> secrets;

    /**
     * @return Assigns the names of [secrets](https://docs.snowflake.com/en/sql-reference/sql/create-secret) to variables so that you can use the variables to reference the secrets when retrieving information from secrets in handler code. Secrets you specify here must be allowed by the [external access integration](https://docs.snowflake.com/en/sql-reference/sql/create-external-access-integration) specified as a value of this CREATE FUNCTION command’s EXTERNAL*ACCESS*INTEGRATIONS parameter.
     * 
     */
    public Optional<Output<List<ProcedureJavaSecretArgs>>> secrets() {
    ...
    private @Nullable Output<List<ProcedureJavaShowOutputArgs>> showOutputs;

    /**
     * @return Outputs the result of `SHOW PROCEDURE` for the given procedure.
     * 
     */
    public Optional<Output<List<ProcedureJavaShowOutputArgs>>> showOutputs() {
    ...
    private @Nullable Output<ProcedureJavaTargetPathArgs> targetPath;

    /**
     * @return Use the fully qualified name of the method or function for the stored procedure. This is typically in the following form `com.my_company.my_package.MyClass.myMethod` where `com.my_company.my_package` corresponds to the package containing the object or class: `package com.my_company.my_package;`.
     * 
     */
    public Optional<Output<ProcedureJavaTargetPathArgs>> targetPath() {
    ...
    private ProcedureJavaState() {}

    private ProcedureJavaState(ProcedureJavaState $) {
    ...
    public static Builder builder(ProcedureJavaState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProcedureJavaState();
        }

        public Builder(ProcedureJavaState defaults) {
            $ = new ProcedureJavaState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder arguments(@Nullable Output<List<ProcedureJavaArgumentArgs>> arguments) {
            $.arguments = arguments;
            return this;
        }
         ...
         * 
         */
        public Builder arguments(List<ProcedureJavaArgumentArgs> arguments) {
         ...
         * 
         */
        public Builder arguments(ProcedureJavaArgumentArgs... arguments) {
         ...
         * 
         */
        public Builder imports(@Nullable Output<List<ProcedureJavaImportArgs>> imports) {
            $.imports = imports;
            return this;
        }
         ...
         * 
         */
        public Builder imports(List<ProcedureJavaImportArgs> imports) {
         ...
         * 
         */
        public Builder imports(ProcedureJavaImportArgs... imports) {
         ...
         * 
         */
        public Builder parameters(@Nullable Output<List<ProcedureJavaParameterArgs>> parameters) {
         ...
         * 
         */
        public Builder parameters(List<ProcedureJavaParameterArgs> parameters) {
         ...
         * 
         */
        public Builder parameters(ProcedureJavaParameterArgs... parameters) {
        ...
        /**
         * @param runtimeVersion The language runtime version to use. Currently, the supported versions are: 11.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder secrets(@Nullable Output<List<ProcedureJavaSecretArgs>> secrets) {
            $.secrets = secrets;
            return this;
        }
         ...
         * 
         */
        public Builder secrets(List<ProcedureJavaSecretArgs> secrets) {
         ...
         * 
         */
        public Builder secrets(ProcedureJavaSecretArgs... secrets) {
         ...
         * 
         */
        public Builder showOutputs(@Nullable Output<List<ProcedureJavaShowOutputArgs>> showOutputs) {
         ...
         * 
         */
        public Builder showOutputs(List<ProcedureJavaShowOutputArgs> showOutputs) {
         ...
         * 
         */
        public Builder showOutputs(ProcedureJavaShowOutputArgs... showOutputs) {
         ...
         * 
         */
        public Builder targetPath(@Nullable Output<ProcedureJavaTargetPathArgs> targetPath) {
         ...
         * 
         */
        public Builder targetPath(ProcedureJavaTargetPathArgs targetPath) {
        ...
        public ProcedureJavaState build() {
            return $;
        }
    }
