...
public final class GetIcebergTablesInArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetIcebergTablesInArgs Empty = new GetIcebergTablesInArgs();
    ...
    private GetIcebergTablesInArgs() {}

    private GetIcebergTablesInArgs(GetIcebergTablesInArgs $) {
    ...
    public static Builder builder(GetIcebergTablesInArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetIcebergTablesInArgs();
        }

        public Builder(GetIcebergTablesInArgs defaults) {
            $ = new GetIcebergTablesInArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetIcebergTablesInArgs build() {
            return $;
        }
    }
