...
public final class GetTasksLimitArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetTasksLimitArgs Empty = new GetTasksLimitArgs();
    ...
    private GetTasksLimitArgs() {}

    private GetTasksLimitArgs(GetTasksLimitArgs $) {
        this.from = $.from;
        this.rows = $.rows;
    }
    ...
    public static Builder builder(GetTasksLimitArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetTasksLimitArgs();
        }

        public Builder(GetTasksLimitArgs defaults) {
            $ = new GetTasksLimitArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetTasksLimitArgs build() {
            if ($.rows == null) {
                throw new MissingRequiredPropertyException("GetTasksLimitArgs", "rows");
            }
            return $;
        }
    }
