...
public final class GetViewsLimitArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetViewsLimitArgs Empty = new GetViewsLimitArgs();
    ...
    private GetViewsLimitArgs() {}

    private GetViewsLimitArgs(GetViewsLimitArgs $) {
        this.from = $.from;
        this.rows = $.rows;
    }
    ...
    public static Builder builder(GetViewsLimitArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetViewsLimitArgs();
        }

        public Builder(GetViewsLimitArgs defaults) {
            $ = new GetViewsLimitArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetViewsLimitArgs build() {
            if ($.rows == null) {
                throw new MissingRequiredPropertyException("GetViewsLimitArgs", "rows");
            }
            return $;
        }
    }
