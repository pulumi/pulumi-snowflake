...
@CustomType
public final class GrantPrivilegesToDatabaseRoleOnSchemaObjectInherited {
    /**
    ...
    private GrantPrivilegesToDatabaseRoleOnSchemaObjectInherited() {}
    /**
     * @return The fully qualified name of the database.
     * 
     */
    ...
    public static Builder builder(GrantPrivilegesToDatabaseRoleOnSchemaObjectInherited defaults) {
    ...
    public static final class Builder {
        ...
        private String objectTypePlural;
        public Builder() {}
        public Builder(GrantPrivilegesToDatabaseRoleOnSchemaObjectInherited defaults) {
        ...
        public Builder objectTypePlural(String objectTypePlural) {
            if (objectTypePlural == null) {
              throw new MissingRequiredPropertyException("GrantPrivilegesToDatabaseRoleOnSchemaObjectInherited", "objectTypePlural");
            }
            this.objectTypePlural = objectTypePlural;
            return this;
        }
        public GrantPrivilegesToDatabaseRoleOnSchemaObjectInherited build() {
            final var _resultValue = new GrantPrivilegesToDatabaseRoleOnSchemaObjectInherited();
