...
@CustomType
public final class FunctionJavaArgument {
    /**
    ...
    public static Builder builder(FunctionJavaArgument defaults) {
    ...
    public static final class Builder {
        ...
        private String argName;
        public Builder() {}
        public Builder(FunctionJavaArgument defaults) {
        ...
        public Builder argDataType(String argDataType) {
            if (argDataType == null) {
              throw new MissingRequiredPropertyException("FunctionJavaArgument", "argDataType");
            }
        ...
        public Builder argName(String argName) {
            if (argName == null) {
              throw new MissingRequiredPropertyException("FunctionJavaArgument", "argName");
            }
            this.argName = argName;
            return this;
        }
        public FunctionJavaArgument build() {
            final var _resultValue = new FunctionJavaArgument();
