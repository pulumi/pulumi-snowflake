...
public final class GetViewsInArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetViewsInArgs Empty = new GetViewsInArgs();
    ...
    private GetViewsInArgs() {}

    private GetViewsInArgs(GetViewsInArgs $) {
    ...
    public static Builder builder(GetViewsInArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetViewsInArgs defaults) {
            $ = new GetViewsInArgs(Objects.requireNonNull(defaults));
        }
