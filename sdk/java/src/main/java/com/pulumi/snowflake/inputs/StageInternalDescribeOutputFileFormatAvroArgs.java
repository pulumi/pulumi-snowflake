...
public final class StageInternalDescribeOutputFileFormatAvroArgs extends com.pulumi.resources.ResourceArgs {

    public static final StageInternalDescribeOutputFileFormatAvroArgs Empty = new StageInternalDescribeOutputFileFormatAvroArgs();
    ...
    private StageInternalDescribeOutputFileFormatAvroArgs() {}

    private StageInternalDescribeOutputFileFormatAvroArgs(StageInternalDescribeOutputFileFormatAvroArgs $) {
    ...
    public static Builder builder(StageInternalDescribeOutputFileFormatAvroArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StageInternalDescribeOutputFileFormatAvroArgs();
        }

        public Builder(StageInternalDescribeOutputFileFormatAvroArgs defaults) {
            $ = new StageInternalDescribeOutputFileFormatAvroArgs(Objects.requireNonNull(defaults));
        }
        ...
        public StageInternalDescribeOutputFileFormatAvroArgs build() {
            return $;
        }
    }
