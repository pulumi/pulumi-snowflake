...
import com.pulumi.snowflake.ApiAuthenticationIntegrationWithClientCredentialsArgs;
import com.pulumi.snowflake.Utilities;
import com.pulumi.snowflake.inputs.ApiAuthenticationIntegrationWithClientCredentialsState;
import com.pulumi.snowflake.outputs.ApiAuthenticationIntegrationWithClientCredentialsDescribeOutput;
import com.pulumi.snowflake.outputs.ApiAuthenticationIntegrationWithClientCredentialsShowOutput;
 ...
 * 
 */
@ResourceType(type="snowflake:index/apiAuthenticationIntegrationWithClientCredentials:ApiAuthenticationIntegrationWithClientCredentials")
public class ApiAuthenticationIntegrationWithClientCredentials extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="describeOutputs", refs={List.class,ApiAuthenticationIntegrationWithClientCredentialsDescribeOutput.class}, tree="[0,1]")
    private Output<List<ApiAuthenticationIntegrationWithClientCredentialsDescribeOutput>> describeOutputs;

    /**
     * @return Outputs the result of `DESCRIBE SECURITY INTEGRATIONS` for the given security integration.
     * 
     */
    public Output<List<ApiAuthenticationIntegrationWithClientCredentialsDescribeOutput>> describeOutputs() {
     ...
     * 
     */
    @Export(name="showOutputs", refs={List.class,ApiAuthenticationIntegrationWithClientCredentialsShowOutput.class}, tree="[0,1]")
    private Output<List<ApiAuthenticationIntegrationWithClientCredentialsShowOutput>> showOutputs;

    /**
     * @return Outputs the result of `SHOW SECURITY INTEGRATIONS` for the given security integration.
     * 
     */
    public Output<List<ApiAuthenticationIntegrationWithClientCredentialsShowOutput>> showOutputs() {
    ...
    public ApiAuthenticationIntegrationWithClientCredentials(String name, ApiAuthenticationIntegrationWithClientCredentialsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("snowflake:index/apiAuthenticationIntegrationWithClientCredentials:ApiAuthenticationIntegrationWithClientCredentials", name, args == null ? ApiAuthenticationIntegrationWithClientCredentialsArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
