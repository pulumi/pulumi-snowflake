...
import com.pulumi.snowflake.inputs.GrantPrivilegesToAccountRoleOnSchemaObjectInheritedArgs;
...
public final class GrantPrivilegesToAccountRoleOnSchemaObjectArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<GrantPrivilegesToAccountRoleOnSchemaObjectInheritedArgs> inherited;

    /**
     * @return Configures an inherited privilege to be granted on all current and future objects of a given type in the account, a database, or a schema. See [Inherited grants](https://docs.snowflake.com/en/user-guide/inherited-grants-using) for more details. This field can be only used when `INHERITED_GRANTS` option is specified in provider block in the `experimentalFeaturesEnabled` field.
     * 
     */
    public Optional<Output<GrantPrivilegesToAccountRoleOnSchemaObjectInheritedArgs>> inherited() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder inherited(@Nullable Output<GrantPrivilegesToAccountRoleOnSchemaObjectInheritedArgs> inherited) {
            $.inherited = inherited;
            return this;
        }
         ...
         * 
         */
        public Builder inherited(GrantPrivilegesToAccountRoleOnSchemaObjectInheritedArgs inherited) {
