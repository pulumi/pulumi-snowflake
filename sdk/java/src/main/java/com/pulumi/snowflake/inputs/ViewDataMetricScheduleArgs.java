...
public final class ViewDataMetricScheduleArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Specifies an interval (in minutes) of wait time inserted between runs of the data metric function. Conflicts with `using_cron`. Valid values are: `5` | `15` | `30` | `60` | `720` | `1440`. Due to Snowflake limitations, changes in this field is not managed by the provider. Please consider using taint metadata argument.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param minutes Specifies an interval (in minutes) of wait time inserted between runs of the data metric function. Conflicts with `using_cron`. Valid values are: `5` | `15` | `30` | `60` | `720` | `1440`. Due to Snowflake limitations, changes in this field is not managed by the provider. Please consider using taint metadata argument.
         * 
         * @return builder
         * 
         */
