...
public final class GetStreamsLimitArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetStreamsLimitArgs Empty = new GetStreamsLimitArgs();
    ...
    private GetStreamsLimitArgs() {}

    private GetStreamsLimitArgs(GetStreamsLimitArgs $) {
        this.from = $.from;
        this.rows = $.rows;
    }
    ...
    public static Builder builder(GetStreamsLimitArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetStreamsLimitArgs();
        }

        public Builder(GetStreamsLimitArgs defaults) {
            $ = new GetStreamsLimitArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetStreamsLimitArgs build() {
            if ($.rows == null) {
                throw new MissingRequiredPropertyException("GetStreamsLimitArgs", "rows");
            }
            return $;
        }
    }
