...
public final class GetHybridTablesInArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetHybridTablesInArgs Empty = new GetHybridTablesInArgs();
    ...
    private GetHybridTablesInArgs() {}

    private GetHybridTablesInArgs(GetHybridTablesInArgs $) {
    ...
    public static Builder builder(GetHybridTablesInArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetHybridTablesInArgs();
        }

        public Builder(GetHybridTablesInArgs defaults) {
            $ = new GetHybridTablesInArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetHybridTablesInArgs build() {
            return $;
        }
    }
