...
@CustomType
public final class ProcedureScalaShowOutput {
    ...
    public static Builder builder(ProcedureScalaShowOutput defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean validForClustering;
        public Builder() {}
        public Builder(ProcedureScalaShowOutput defaults) {
        ...
        public ProcedureScalaShowOutput build() {
            final var _resultValue = new ProcedureScalaShowOutput();
