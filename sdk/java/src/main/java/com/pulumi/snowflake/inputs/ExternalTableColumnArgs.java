...
public final class ExternalTableColumnArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public ExternalTableColumnArgs build() {
            if ($.as == null) {
                throw new MissingRequiredPropertyException("ExternalTableColumnArgs", "as");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ExternalTableColumnArgs", "name");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("ExternalTableColumnArgs", "type");
            }
            return $;
        }
    }
