...
public final class StageExternalS3CompatibleDescribeOutputFileFormatAvroArgs extends com.pulumi.resources.ResourceArgs {

    public static final StageExternalS3CompatibleDescribeOutputFileFormatAvroArgs Empty = new StageExternalS3CompatibleDescribeOutputFileFormatAvroArgs();
    ...
    private StageExternalS3CompatibleDescribeOutputFileFormatAvroArgs() {}

    private StageExternalS3CompatibleDescribeOutputFileFormatAvroArgs(StageExternalS3CompatibleDescribeOutputFileFormatAvroArgs $) {
    ...
    public static Builder builder(StageExternalS3CompatibleDescribeOutputFileFormatAvroArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StageExternalS3CompatibleDescribeOutputFileFormatAvroArgs();
        }

        public Builder(StageExternalS3CompatibleDescribeOutputFileFormatAvroArgs defaults) {
            $ = new StageExternalS3CompatibleDescribeOutputFileFormatAvroArgs(Objects.requireNonNull(defaults));
        }
        ...
        public StageExternalS3CompatibleDescribeOutputFileFormatAvroArgs build() {
            return $;
        }
    }
