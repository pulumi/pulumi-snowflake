...
public final class StageExternalS3DescribeOutputFileFormatOrcArgs extends com.pulumi.resources.ResourceArgs {

    public static final StageExternalS3DescribeOutputFileFormatOrcArgs Empty = new StageExternalS3DescribeOutputFileFormatOrcArgs();
    ...
    private StageExternalS3DescribeOutputFileFormatOrcArgs() {}

    private StageExternalS3DescribeOutputFileFormatOrcArgs(StageExternalS3DescribeOutputFileFormatOrcArgs $) {
    ...
    public static Builder builder(StageExternalS3DescribeOutputFileFormatOrcArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StageExternalS3DescribeOutputFileFormatOrcArgs();
        }

        public Builder(StageExternalS3DescribeOutputFileFormatOrcArgs defaults) {
            $ = new StageExternalS3DescribeOutputFileFormatOrcArgs(Objects.requireNonNull(defaults));
        }
        ...
        public StageExternalS3DescribeOutputFileFormatOrcArgs build() {
            return $;
        }
    }
