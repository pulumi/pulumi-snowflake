...
@CustomType
public final class ProcedureScalaImport {
    /**
    ...
    public static Builder builder(ProcedureScalaImport defaults) {
    ...
    public static final class Builder {
        ...
        private String stageLocation;
        public Builder() {}
        public Builder(ProcedureScalaImport defaults) {
        ...
        public Builder pathOnStage(String pathOnStage) {
            if (pathOnStage == null) {
              throw new MissingRequiredPropertyException("ProcedureScalaImport", "pathOnStage");
            }
        ...
        public Builder stageLocation(String stageLocation) {
            if (stageLocation == null) {
              throw new MissingRequiredPropertyException("ProcedureScalaImport", "stageLocation");
            }
            this.stageLocation = stageLocation;
            return this;
        }
        public ProcedureScalaImport build() {
            final var _resultValue = new ProcedureScalaImport();
