...
public final class GetSessionPoliciesIn extends com.pulumi.resources.InvokeArgs {

    public static final GetSessionPoliciesIn Empty = new GetSessionPoliciesIn();
    ...
    private GetSessionPoliciesIn() {}

    private GetSessionPoliciesIn(GetSessionPoliciesIn $) {
    ...
    public static Builder builder(GetSessionPoliciesIn defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSessionPoliciesIn();
        }

        public Builder(GetSessionPoliciesIn defaults) {
            $ = new GetSessionPoliciesIn(Objects.requireNonNull(defaults));
        }
        ...
        public GetSessionPoliciesIn build() {
            return $;
        }
    }
