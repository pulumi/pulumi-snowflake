...
@CustomType
public final class ScimIntegrationShowOutput {
    ...
    private ScimIntegrationShowOutput() {}
    ...
    public static Builder builder(ScimIntegrationShowOutput defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String name;
        public Builder() {}
        public Builder(ScimIntegrationShowOutput defaults) {
        ...
        public ScimIntegrationShowOutput build() {
            final var _resultValue = new ScimIntegrationShowOutput();
