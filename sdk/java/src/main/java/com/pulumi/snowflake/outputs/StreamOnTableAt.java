...
@CustomType
public final class StreamOnTableAt {
    /**
    ...
    public static Builder builder(StreamOnTableAt defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String timestamp;
        public Builder() {}
        public Builder(StreamOnTableAt defaults) {
        ...
        public StreamOnTableAt build() {
            final var _resultValue = new StreamOnTableAt();
