...
@CustomType
public final class FileFormatParquetShowOutput {
    private @Nullable String comment;
    private @Nullable String createdOn;
    private @Nullable String databaseName;
    private @Nullable String formatOptions;
    ...
    private FileFormatParquetShowOutput() {}
    ...
    public Optional<String> formatOptions() {
    ...
    public static Builder builder(FileFormatParquetShowOutput defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String type;
        public Builder() {}
        public Builder(FileFormatParquetShowOutput defaults) {
        ...
        @CustomType.Setter
        public Builder formatOptions(@Nullable String formatOptions) {
        ...
        public FileFormatParquetShowOutput build() {
            final var _resultValue = new FileFormatParquetShowOutput();
