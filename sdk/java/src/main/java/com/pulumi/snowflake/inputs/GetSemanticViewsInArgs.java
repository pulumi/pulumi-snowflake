...
public final class GetSemanticViewsInArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetSemanticViewsInArgs Empty = new GetSemanticViewsInArgs();
    ...
    private GetSemanticViewsInArgs() {}

    private GetSemanticViewsInArgs(GetSemanticViewsInArgs $) {
    ...
    public static Builder builder(GetSemanticViewsInArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSemanticViewsInArgs();
        }

        public Builder(GetSemanticViewsInArgs defaults) {
            $ = new GetSemanticViewsInArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetSemanticViewsInArgs build() {
            return $;
        }
    }
