...
public final class AccountGrantState extends com.pulumi.resources.ResourceArgs {

    public static final AccountGrantState Empty = new AccountGrantState();
    ...
    private AccountGrantState() {}

    private AccountGrantState(AccountGrantState $) {
    ...
    public static Builder builder(AccountGrantState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AccountGrantState();
        }

        public Builder(AccountGrantState defaults) {
            $ = new AccountGrantState(Objects.requireNonNull(defaults));
        }
        ...
        public AccountGrantState build() {
            return $;
        }
    }
