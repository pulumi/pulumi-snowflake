...
public final class StageExternalAzureDescribeOutputFileFormatAvroArgs extends com.pulumi.resources.ResourceArgs {

    public static final StageExternalAzureDescribeOutputFileFormatAvroArgs Empty = new StageExternalAzureDescribeOutputFileFormatAvroArgs();
    ...
    private StageExternalAzureDescribeOutputFileFormatAvroArgs() {}

    private StageExternalAzureDescribeOutputFileFormatAvroArgs(StageExternalAzureDescribeOutputFileFormatAvroArgs $) {
    ...
    public static Builder builder(StageExternalAzureDescribeOutputFileFormatAvroArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StageExternalAzureDescribeOutputFileFormatAvroArgs();
        }

        public Builder(StageExternalAzureDescribeOutputFileFormatAvroArgs defaults) {
            $ = new StageExternalAzureDescribeOutputFileFormatAvroArgs(Objects.requireNonNull(defaults));
        }
        ...
        public StageExternalAzureDescribeOutputFileFormatAvroArgs build() {
            return $;
        }
    }
