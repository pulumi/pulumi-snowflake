...
public final class GetIcebergTablesIn extends com.pulumi.resources.InvokeArgs {

    public static final GetIcebergTablesIn Empty = new GetIcebergTablesIn();
    ...
    private GetIcebergTablesIn() {}

    private GetIcebergTablesIn(GetIcebergTablesIn $) {
    ...
    public static Builder builder(GetIcebergTablesIn defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetIcebergTablesIn();
        }

        public Builder(GetIcebergTablesIn defaults) {
            $ = new GetIcebergTablesIn(Objects.requireNonNull(defaults));
        }
        ...
        public GetIcebergTablesIn build() {
            return $;
        }
    }
