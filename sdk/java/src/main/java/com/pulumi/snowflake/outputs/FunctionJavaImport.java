...
@CustomType
public final class FunctionJavaImport {
    /**
    ...
    public static Builder builder(FunctionJavaImport defaults) {
    ...
    public static final class Builder {
        ...
        private String stageLocation;
        public Builder() {}
        public Builder(FunctionJavaImport defaults) {
        ...
        public Builder pathOnStage(String pathOnStage) {
            if (pathOnStage == null) {
              throw new MissingRequiredPropertyException("FunctionJavaImport", "pathOnStage");
            }
        ...
        public Builder stageLocation(String stageLocation) {
            if (stageLocation == null) {
              throw new MissingRequiredPropertyException("FunctionJavaImport", "stageLocation");
            }
            this.stageLocation = stageLocation;
            return this;
        }
        public FunctionJavaImport build() {
            final var _resultValue = new FunctionJavaImport();
