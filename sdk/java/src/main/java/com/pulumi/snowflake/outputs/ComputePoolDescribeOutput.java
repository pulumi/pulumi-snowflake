...
@CustomType
public final class ComputePoolDescribeOutput {
    ...
    private ComputePoolDescribeOutput() {}
    ...
    public static Builder builder(ComputePoolDescribeOutput defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String updatedOn;
        public Builder() {}
        public Builder(ComputePoolDescribeOutput defaults) {
        ...
        public ComputePoolDescribeOutput build() {
            final var _resultValue = new ComputePoolDescribeOutput();
