...
public final class GetMaskingPoliciesLimitArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetMaskingPoliciesLimitArgs Empty = new GetMaskingPoliciesLimitArgs();
    ...
    private GetMaskingPoliciesLimitArgs() {}

    private GetMaskingPoliciesLimitArgs(GetMaskingPoliciesLimitArgs $) {
        this.from = $.from;
        this.rows = $.rows;
    }
    ...
    public static Builder builder(GetMaskingPoliciesLimitArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetMaskingPoliciesLimitArgs();
        }

        public Builder(GetMaskingPoliciesLimitArgs defaults) {
            $ = new GetMaskingPoliciesLimitArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetMaskingPoliciesLimitArgs build() {
            if ($.rows == null) {
                throw new MissingRequiredPropertyException("GetMaskingPoliciesLimitArgs", "rows");
            }
            return $;
        }
    }
