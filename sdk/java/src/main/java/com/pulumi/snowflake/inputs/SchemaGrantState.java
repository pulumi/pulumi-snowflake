...
public final class SchemaGrantState extends com.pulumi.resources.ResourceArgs {

    public static final SchemaGrantState Empty = new SchemaGrantState();
    ...
    public static Builder builder(SchemaGrantState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SchemaGrantState();
        }

        public Builder(SchemaGrantState defaults) {
            $ = new SchemaGrantState(Objects.requireNonNull(defaults));
        }
