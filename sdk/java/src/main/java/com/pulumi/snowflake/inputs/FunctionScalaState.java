...
import com.pulumi.snowflake.inputs.FunctionScalaParameterArgs;
import com.pulumi.snowflake.inputs.FunctionScalaSecretArgs;
import com.pulumi.snowflake.inputs.FunctionScalaShowOutputArgs;
...
public final class FunctionScalaState extends com.pulumi.resources.ResourceArgs {

    public static final FunctionScalaState Empty = new FunctionScalaState();
    ...
    private @Nullable Output<List<FunctionScalaParameterArgs>> parameters;

    /**
     * @return Outputs the result of `SHOW PARAMETERS IN FUNCTION` for the given function.
     * 
     */
    public Optional<Output<List<FunctionScalaParameterArgs>>> parameters() {
    ...
    private @Nullable Output<List<FunctionScalaShowOutputArgs>> showOutputs;

    /**
     * @return Outputs the result of `SHOW FUNCTION` for the given function.
     * 
     */
    public Optional<Output<List<FunctionScalaShowOutputArgs>>> showOutputs() {
    ...
    private FunctionScalaState() {}

    private FunctionScalaState(FunctionScalaState $) {
    ...
    public static Builder builder(FunctionScalaState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FunctionScalaState();
        }

        public Builder(FunctionScalaState defaults) {
            $ = new FunctionScalaState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param handler The name of the handler method or class. If the handler is for a scalar UDF, returning a non-tabular value, the HANDLER value should be a method name, as in the following form: `MyClass.myMethod`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param imports The location (stage), path, and name of the file(s) to import, such as a JAR or other kind of file. The JAR file might contain handler dependency libraries. It can contain one or more .class files and zero or more resource files. JNI (Java Native Interface) is not supported. Snowflake prohibits loading libraries that contain native code (as opposed to Java bytecode). A non-JAR file might a file read by handler code. For an example, see [Reading a file specified statically in IMPORTS](https://docs.snowflake.com/en/developer-guide/udf/java/udf-java-cookbook.html#label-reading-file-from-java-udf-imports). Consult the [docs](https://docs.snowflake.com/en/sql-reference/sql/create-function#scala).
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder parameters(@Nullable Output<List<FunctionScalaParameterArgs>> parameters) {
         ...
         * 
         */
        public Builder parameters(List<FunctionScalaParameterArgs> parameters) {
         ...
         * 
         */
        public Builder parameters(FunctionScalaParameterArgs... parameters) {
         ...
         * 
         */
        public Builder showOutputs(@Nullable Output<List<FunctionScalaShowOutputArgs>> showOutputs) {
         ...
         * 
         */
        public Builder showOutputs(List<FunctionScalaShowOutputArgs> showOutputs) {
         ...
         * 
         */
        public Builder showOutputs(FunctionScalaShowOutputArgs... showOutputs) {
            return showOutputs(List.of(showOutputs));
        }

        /**
         * @param targetPath The name of the handler method or class. If the handler is for a scalar UDF, returning a non-tabular value, the HANDLER value should be a method name, as in the following form: `MyClass.myMethod`.
         * 
         * @return builder
         * 
         */
        ...
        public FunctionScalaState build() {
            return $;
        }
    }
