...
@CustomType
public final class ExternalOauthIntegrationShowOutput {
    ...
    private ExternalOauthIntegrationShowOutput() {}
    ...
    public static Builder builder(ExternalOauthIntegrationShowOutput defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String name;
        public Builder() {}
        public Builder(ExternalOauthIntegrationShowOutput defaults) {
        ...
        public ExternalOauthIntegrationShowOutput build() {
            final var _resultValue = new ExternalOauthIntegrationShowOutput();
