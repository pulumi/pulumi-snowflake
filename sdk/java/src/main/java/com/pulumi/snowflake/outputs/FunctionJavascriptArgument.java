...
@CustomType
public final class FunctionJavascriptArgument {
    /**
    ...
    private FunctionJavascriptArgument() {}
    /**
     * @return The argument type.
     * 
     */
    ...
    public static Builder builder(FunctionJavascriptArgument defaults) {
    ...
    public static final class Builder {
        ...
        private String argName;
        public Builder() {}
        public Builder(FunctionJavascriptArgument defaults) {
        ...
        public Builder argDataType(String argDataType) {
            if (argDataType == null) {
              throw new MissingRequiredPropertyException("FunctionJavascriptArgument", "argDataType");
            }
        ...
        public Builder argName(String argName) {
            if (argName == null) {
              throw new MissingRequiredPropertyException("FunctionJavascriptArgument", "argName");
            }
            this.argName = argName;
            return this;
        }
        public FunctionJavascriptArgument build() {
            final var _resultValue = new FunctionJavascriptArgument();
