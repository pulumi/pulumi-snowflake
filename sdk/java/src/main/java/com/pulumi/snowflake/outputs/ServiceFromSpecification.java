...
@CustomType
public final class ServiceFromSpecification {
    /**
    ...
    public static Builder builder(ServiceFromSpecification defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String text;
        public Builder() {}
        public Builder(ServiceFromSpecification defaults) {
        ...
        public ServiceFromSpecification build() {
            final var _resultValue = new ServiceFromSpecification();
