...
public final class GetSecretsIn extends com.pulumi.resources.InvokeArgs {

    public static final GetSecretsIn Empty = new GetSecretsIn();
    ...
    private GetSecretsIn(GetSecretsIn $) {
    ...
    public static final class Builder {
        ...
        public Builder(GetSecretsIn defaults) {
            $ = new GetSecretsIn(Objects.requireNonNull(defaults));
        }
