...
import com.pulumi.snowflake.inputs.GetNotebooksLimitArgs;
...
public final class GetNotebooksArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetNotebooksArgs Empty = new GetNotebooksArgs();
     ...
     */
    @Import(name="limit")
    private @Nullable Output<GetNotebooksLimitArgs> limit;
     ...
     * 
     */
    public Optional<Output<GetNotebooksLimitArgs>> limit() {
    ...
    private GetNotebooksArgs() {}

    private GetNotebooksArgs(GetNotebooksArgs $) {
        this.like = $.like;
        this.limit = $.limit;
    ...
    public static Builder builder(GetNotebooksArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetNotebooksArgs();
        }

        public Builder(GetNotebooksArgs defaults) {
            $ = new GetNotebooksArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder limit(@Nullable Output<GetNotebooksLimitArgs> limit) {
            $.limit = limit;
            return this;
        }
         ...
         * 
         */
        public Builder limit(GetNotebooksLimitArgs limit) {
        ...
        /**
         * @param withDescribe (Default: `true`) Runs DESC NOTEBOOK for each notebook returned by SHOW NOTEBOOKS. The output of describe is saved to the description field. By default this value is set to true.
         * 
         * @return builder
         * 
         */
