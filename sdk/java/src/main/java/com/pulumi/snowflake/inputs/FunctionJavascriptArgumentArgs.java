...
public final class FunctionJavascriptArgumentArgs extends com.pulumi.resources.ResourceArgs {

    public static final FunctionJavascriptArgumentArgs Empty = new FunctionJavascriptArgumentArgs();
    ...
    private FunctionJavascriptArgumentArgs() {}

    private FunctionJavascriptArgumentArgs(FunctionJavascriptArgumentArgs $) {
    ...
    public static Builder builder(FunctionJavascriptArgumentArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FunctionJavascriptArgumentArgs();
        }

        public Builder(FunctionJavascriptArgumentArgs defaults) {
            $ = new FunctionJavascriptArgumentArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FunctionJavascriptArgumentArgs build() {
            if ($.argDataType == null) {
                throw new MissingRequiredPropertyException("FunctionJavascriptArgumentArgs", "argDataType");
            }
            if ($.argName == null) {
                throw new MissingRequiredPropertyException("FunctionJavascriptArgumentArgs", "argName");
            }
            return $;
        }
    }
