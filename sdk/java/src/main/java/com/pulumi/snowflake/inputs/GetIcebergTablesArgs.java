...
import com.pulumi.snowflake.inputs.GetIcebergTablesInArgs;
import com.pulumi.snowflake.inputs.GetIcebergTablesLimitArgs;
...
public final class GetIcebergTablesArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetIcebergTablesArgs Empty = new GetIcebergTablesArgs();
     ...
     */
    @Import(name="in")
    private @Nullable Output<GetIcebergTablesInArgs> in;

    /**
     * @return IN clause to filter the list of objects
     * 
     */
    public Optional<Output<GetIcebergTablesInArgs>> in() {
     ...
     */
    @Import(name="limit")
    private @Nullable Output<GetIcebergTablesLimitArgs> limit;
     ...
     * 
     */
    public Optional<Output<GetIcebergTablesLimitArgs>> limit() {
    ...
    private GetIcebergTablesArgs() {}

    private GetIcebergTablesArgs(GetIcebergTablesArgs $) {
        this.in = $.in;
        this.like = $.like;
        this.limit = $.limit;
    ...
    public static Builder builder(GetIcebergTablesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetIcebergTablesArgs();
        }

        public Builder(GetIcebergTablesArgs defaults) {
            $ = new GetIcebergTablesArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder in(@Nullable Output<GetIcebergTablesInArgs> in) {
            $.in = in;
            return this;
        }
         ...
         * 
         */
        public Builder in(GetIcebergTablesInArgs in) {
         ...
         * 
         */
        public Builder limit(@Nullable Output<GetIcebergTablesLimitArgs> limit) {
            $.limit = limit;
            return this;
        }
         ...
         * 
         */
        public Builder limit(GetIcebergTablesLimitArgs limit) {
        ...
        public GetIcebergTablesArgs build() {
            return $;
        }
    }
