...
public final class DatabaseGrantArgs extends com.pulumi.resources.ResourceArgs {

    public static final DatabaseGrantArgs Empty = new DatabaseGrantArgs();
    ...
    private DatabaseGrantArgs() {}

    private DatabaseGrantArgs(DatabaseGrantArgs $) {
    ...
    public static Builder builder(DatabaseGrantArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DatabaseGrantArgs();
        }

        public Builder(DatabaseGrantArgs defaults) {
            $ = new DatabaseGrantArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param privilege The privilege to grant on the database. To grant all privileges, use the value `ALL PRIVILEGES`.
         * 
         * @return builder
         * 
         */
        ...
        public DatabaseGrantArgs build() {
            if ($.databaseName == null) {
                throw new MissingRequiredPropertyException("DatabaseGrantArgs", "databaseName");
            }
            return $;
        }
    }
