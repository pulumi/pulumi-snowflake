 ...
 * 
 */
@ResourceType(type="snowflake:index/serviceUser:ServiceUser")
public class ServiceUser extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="parameters", refs={List.class,ServiceUserParameter.class}, tree="[0,1]")
    private Output<List<ServiceUserParameter>> parameters;

    /**
     * @return Outputs the result of `SHOW PARAMETERS IN USER` for the given user.
     * 
     */
    public Output<List<ServiceUserParameter>> parameters() {
     ...
     * 
     */
    @Export(name="showOutputs", refs={List.class,ServiceUserShowOutput.class}, tree="[0,1]")
    private Output<List<ServiceUserShowOutput>> showOutputs;

    /**
     * @return Outputs the result of `SHOW USER` for the given user.
     * 
     */
    public Output<List<ServiceUserShowOutput>> showOutputs() {
     ...
     */
    public ServiceUser(java.lang.String name, @Nullable ServiceUserArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ServiceUser(java.lang.String name, @Nullable ServiceUserArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("snowflake:index/serviceUser:ServiceUser", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ServiceUser(java.lang.String name, Output<java.lang.String> id, @Nullable ServiceUserState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("snowflake:index/serviceUser:ServiceUser", name, state, makeResourceOptions(options, id), false);
    }

    private static ServiceUserArgs makeArgs(@Nullable ServiceUserArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? ServiceUserArgs.Empty : args;
    }
     ...
     */
    public static ServiceUser get(java.lang.String name, Output<java.lang.String> id, @Nullable ServiceUserState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
