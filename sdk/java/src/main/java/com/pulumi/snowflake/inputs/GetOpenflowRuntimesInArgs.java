...
public final class GetOpenflowRuntimesInArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetOpenflowRuntimesInArgs Empty = new GetOpenflowRuntimesInArgs();
    ...
    private GetOpenflowRuntimesInArgs() {}

    private GetOpenflowRuntimesInArgs(GetOpenflowRuntimesInArgs $) {
    ...
    public static Builder builder(GetOpenflowRuntimesInArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetOpenflowRuntimesInArgs();
        }

        public Builder(GetOpenflowRuntimesInArgs defaults) {
            $ = new GetOpenflowRuntimesInArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetOpenflowRuntimesInArgs build() {
            return $;
        }
    }
