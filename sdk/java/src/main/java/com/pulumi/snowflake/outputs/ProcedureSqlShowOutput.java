...
@CustomType
public final class ProcedureSqlShowOutput {
    ...
    public static Builder builder(ProcedureSqlShowOutput defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean validForClustering;
        public Builder() {}
        public Builder(ProcedureSqlShowOutput defaults) {
        ...
        public ProcedureSqlShowOutput build() {
            final var _resultValue = new ProcedureSqlShowOutput();
