...
public final class UserOwnershipGrantState extends com.pulumi.resources.ResourceArgs {

    public static final UserOwnershipGrantState Empty = new UserOwnershipGrantState();
     ...
     * 
     */
    @Import(name="onUserName")
    private @Nullable Output<String> onUserName;

    /**
     * @return The name of the user ownership is granted on.
     * 
     */
    public Optional<Output<String>> onUserName() {
        return Optional.ofNullable(this.onUserName);
    }
    ...
    private UserOwnershipGrantState() {}
    ...
    public static Builder builder(UserOwnershipGrantState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new UserOwnershipGrantState();
        }

        public Builder(UserOwnershipGrantState defaults) {
            $ = new UserOwnershipGrantState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder onUserName(@Nullable Output<String> onUserName) {
        ...
        public UserOwnershipGrantState build() {
            return $;
        }
    }
