...
@CustomType
public final class OauthIntegrationForCustomClientsShowOutput {
    ...
    public static Builder builder(OauthIntegrationForCustomClientsShowOutput defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String name;
        public Builder() {}
        public Builder(OauthIntegrationForCustomClientsShowOutput defaults) {
        ...
        public OauthIntegrationForCustomClientsShowOutput build() {
            final var _resultValue = new OauthIntegrationForCustomClientsShowOutput();
