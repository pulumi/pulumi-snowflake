...
@CustomType
public final class StreamOnExternalTableBefore {
    /**
    ...
    public static Builder builder(StreamOnExternalTableBefore defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String timestamp;
        public Builder() {}
        public Builder(StreamOnExternalTableBefore defaults) {
        ...
        public StreamOnExternalTableBefore build() {
            final var _resultValue = new StreamOnExternalTableBefore();
