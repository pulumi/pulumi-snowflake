...
import com.pulumi.snowflake.inputs.ProcedureScalaImportArgs;
import com.pulumi.snowflake.inputs.ProcedureScalaParameterArgs;
import com.pulumi.snowflake.inputs.ProcedureScalaSecretArgs;
import com.pulumi.snowflake.inputs.ProcedureScalaShowOutputArgs;
import com.pulumi.snowflake.inputs.ProcedureScalaTargetPathArgs;
...
public final class ProcedureScalaState extends com.pulumi.resources.ResourceArgs {

    public static final ProcedureScalaState Empty = new ProcedureScalaState();
    ...
    private @Nullable Output<List<ProcedureScalaArgumentArgs>> arguments;
     ...
     * 
     */
    public Optional<Output<List<ProcedureScalaArgumentArgs>>> arguments() {
     ...
     */
    @Import(name="imports")
    private @Nullable Output<List<ProcedureScalaImportArgs>> imports;
     ...
     * 
     */
    public Optional<Output<List<ProcedureScalaImportArgs>>> imports() {
    ...
    private @Nullable Output<List<ProcedureScalaParameterArgs>> parameters;

    /**
     * @return Outputs the result of `SHOW PARAMETERS IN PROCEDURE` for the given procedure.
     * 
     */
    public Optional<Output<List<ProcedureScalaParameterArgs>>> parameters() {
     ...
     */
    @Import(name="secrets")
    private @Nullable Output<List<ProcedureScalaSecretArgs>> secrets;

    /**
     * @return Assigns the names of [secrets](https://docs.snowflake.com/en/sql-reference/sql/create-secret) to variables so that you can use the variables to reference the secrets when retrieving information from secrets in handler code. Secrets you specify here must be allowed by the [external access integration](https://docs.snowflake.com/en/sql-reference/sql/create-external-access-integration) specified as a value of this CREATE FUNCTION command’s EXTERNAL*ACCESS*INTEGRATIONS parameter.
     * 
     */
    public Optional<Output<List<ProcedureScalaSecretArgs>>> secrets() {
    ...
    private @Nullable Output<List<ProcedureScalaShowOutputArgs>> showOutputs;

    /**
     * @return Outputs the result of `SHOW PROCEDURE` for the given procedure.
     * 
     */
    public Optional<Output<List<ProcedureScalaShowOutputArgs>>> showOutputs() {
     ...
     * 
     */
    @Import(name="snowparkPackage")
    private @Nullable Output<String> snowparkPackage;
     ...
     * 
     */
    public Optional<Output<String>> snowparkPackage() {
        return Optional.ofNullable(this.snowparkPackage);
    }
    ...
    private @Nullable Output<ProcedureScalaTargetPathArgs> targetPath;

    /**
     * @return Use the fully qualified name of the method or function for the stored procedure. This is typically in the following form: `com.my_company.my_package.MyClass.myMethod` where `com.my_company.my_package` corresponds to the package containing the object or class: `package com.my_company.my_package;`.
     * 
     */
    public Optional<Output<ProcedureScalaTargetPathArgs>> targetPath() {
    ...
    private ProcedureScalaState() {}

    private ProcedureScalaState(ProcedureScalaState $) {
    ...
    public static Builder builder(ProcedureScalaState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProcedureScalaState();
        }

        public Builder(ProcedureScalaState defaults) {
            $ = new ProcedureScalaState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder arguments(@Nullable Output<List<ProcedureScalaArgumentArgs>> arguments) {
            $.arguments = arguments;
            return this;
        }
         ...
         * 
         */
        public Builder arguments(List<ProcedureScalaArgumentArgs> arguments) {
         ...
         * 
         */
        public Builder arguments(ProcedureScalaArgumentArgs... arguments) {
        ...
        /**
         * @param handler Use the fully qualified name of the method or function for the stored procedure. This is typically in the following form: `com.my_company.my_package.MyClass.myMethod` where `com.my_company.my_package` corresponds to the package containing the object or class: `package com.my_company.my_package;`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param imports The location (stage), path, and name of the file(s) to import. You must set the IMPORTS clause to include any files that your stored procedure depends on. If you are writing an in-line stored procedure, you can omit this clause, unless your code depends on classes defined outside the stored procedure or resource files. If you are writing a stored procedure with a staged handler, you must also include a path to the JAR file containing the stored procedure’s handler code. The IMPORTS definition cannot reference variables from arguments that are passed into the stored procedure. Each file in the IMPORTS clause must have a unique name, even if the files are in different subdirectories or different stages.
         * 
         * @return builder
         * 
         */
        public Builder imports(@Nullable Output<List<ProcedureScalaImportArgs>> imports) {
            $.imports = imports;
            return this;
        }
         ...
         * 
         */
        public Builder imports(List<ProcedureScalaImportArgs> imports) {
         ...
         * 
         */
        public Builder imports(ProcedureScalaImportArgs... imports) {
         ...
         * 
         */
        public Builder parameters(@Nullable Output<List<ProcedureScalaParameterArgs>> parameters) {
         ...
         * 
         */
        public Builder parameters(List<ProcedureScalaParameterArgs> parameters) {
         ...
         * 
         */
        public Builder parameters(ProcedureScalaParameterArgs... parameters) {
        ...
        /**
         * @param runtimeVersion The language runtime version to use. Currently, the supported versions are: 2.12.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder secrets(@Nullable Output<List<ProcedureScalaSecretArgs>> secrets) {
            $.secrets = secrets;
            return this;
        }
         ...
         * 
         */
        public Builder secrets(List<ProcedureScalaSecretArgs> secrets) {
         ...
         * 
         */
        public Builder secrets(ProcedureScalaSecretArgs... secrets) {
         ...
         * 
         */
        public Builder showOutputs(@Nullable Output<List<ProcedureScalaShowOutputArgs>> showOutputs) {
         ...
         * 
         */
        public Builder showOutputs(List<ProcedureScalaShowOutputArgs> showOutputs) {
         ...
         * 
         */
        public Builder showOutputs(ProcedureScalaShowOutputArgs... showOutputs) {
         ...
         * 
         */
        public Builder snowparkPackage(@Nullable Output<String> snowparkPackage) {
        ...
        /**
         * @param targetPath Use the fully qualified name of the method or function for the stored procedure. This is typically in the following form: `com.my_company.my_package.MyClass.myMethod` where `com.my_company.my_package` corresponds to the package containing the object or class: `package com.my_company.my_package;`.
         * 
         * @return builder
         * 
         */
        public Builder targetPath(@Nullable Output<ProcedureScalaTargetPathArgs> targetPath) {
         ...
         * 
         */
        public Builder targetPath(ProcedureScalaTargetPathArgs targetPath) {
        ...
        public ProcedureScalaState build() {
            return $;
        }
    }
