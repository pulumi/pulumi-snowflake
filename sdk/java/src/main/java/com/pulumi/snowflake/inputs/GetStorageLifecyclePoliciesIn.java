...
public final class GetStorageLifecyclePoliciesIn extends com.pulumi.resources.InvokeArgs {

    public static final GetStorageLifecyclePoliciesIn Empty = new GetStorageLifecyclePoliciesIn();
    ...
    private GetStorageLifecyclePoliciesIn() {}

    private GetStorageLifecyclePoliciesIn(GetStorageLifecyclePoliciesIn $) {
    ...
    public static Builder builder(GetStorageLifecyclePoliciesIn defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetStorageLifecyclePoliciesIn();
        }

        public Builder(GetStorageLifecyclePoliciesIn defaults) {
            $ = new GetStorageLifecyclePoliciesIn(Objects.requireNonNull(defaults));
        }
        ...
        public GetStorageLifecyclePoliciesIn build() {
            return $;
        }
    }
