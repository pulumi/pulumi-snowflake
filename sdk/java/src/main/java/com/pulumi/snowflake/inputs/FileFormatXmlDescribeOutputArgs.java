...
public final class FileFormatXmlDescribeOutputArgs extends com.pulumi.resources.ResourceArgs {

    public static final FileFormatXmlDescribeOutputArgs Empty = new FileFormatXmlDescribeOutputArgs();
    ...
    private FileFormatXmlDescribeOutputArgs() {}

    private FileFormatXmlDescribeOutputArgs(FileFormatXmlDescribeOutputArgs $) {
    ...
    public static Builder builder(FileFormatXmlDescribeOutputArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FileFormatXmlDescribeOutputArgs();
        }

        public Builder(FileFormatXmlDescribeOutputArgs defaults) {
            $ = new FileFormatXmlDescribeOutputArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FileFormatXmlDescribeOutputArgs build() {
            return $;
        }
    }
