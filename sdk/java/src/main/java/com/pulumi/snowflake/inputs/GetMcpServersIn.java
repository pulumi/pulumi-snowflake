...
public final class GetMcpServersIn extends com.pulumi.resources.InvokeArgs {

    public static final GetMcpServersIn Empty = new GetMcpServersIn();
    ...
    private GetMcpServersIn() {}

    private GetMcpServersIn(GetMcpServersIn $) {
    ...
    public static Builder builder(GetMcpServersIn defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetMcpServersIn defaults) {
            $ = new GetMcpServersIn(Objects.requireNonNull(defaults));
        }
