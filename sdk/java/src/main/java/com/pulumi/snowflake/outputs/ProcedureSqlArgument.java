...
@CustomType
public final class ProcedureSqlArgument {
    /**
    ...
    public static Builder builder(ProcedureSqlArgument defaults) {
    ...
    public static final class Builder {
        ...
        private String argName;
        public Builder() {}
        public Builder(ProcedureSqlArgument defaults) {
        ...
        public Builder argDataType(String argDataType) {
            if (argDataType == null) {
              throw new MissingRequiredPropertyException("ProcedureSqlArgument", "argDataType");
            }
        ...
        public Builder argName(String argName) {
            if (argName == null) {
              throw new MissingRequiredPropertyException("ProcedureSqlArgument", "argName");
            }
            this.argName = argName;
            return this;
        }
        public ProcedureSqlArgument build() {
            final var _resultValue = new ProcedureSqlArgument();
