...
public final class StreamOnTableAtArgs extends com.pulumi.resources.ResourceArgs {

    public static final StreamOnTableAtArgs Empty = new StreamOnTableAtArgs();
    ...
    private StreamOnTableAtArgs() {}

    private StreamOnTableAtArgs(StreamOnTableAtArgs $) {
        this.offset = $.offset;
    ...
    public static Builder builder(StreamOnTableAtArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StreamOnTableAtArgs();
        }

        public Builder(StreamOnTableAtArgs defaults) {
            $ = new StreamOnTableAtArgs(Objects.requireNonNull(defaults));
        }
        ...
        public StreamOnTableAtArgs build() {
            return $;
        }
    }
