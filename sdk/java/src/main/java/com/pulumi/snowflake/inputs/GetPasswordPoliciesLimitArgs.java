...
public final class GetPasswordPoliciesLimitArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPasswordPoliciesLimitArgs Empty = new GetPasswordPoliciesLimitArgs();
    ...
    private GetPasswordPoliciesLimitArgs() {}

    private GetPasswordPoliciesLimitArgs(GetPasswordPoliciesLimitArgs $) {
        this.from = $.from;
        this.rows = $.rows;
    }
    ...
    public static Builder builder(GetPasswordPoliciesLimitArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPasswordPoliciesLimitArgs();
        }

        public Builder(GetPasswordPoliciesLimitArgs defaults) {
            $ = new GetPasswordPoliciesLimitArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetPasswordPoliciesLimitArgs build() {
            if ($.rows == null) {
                throw new MissingRequiredPropertyException("GetPasswordPoliciesLimitArgs", "rows");
            }
            return $;
        }
    }
