...
public final class GetDatabasesLimitArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetDatabasesLimitArgs Empty = new GetDatabasesLimitArgs();
    ...
    private GetDatabasesLimitArgs() {}

    private GetDatabasesLimitArgs(GetDatabasesLimitArgs $) {
        this.from = $.from;
        this.rows = $.rows;
    }
    ...
    public static Builder builder(GetDatabasesLimitArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDatabasesLimitArgs();
        }

        public Builder(GetDatabasesLimitArgs defaults) {
            $ = new GetDatabasesLimitArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetDatabasesLimitArgs build() {
            if ($.rows == null) {
                throw new MissingRequiredPropertyException("GetDatabasesLimitArgs", "rows");
            }
            return $;
        }
    }
