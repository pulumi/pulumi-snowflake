...
public final class ServiceUserShowOutputArgs extends com.pulumi.resources.ResourceArgs {

    public static final ServiceUserShowOutputArgs Empty = new ServiceUserShowOutputArgs();
    ...
    private ServiceUserShowOutputArgs() {}

    private ServiceUserShowOutputArgs(ServiceUserShowOutputArgs $) {
    ...
    public static Builder builder(ServiceUserShowOutputArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceUserShowOutputArgs();
        }

        public Builder(ServiceUserShowOutputArgs defaults) {
            $ = new ServiceUserShowOutputArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ServiceUserShowOutputArgs build() {
            return $;
        }
    }
