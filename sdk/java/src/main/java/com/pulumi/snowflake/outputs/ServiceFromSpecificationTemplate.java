...
import com.pulumi.snowflake.outputs.ServiceFromSpecificationTemplateUsing;
...
@CustomType
public final class ServiceFromSpecificationTemplate {
    /**
     ...
     * 
     */
    private List<ServiceFromSpecificationTemplateUsing> usings;

    private ServiceFromSpecificationTemplate() {}
    /**
     * @return The file name of the service specification template. Example: `spec.yaml`.
     * 
     */
     ...
     * 
     */
    public List<ServiceFromSpecificationTemplateUsing> usings() {
        return this.usings;
    }
    ...
    public static Builder builder(ServiceFromSpecificationTemplate defaults) {
    ...
    public static final class Builder {
        ...
        private List<ServiceFromSpecificationTemplateUsing> usings;
        public Builder() {}
        public Builder(ServiceFromSpecificationTemplate defaults) {
        ...
        @CustomType.Setter
        public Builder usings(List<ServiceFromSpecificationTemplateUsing> usings) {
            if (usings == null) {
              throw new MissingRequiredPropertyException("ServiceFromSpecificationTemplate", "usings");
            }
            this.usings = usings;
            return this;
        }
        public Builder usings(ServiceFromSpecificationTemplateUsing... usings) {
            return usings(List.of(usings));
        }
        public ServiceFromSpecificationTemplate build() {
            final var _resultValue = new ServiceFromSpecificationTemplate();
