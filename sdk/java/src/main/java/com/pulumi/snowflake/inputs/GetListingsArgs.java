...
import com.pulumi.snowflake.inputs.GetListingsLimitArgs;
...
public final class GetListingsArgs extends com.pulumi.resources.InvokeArgs {
     ...
     */
    @Import(name="limit")
    private @Nullable Output<GetListingsLimitArgs> limit;
     ...
     * 
     */
    public Optional<Output<GetListingsLimitArgs>> limit() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder limit(@Nullable Output<GetListingsLimitArgs> limit) {
            $.limit = limit;
            return this;
        }
         ...
         * 
         */
        public Builder limit(GetListingsLimitArgs limit) {
        ...
        /**
         * @param withDescribe (Default: `true`) Runs DESC LISTING for each listing returned by SHOW LISTINGS. The output of describe is saved to the description field. By default this value is set to true.
         * 
         * @return builder
         * 
         */
