...
public final class FileFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final FileFormatArgs Empty = new FileFormatArgs();
    ...
    private FileFormatArgs() {}

    private FileFormatArgs(FileFormatArgs $) {
    ...
    public static Builder builder(FileFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(FileFormatArgs defaults) {
            $ = new FileFormatArgs(Objects.requireNonNull(defaults));
        }
