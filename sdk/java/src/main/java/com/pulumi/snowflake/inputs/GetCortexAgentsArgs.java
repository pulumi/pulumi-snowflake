...
import com.pulumi.snowflake.inputs.GetCortexAgentsInArgs;
import com.pulumi.snowflake.inputs.GetCortexAgentsLimitArgs;
...
public final class GetCortexAgentsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetCortexAgentsArgs Empty = new GetCortexAgentsArgs();
     ...
     */
    @Import(name="in")
    private @Nullable Output<GetCortexAgentsInArgs> in;

    /**
     * @return IN clause to filter the list of objects
     * 
     */
    public Optional<Output<GetCortexAgentsInArgs>> in() {
     ...
     */
    @Import(name="limit")
    private @Nullable Output<GetCortexAgentsLimitArgs> limit;
     ...
     * 
     */
    public Optional<Output<GetCortexAgentsLimitArgs>> limit() {
    ...
    private GetCortexAgentsArgs() {}

    private GetCortexAgentsArgs(GetCortexAgentsArgs $) {
        this.in = $.in;
        this.like = $.like;
        this.limit = $.limit;
    ...
    public static Builder builder(GetCortexAgentsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCortexAgentsArgs();
        }

        public Builder(GetCortexAgentsArgs defaults) {
            $ = new GetCortexAgentsArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder in(@Nullable Output<GetCortexAgentsInArgs> in) {
            $.in = in;
            return this;
        }
         ...
         * 
         */
        public Builder in(GetCortexAgentsInArgs in) {
         ...
         * 
         */
        public Builder limit(@Nullable Output<GetCortexAgentsLimitArgs> limit) {
            $.limit = limit;
            return this;
        }
         ...
         * 
         */
        public Builder limit(GetCortexAgentsLimitArgs limit) {
        ...
        /**
         * @param withDescribe (Default: `true`) Runs DESC AGENT for each object returned by SHOW AGENTS. The output of describe is saved to the describeOutput field. By default this value is set to true.
         * 
         * @return builder
         * 
         */
        ...
        public GetCortexAgentsArgs build() {
            return $;
        }
    }
