...
@CustomType
public final class ServiceShowOutput {
    ...
    public static Builder builder(ServiceShowOutput defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String updatedOn;
        public Builder() {}
        public Builder(ServiceShowOutput defaults) {
        ...
        public ServiceShowOutput build() {
            final var _resultValue = new ServiceShowOutput();
