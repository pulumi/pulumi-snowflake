...
@CustomType
public final class ProcedureJavaArgument {
    /**
    ...
    public static Builder builder(ProcedureJavaArgument defaults) {
    ...
    public static final class Builder {
        ...
        private String argName;
        public Builder() {}
        public Builder(ProcedureJavaArgument defaults) {
        ...
        public Builder argDataType(String argDataType) {
            if (argDataType == null) {
              throw new MissingRequiredPropertyException("ProcedureJavaArgument", "argDataType");
            }
        ...
        public Builder argName(String argName) {
            if (argName == null) {
              throw new MissingRequiredPropertyException("ProcedureJavaArgument", "argName");
            }
            this.argName = argName;
            return this;
        }
        public ProcedureJavaArgument build() {
            final var _resultValue = new ProcedureJavaArgument();
