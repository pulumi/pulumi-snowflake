...
public final class GrantAccountRoleArgs extends com.pulumi.resources.ResourceArgs {

    public static final GrantAccountRoleArgs Empty = new GrantAccountRoleArgs();
    ...
    private GrantAccountRoleArgs() {}

    private GrantAccountRoleArgs(GrantAccountRoleArgs $) {
    ...
    public static Builder builder(GrantAccountRoleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GrantAccountRoleArgs();
        }

        public Builder(GrantAccountRoleArgs defaults) {
            $ = new GrantAccountRoleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GrantAccountRoleArgs build() {
            if ($.roleName == null) {
                throw new MissingRequiredPropertyException("GrantAccountRoleArgs", "roleName");
            }
            return $;
        }
    }
