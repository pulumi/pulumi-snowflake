...
public final class GetComputePoolsLimitArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetComputePoolsLimitArgs Empty = new GetComputePoolsLimitArgs();
    ...
    private GetComputePoolsLimitArgs() {}

    private GetComputePoolsLimitArgs(GetComputePoolsLimitArgs $) {
        this.from = $.from;
        this.rows = $.rows;
    }
    ...
    public static Builder builder(GetComputePoolsLimitArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetComputePoolsLimitArgs();
        }

        public Builder(GetComputePoolsLimitArgs defaults) {
            $ = new GetComputePoolsLimitArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetComputePoolsLimitArgs build() {
            if ($.rows == null) {
                throw new MissingRequiredPropertyException("GetComputePoolsLimitArgs", "rows");
            }
            return $;
        }
    }
