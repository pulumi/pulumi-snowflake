...
public final class GetCortexAgentsLimitArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetCortexAgentsLimitArgs Empty = new GetCortexAgentsLimitArgs();
    ...
    private GetCortexAgentsLimitArgs() {}

    private GetCortexAgentsLimitArgs(GetCortexAgentsLimitArgs $) {
        this.from = $.from;
        this.rows = $.rows;
    }
    ...
    public static Builder builder(GetCortexAgentsLimitArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCortexAgentsLimitArgs();
        }

        public Builder(GetCortexAgentsLimitArgs defaults) {
            $ = new GetCortexAgentsLimitArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetCortexAgentsLimitArgs build() {
            if ($.rows == null) {
                throw new MissingRequiredPropertyException("GetCortexAgentsLimitArgs", "rows");
            }
            return $;
        }
    }
