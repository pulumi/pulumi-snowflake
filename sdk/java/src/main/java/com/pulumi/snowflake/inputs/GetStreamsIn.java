...
public final class GetStreamsIn extends com.pulumi.resources.InvokeArgs {

    public static final GetStreamsIn Empty = new GetStreamsIn();
    ...
    private GetStreamsIn() {}

    private GetStreamsIn(GetStreamsIn $) {
    ...
    public static Builder builder(GetStreamsIn defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetStreamsIn defaults) {
            $ = new GetStreamsIn(Objects.requireNonNull(defaults));
        }
