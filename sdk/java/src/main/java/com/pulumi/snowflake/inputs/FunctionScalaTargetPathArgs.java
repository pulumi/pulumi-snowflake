...
public final class FunctionScalaTargetPathArgs extends com.pulumi.resources.ResourceArgs {

    public static final FunctionScalaTargetPathArgs Empty = new FunctionScalaTargetPathArgs();
    ...
    private FunctionScalaTargetPathArgs() {}

    private FunctionScalaTargetPathArgs(FunctionScalaTargetPathArgs $) {
    ...
    public static Builder builder(FunctionScalaTargetPathArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FunctionScalaTargetPathArgs();
        }

        public Builder(FunctionScalaTargetPathArgs defaults) {
            $ = new FunctionScalaTargetPathArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FunctionScalaTargetPathArgs build() {
            if ($.pathOnStage == null) {
                throw new MissingRequiredPropertyException("FunctionScalaTargetPathArgs", "pathOnStage");
            }
            if ($.stageLocation == null) {
                throw new MissingRequiredPropertyException("FunctionScalaTargetPathArgs", "stageLocation");
            }
            return $;
        }
    }
