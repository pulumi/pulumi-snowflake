...
import com.pulumi.snowflake.inputs.RoleOwnershipGrantState;
...
public class RoleOwnershipGrant extends com.pulumi.resources.CustomResource {
     ...
     */
    public RoleOwnershipGrant(String name) {
        this(name, RoleOwnershipGrantArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RoleOwnershipGrant(String name, RoleOwnershipGrantArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("snowflake:index/roleOwnershipGrant:RoleOwnershipGrant", name, args == null ? RoleOwnershipGrantArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private RoleOwnershipGrant(String name, Output<String> id, @Nullable RoleOwnershipGrantState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("snowflake:index/roleOwnershipGrant:RoleOwnershipGrant", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static RoleOwnershipGrant get(String name, Output<String> id, @Nullable RoleOwnershipGrantState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
