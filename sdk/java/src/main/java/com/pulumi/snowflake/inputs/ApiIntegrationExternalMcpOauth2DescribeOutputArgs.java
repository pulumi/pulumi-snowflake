...
public final class ApiIntegrationExternalMcpOauth2DescribeOutputArgs extends com.pulumi.resources.ResourceArgs {

    public static final ApiIntegrationExternalMcpOauth2DescribeOutputArgs Empty = new ApiIntegrationExternalMcpOauth2DescribeOutputArgs();
    ...
    @Import(name="oauthGrant")
    private @Nullable Output<String> oauthGrant;

    public Optional<Output<String>> oauthGrant() {
    ...
    private ApiIntegrationExternalMcpOauth2DescribeOutputArgs() {}

    private ApiIntegrationExternalMcpOauth2DescribeOutputArgs(ApiIntegrationExternalMcpOauth2DescribeOutputArgs $) {
    ...
    public static Builder builder(ApiIntegrationExternalMcpOauth2DescribeOutputArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApiIntegrationExternalMcpOauth2DescribeOutputArgs();
        }

        public Builder(ApiIntegrationExternalMcpOauth2DescribeOutputArgs defaults) {
            $ = new ApiIntegrationExternalMcpOauth2DescribeOutputArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder oauthGrant(@Nullable Output<String> oauthGrant) {
            $.oauthGrant = oauthGrant;
            return this;
        }

        public Builder oauthGrant(String oauthGrant) {
            return oauthGrant(Output.of(oauthGrant));
        }
        ...
        public ApiIntegrationExternalMcpOauth2DescribeOutputArgs build() {
            return $;
        }
    }
