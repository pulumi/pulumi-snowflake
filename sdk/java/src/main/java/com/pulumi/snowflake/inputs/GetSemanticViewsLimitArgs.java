...
public final class GetSemanticViewsLimitArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetSemanticViewsLimitArgs Empty = new GetSemanticViewsLimitArgs();
    ...
    private GetSemanticViewsLimitArgs() {}

    private GetSemanticViewsLimitArgs(GetSemanticViewsLimitArgs $) {
        this.from = $.from;
        this.rows = $.rows;
    }
    ...
    public static Builder builder(GetSemanticViewsLimitArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSemanticViewsLimitArgs();
        }

        public Builder(GetSemanticViewsLimitArgs defaults) {
            $ = new GetSemanticViewsLimitArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetSemanticViewsLimitArgs build() {
            if ($.rows == null) {
                throw new MissingRequiredPropertyException("GetSemanticViewsLimitArgs", "rows");
            }
            return $;
        }
    }
