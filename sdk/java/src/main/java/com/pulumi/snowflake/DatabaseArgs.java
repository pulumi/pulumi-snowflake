...
public final class DatabaseArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Specifies whether to drop public schema on creation or not. Modifying the parameter after database is already created
     * won&#39;t have any effect.
     * 
     */
    ...
    /**
     * @return Configures replication for a given database. When specified, this database will be promoted to serve as a primary
     * database for replication. A primary database can be replicated in one or more accounts, allowing users in those accounts
     * to query objects in each secondary (i.e. replica) database.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param dropPublicSchemaOnCreation Specifies whether to drop public schema on creation or not. Modifying the parameter after database is already created
         * won&#39;t have any effect.
         * 
         * @return builder
         * 
        ...
        /**
         * @param replication Configures replication for a given database. When specified, this database will be promoted to serve as a primary
         * database for replication. A primary database can be replicated in one or more accounts, allowing users in those accounts
         * to query objects in each secondary (i.e. replica) database.
         * 
         * @return builder
