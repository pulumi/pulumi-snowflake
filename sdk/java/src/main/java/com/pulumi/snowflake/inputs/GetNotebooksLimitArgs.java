...
public final class GetNotebooksLimitArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetNotebooksLimitArgs Empty = new GetNotebooksLimitArgs();
    ...
    private GetNotebooksLimitArgs() {}

    private GetNotebooksLimitArgs(GetNotebooksLimitArgs $) {
        this.from = $.from;
        this.rows = $.rows;
    }
    ...
    public static Builder builder(GetNotebooksLimitArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetNotebooksLimitArgs();
        }

        public Builder(GetNotebooksLimitArgs defaults) {
            $ = new GetNotebooksLimitArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetNotebooksLimitArgs build() {
            if ($.rows == null) {
                throw new MissingRequiredPropertyException("GetNotebooksLimitArgs", "rows");
            }
            return $;
        }
    }
