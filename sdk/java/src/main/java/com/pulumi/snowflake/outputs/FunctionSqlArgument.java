...
@CustomType
public final class FunctionSqlArgument {
    /**
    ...
    public static Builder builder(FunctionSqlArgument defaults) {
    ...
    public static final class Builder {
        ...
        private String argName;
        public Builder() {}
        public Builder(FunctionSqlArgument defaults) {
        ...
        public Builder argDataType(String argDataType) {
            if (argDataType == null) {
              throw new MissingRequiredPropertyException("FunctionSqlArgument", "argDataType");
            }
        ...
        public Builder argName(String argName) {
            if (argName == null) {
              throw new MissingRequiredPropertyException("FunctionSqlArgument", "argName");
            }
            this.argName = argName;
            return this;
        }
        public FunctionSqlArgument build() {
            final var _resultValue = new FunctionSqlArgument();
