...
import com.pulumi.snowflake.inputs.ProcedureJavascriptParameterLogEventLevelArgs;
...
public final class ProcedureJavascriptParameterArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<List<ProcedureJavascriptParameterLogEventLevelArgs>> logEventLevels;

    public Optional<Output<List<ProcedureJavascriptParameterLogEventLevelArgs>>> logEventLevels() {
    ...
    public static final class Builder {
        ...
        public Builder logEventLevels(@Nullable Output<List<ProcedureJavascriptParameterLogEventLevelArgs>> logEventLevels) {
            $.logEventLevels = logEventLevels;
            return this;
        }

        public Builder logEventLevels(List<ProcedureJavascriptParameterLogEventLevelArgs> logEventLevels) {
            return logEventLevels(Output.of(logEventLevels));
        }

        public Builder logEventLevels(ProcedureJavascriptParameterLogEventLevelArgs... logEventLevels) {
