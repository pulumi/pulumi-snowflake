...
public final class GetNetworkRulesIn extends com.pulumi.resources.InvokeArgs {

    public static final GetNetworkRulesIn Empty = new GetNetworkRulesIn();
    ...
    private GetNetworkRulesIn() {}

    private GetNetworkRulesIn(GetNetworkRulesIn $) {
    ...
    public static Builder builder(GetNetworkRulesIn defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetNetworkRulesIn();
        }

        public Builder(GetNetworkRulesIn defaults) {
            $ = new GetNetworkRulesIn(Objects.requireNonNull(defaults));
        }
        ...
        public GetNetworkRulesIn build() {
            return $;
        }
    }
