...
@CustomType
public final class JobServiceShowOutput {
    ...
    public static Builder builder(JobServiceShowOutput defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String updatedOn;
        public Builder() {}
        public Builder(JobServiceShowOutput defaults) {
        ...
        public JobServiceShowOutput build() {
            final var _resultValue = new JobServiceShowOutput();
