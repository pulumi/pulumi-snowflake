...
public final class GetOpenflowConnectorsIn extends com.pulumi.resources.InvokeArgs {

    public static final GetOpenflowConnectorsIn Empty = new GetOpenflowConnectorsIn();
    ...
    private GetOpenflowConnectorsIn() {}

    private GetOpenflowConnectorsIn(GetOpenflowConnectorsIn $) {
    ...
    public static Builder builder(GetOpenflowConnectorsIn defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetOpenflowConnectorsIn();
        }

        public Builder(GetOpenflowConnectorsIn defaults) {
            $ = new GetOpenflowConnectorsIn(Objects.requireNonNull(defaults));
        }
        ...
        public GetOpenflowConnectorsIn build() {
            return $;
        }
    }
