...
public final class UnsafeExecuteState extends com.pulumi.resources.ResourceArgs {

    public static final UnsafeExecuteState Empty = new UnsafeExecuteState();
    ...
    private UnsafeExecuteState() {}

    private UnsafeExecuteState(UnsafeExecuteState $) {
    ...
    public static Builder builder(UnsafeExecuteState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new UnsafeExecuteState();
        }

        public Builder(UnsafeExecuteState defaults) {
            $ = new UnsafeExecuteState(Objects.requireNonNull(defaults));
        }
        ...
        public UnsafeExecuteState build() {
            return $;
        }
    }
