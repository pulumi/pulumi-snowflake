...
import com.pulumi.snowflake.inputs.DatabaseGrantState;
 ...
 * 
 * ```sh
 *  $ pulumi import snowflake:index/databaseGrant:DatabaseGrant example &#39;MY_DATABASE❄️USAGE❄️false❄️role1,role2❄️share1,share2&#39;
 * ```
 * 
 */
@ResourceType(type="snowflake:index/databaseGrant:DatabaseGrant")
public class DatabaseGrant extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public DatabaseGrant(String name) {
        this(name, DatabaseGrantArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public DatabaseGrant(String name, DatabaseGrantArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("snowflake:index/databaseGrant:DatabaseGrant", name, args == null ? DatabaseGrantArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private DatabaseGrant(String name, Output<String> id, @Nullable DatabaseGrantState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("snowflake:index/databaseGrant:DatabaseGrant", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static DatabaseGrant get(String name, Output<String> id, @Nullable DatabaseGrantState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
