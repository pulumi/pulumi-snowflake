...
public final class GetTagsInArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetTagsInArgs Empty = new GetTagsInArgs();
    ...
    private GetTagsInArgs() {}

    private GetTagsInArgs(GetTagsInArgs $) {
    ...
    public static Builder builder(GetTagsInArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetTagsInArgs defaults) {
            $ = new GetTagsInArgs(Objects.requireNonNull(defaults));
        }
