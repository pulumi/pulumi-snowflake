...
public final class GetRowAccessPoliciesLimitArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetRowAccessPoliciesLimitArgs Empty = new GetRowAccessPoliciesLimitArgs();
    ...
    private GetRowAccessPoliciesLimitArgs(GetRowAccessPoliciesLimitArgs $) {
        this.from = $.from;
        this.rows = $.rows;
    }
    ...
    public static Builder builder(GetRowAccessPoliciesLimitArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRowAccessPoliciesLimitArgs();
        }

        public Builder(GetRowAccessPoliciesLimitArgs defaults) {
            $ = new GetRowAccessPoliciesLimitArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetRowAccessPoliciesLimitArgs build() {
            if ($.rows == null) {
                throw new MissingRequiredPropertyException("GetRowAccessPoliciesLimitArgs", "rows");
            }
            return $;
        }
    }
