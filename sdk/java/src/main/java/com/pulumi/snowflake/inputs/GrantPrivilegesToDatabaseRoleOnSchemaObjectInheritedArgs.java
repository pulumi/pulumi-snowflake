...
public final class GrantPrivilegesToDatabaseRoleOnSchemaObjectInheritedArgs extends com.pulumi.resources.ResourceArgs {

    public static final GrantPrivilegesToDatabaseRoleOnSchemaObjectInheritedArgs Empty = new GrantPrivilegesToDatabaseRoleOnSchemaObjectInheritedArgs();
    ...
    private GrantPrivilegesToDatabaseRoleOnSchemaObjectInheritedArgs() {}

    private GrantPrivilegesToDatabaseRoleOnSchemaObjectInheritedArgs(GrantPrivilegesToDatabaseRoleOnSchemaObjectInheritedArgs $) {
    ...
    public static Builder builder(GrantPrivilegesToDatabaseRoleOnSchemaObjectInheritedArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GrantPrivilegesToDatabaseRoleOnSchemaObjectInheritedArgs();
        }

        public Builder(GrantPrivilegesToDatabaseRoleOnSchemaObjectInheritedArgs defaults) {
            $ = new GrantPrivilegesToDatabaseRoleOnSchemaObjectInheritedArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GrantPrivilegesToDatabaseRoleOnSchemaObjectInheritedArgs build() {
            if ($.objectTypePlural == null) {
                throw new MissingRequiredPropertyException("GrantPrivilegesToDatabaseRoleOnSchemaObjectInheritedArgs", "objectTypePlural");
            }
            return $;
        }
    }
