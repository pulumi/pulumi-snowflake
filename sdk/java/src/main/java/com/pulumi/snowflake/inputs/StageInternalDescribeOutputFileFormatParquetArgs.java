...
public final class StageInternalDescribeOutputFileFormatParquetArgs extends com.pulumi.resources.ResourceArgs {

    public static final StageInternalDescribeOutputFileFormatParquetArgs Empty = new StageInternalDescribeOutputFileFormatParquetArgs();
    ...
    private StageInternalDescribeOutputFileFormatParquetArgs() {}

    private StageInternalDescribeOutputFileFormatParquetArgs(StageInternalDescribeOutputFileFormatParquetArgs $) {
    ...
    public static Builder builder(StageInternalDescribeOutputFileFormatParquetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StageInternalDescribeOutputFileFormatParquetArgs();
        }

        public Builder(StageInternalDescribeOutputFileFormatParquetArgs defaults) {
            $ = new StageInternalDescribeOutputFileFormatParquetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public StageInternalDescribeOutputFileFormatParquetArgs build() {
            return $;
        }
    }
