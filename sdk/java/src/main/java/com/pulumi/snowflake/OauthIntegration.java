...
public class OauthIntegration extends com.pulumi.resources.CustomResource {
     ...
     */
    public OauthIntegration(java.lang.String name) {
     ...
     */
    public OauthIntegration(java.lang.String name, OauthIntegrationArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public OauthIntegration(java.lang.String name, OauthIntegrationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("snowflake:index/oauthIntegration:OauthIntegration", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private OauthIntegration(java.lang.String name, Output<java.lang.String> id, @Nullable OauthIntegrationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("snowflake:index/oauthIntegration:OauthIntegration", name, state, makeResourceOptions(options, id), false);
    }

    private static OauthIntegrationArgs makeArgs(OauthIntegrationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? OauthIntegrationArgs.Empty : args;
    }
     ...
     */
    public static OauthIntegration get(java.lang.String name, Output<java.lang.String> id, @Nullable OauthIntegrationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
