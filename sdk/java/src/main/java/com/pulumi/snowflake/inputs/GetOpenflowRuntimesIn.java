...
public final class GetOpenflowRuntimesIn extends com.pulumi.resources.InvokeArgs {

    public static final GetOpenflowRuntimesIn Empty = new GetOpenflowRuntimesIn();
    ...
    private GetOpenflowRuntimesIn() {}

    private GetOpenflowRuntimesIn(GetOpenflowRuntimesIn $) {
    ...
    public static Builder builder(GetOpenflowRuntimesIn defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetOpenflowRuntimesIn();
        }

        public Builder(GetOpenflowRuntimesIn defaults) {
            $ = new GetOpenflowRuntimesIn(Objects.requireNonNull(defaults));
        }
        ...
        public GetOpenflowRuntimesIn build() {
            return $;
        }
    }
