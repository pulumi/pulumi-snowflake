...
public final class IcebergTableFromDeltaFilesDescribeOutputArgs extends com.pulumi.resources.ResourceArgs {

    public static final IcebergTableFromDeltaFilesDescribeOutputArgs Empty = new IcebergTableFromDeltaFilesDescribeOutputArgs();
    ...
    @Import(name="sourceIcebergType")
    private @Nullable Output<String> sourceIcebergType;

    public Optional<Output<String>> sourceIcebergType() {
    ...
    private IcebergTableFromDeltaFilesDescribeOutputArgs() {}

    private IcebergTableFromDeltaFilesDescribeOutputArgs(IcebergTableFromDeltaFilesDescribeOutputArgs $) {
        this.check = $.check;
    ...
    public static Builder builder(IcebergTableFromDeltaFilesDescribeOutputArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new IcebergTableFromDeltaFilesDescribeOutputArgs();
        }

        public Builder(IcebergTableFromDeltaFilesDescribeOutputArgs defaults) {
            $ = new IcebergTableFromDeltaFilesDescribeOutputArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder sourceIcebergType(@Nullable Output<String> sourceIcebergType) {
            $.sourceIcebergType = sourceIcebergType;
            return this;
        }

        public Builder sourceIcebergType(String sourceIcebergType) {
            return sourceIcebergType(Output.of(sourceIcebergType));
        }
        ...
        public IcebergTableFromDeltaFilesDescribeOutputArgs build() {
            return $;
        }
    }
