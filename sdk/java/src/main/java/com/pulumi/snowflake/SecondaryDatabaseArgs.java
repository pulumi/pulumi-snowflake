...
public final class SecondaryDatabaseArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private SecondaryDatabaseArgs() {}

    private SecondaryDatabaseArgs(SecondaryDatabaseArgs $) {
    ...
    public static Builder builder(SecondaryDatabaseArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SecondaryDatabaseArgs();
        }

        public Builder(SecondaryDatabaseArgs defaults) {
            $ = new SecondaryDatabaseArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SecondaryDatabaseArgs build() {
            if ($.asReplicaOf == null) {
                throw new MissingRequiredPropertyException("SecondaryDatabaseArgs", "asReplicaOf");
            }
            return $;
        }
    }
