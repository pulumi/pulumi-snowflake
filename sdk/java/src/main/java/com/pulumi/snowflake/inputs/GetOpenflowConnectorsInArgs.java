...
public final class GetOpenflowConnectorsInArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetOpenflowConnectorsInArgs Empty = new GetOpenflowConnectorsInArgs();
    ...
    private GetOpenflowConnectorsInArgs() {}

    private GetOpenflowConnectorsInArgs(GetOpenflowConnectorsInArgs $) {
    ...
    public static Builder builder(GetOpenflowConnectorsInArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetOpenflowConnectorsInArgs();
        }

        public Builder(GetOpenflowConnectorsInArgs defaults) {
            $ = new GetOpenflowConnectorsInArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetOpenflowConnectorsInArgs build() {
            return $;
        }
    }
