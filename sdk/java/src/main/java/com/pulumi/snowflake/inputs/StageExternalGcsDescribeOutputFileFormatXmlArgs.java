...
public final class StageExternalGcsDescribeOutputFileFormatXmlArgs extends com.pulumi.resources.ResourceArgs {

    public static final StageExternalGcsDescribeOutputFileFormatXmlArgs Empty = new StageExternalGcsDescribeOutputFileFormatXmlArgs();
    ...
    private StageExternalGcsDescribeOutputFileFormatXmlArgs() {}

    private StageExternalGcsDescribeOutputFileFormatXmlArgs(StageExternalGcsDescribeOutputFileFormatXmlArgs $) {
    ...
    public static Builder builder(StageExternalGcsDescribeOutputFileFormatXmlArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StageExternalGcsDescribeOutputFileFormatXmlArgs();
        }

        public Builder(StageExternalGcsDescribeOutputFileFormatXmlArgs defaults) {
            $ = new StageExternalGcsDescribeOutputFileFormatXmlArgs(Objects.requireNonNull(defaults));
        }
        ...
        public StageExternalGcsDescribeOutputFileFormatXmlArgs build() {
            return $;
        }
    }
