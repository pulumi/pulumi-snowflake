...
public final class GetNotebooksLimit extends com.pulumi.resources.InvokeArgs {

    public static final GetNotebooksLimit Empty = new GetNotebooksLimit();
    ...
    private GetNotebooksLimit() {}

    private GetNotebooksLimit(GetNotebooksLimit $) {
        this.from = $.from;
        this.rows = $.rows;
    }
    ...
    public static Builder builder(GetNotebooksLimit defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetNotebooksLimit();
        }

        public Builder(GetNotebooksLimit defaults) {
            $ = new GetNotebooksLimit(Objects.requireNonNull(defaults));
        }
        ...
        public GetNotebooksLimit build() {
            if ($.rows == null) {
                throw new MissingRequiredPropertyException("GetNotebooksLimit", "rows");
            }
            return $;
        }
    }
