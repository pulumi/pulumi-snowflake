...
public final class AccountParameterArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Value of account parameter, as a string. Constraints are the same as those for the parameters in Snowflake
     * documentation. The parameter values are validated in Snowflake.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param value Value of account parameter, as a string. Constraints are the same as those for the parameters in Snowflake
         * documentation. The parameter values are validated in Snowflake.
         * 
         * @return builder
         * 
