...
public final class GetDatabasesLimit extends com.pulumi.resources.InvokeArgs {

    public static final GetDatabasesLimit Empty = new GetDatabasesLimit();
    ...
    private GetDatabasesLimit(GetDatabasesLimit $) {
        this.from = $.from;
        this.rows = $.rows;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDatabasesLimit();
        }

        public Builder(GetDatabasesLimit defaults) {
            $ = new GetDatabasesLimit(Objects.requireNonNull(defaults));
        }
