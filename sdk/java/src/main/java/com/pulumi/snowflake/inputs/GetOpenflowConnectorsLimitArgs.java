...
public final class GetOpenflowConnectorsLimitArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetOpenflowConnectorsLimitArgs Empty = new GetOpenflowConnectorsLimitArgs();
    ...
    private GetOpenflowConnectorsLimitArgs() {}

    private GetOpenflowConnectorsLimitArgs(GetOpenflowConnectorsLimitArgs $) {
        this.from = $.from;
        this.rows = $.rows;
    }
    ...
    public static Builder builder(GetOpenflowConnectorsLimitArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetOpenflowConnectorsLimitArgs();
        }

        public Builder(GetOpenflowConnectorsLimitArgs defaults) {
            $ = new GetOpenflowConnectorsLimitArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetOpenflowConnectorsLimitArgs build() {
            if ($.rows == null) {
                throw new MissingRequiredPropertyException("GetOpenflowConnectorsLimitArgs", "rows");
            }
            return $;
        }
    }
