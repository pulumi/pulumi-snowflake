...
public final class GetStreamlitsLimit extends com.pulumi.resources.InvokeArgs {

    public static final GetStreamlitsLimit Empty = new GetStreamlitsLimit();
    ...
    private GetStreamlitsLimit(GetStreamlitsLimit $) {
        this.from = $.from;
        this.rows = $.rows;
    }
    ...
    public static Builder builder(GetStreamlitsLimit defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetStreamlitsLimit();
        }

        public Builder(GetStreamlitsLimit defaults) {
            $ = new GetStreamlitsLimit(Objects.requireNonNull(defaults));
        }
        ...
        public GetStreamlitsLimit build() {
            if ($.rows == null) {
                throw new MissingRequiredPropertyException("GetStreamlitsLimit", "rows");
            }
            return $;
        }
    }
