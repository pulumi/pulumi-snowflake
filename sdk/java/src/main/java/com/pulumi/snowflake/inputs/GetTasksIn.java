...
public final class GetTasksIn extends com.pulumi.resources.InvokeArgs {

    public static final GetTasksIn Empty = new GetTasksIn();
    ...
    public static Builder builder(GetTasksIn defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetTasksIn defaults) {
            $ = new GetTasksIn(Objects.requireNonNull(defaults));
        }
