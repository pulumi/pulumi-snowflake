...
public final class GetHybridTablesLimitArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetHybridTablesLimitArgs Empty = new GetHybridTablesLimitArgs();
    ...
    private GetHybridTablesLimitArgs() {}

    private GetHybridTablesLimitArgs(GetHybridTablesLimitArgs $) {
        this.from = $.from;
        this.rows = $.rows;
    }
    ...
    public static Builder builder(GetHybridTablesLimitArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetHybridTablesLimitArgs();
        }

        public Builder(GetHybridTablesLimitArgs defaults) {
            $ = new GetHybridTablesLimitArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetHybridTablesLimitArgs build() {
            if ($.rows == null) {
                throw new MissingRequiredPropertyException("GetHybridTablesLimitArgs", "rows");
            }
            return $;
        }
    }
