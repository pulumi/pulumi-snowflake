...
public final class GetIcebergTablesLimitArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetIcebergTablesLimitArgs Empty = new GetIcebergTablesLimitArgs();
    ...
    private GetIcebergTablesLimitArgs() {}

    private GetIcebergTablesLimitArgs(GetIcebergTablesLimitArgs $) {
        this.from = $.from;
        this.rows = $.rows;
    }
    ...
    public static Builder builder(GetIcebergTablesLimitArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetIcebergTablesLimitArgs();
        }

        public Builder(GetIcebergTablesLimitArgs defaults) {
            $ = new GetIcebergTablesLimitArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetIcebergTablesLimitArgs build() {
            if ($.rows == null) {
                throw new MissingRequiredPropertyException("GetIcebergTablesLimitArgs", "rows");
            }
            return $;
        }
    }
