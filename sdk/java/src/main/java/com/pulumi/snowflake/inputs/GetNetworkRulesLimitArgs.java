...
public final class GetNetworkRulesLimitArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetNetworkRulesLimitArgs Empty = new GetNetworkRulesLimitArgs();
    ...
    private GetNetworkRulesLimitArgs() {}

    private GetNetworkRulesLimitArgs(GetNetworkRulesLimitArgs $) {
        this.from = $.from;
        this.rows = $.rows;
    }
    ...
    public static Builder builder(GetNetworkRulesLimitArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetNetworkRulesLimitArgs();
        }

        public Builder(GetNetworkRulesLimitArgs defaults) {
            $ = new GetNetworkRulesLimitArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetNetworkRulesLimitArgs build() {
            if ($.rows == null) {
                throw new MissingRequiredPropertyException("GetNetworkRulesLimitArgs", "rows");
            }
            return $;
        }
    }
