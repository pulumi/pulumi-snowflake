...
public final class ProcedureJavaImportArgs extends com.pulumi.resources.ResourceArgs {

    public static final ProcedureJavaImportArgs Empty = new ProcedureJavaImportArgs();
    ...
    private ProcedureJavaImportArgs() {}

    private ProcedureJavaImportArgs(ProcedureJavaImportArgs $) {
    ...
    public static Builder builder(ProcedureJavaImportArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProcedureJavaImportArgs();
        }

        public Builder(ProcedureJavaImportArgs defaults) {
            $ = new ProcedureJavaImportArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ProcedureJavaImportArgs build() {
            if ($.pathOnStage == null) {
                throw new MissingRequiredPropertyException("ProcedureJavaImportArgs", "pathOnStage");
            }
            if ($.stageLocation == null) {
                throw new MissingRequiredPropertyException("ProcedureJavaImportArgs", "stageLocation");
            }
            return $;
        }
    }
