...
public final class StageExternalGcsDescribeOutputFileFormatAvroArgs extends com.pulumi.resources.ResourceArgs {

    public static final StageExternalGcsDescribeOutputFileFormatAvroArgs Empty = new StageExternalGcsDescribeOutputFileFormatAvroArgs();
    ...
    private StageExternalGcsDescribeOutputFileFormatAvroArgs() {}

    private StageExternalGcsDescribeOutputFileFormatAvroArgs(StageExternalGcsDescribeOutputFileFormatAvroArgs $) {
    ...
    public static Builder builder(StageExternalGcsDescribeOutputFileFormatAvroArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StageExternalGcsDescribeOutputFileFormatAvroArgs();
        }

        public Builder(StageExternalGcsDescribeOutputFileFormatAvroArgs defaults) {
            $ = new StageExternalGcsDescribeOutputFileFormatAvroArgs(Objects.requireNonNull(defaults));
        }
        ...
        public StageExternalGcsDescribeOutputFileFormatAvroArgs build() {
            return $;
        }
    }
