...
@CustomType
public final class StreamOnExternalTableAt {
    /**
    ...
    private StreamOnExternalTableAt() {}
    /**
     * @return Specifies the difference in seconds from the current time to use for Time Travel, in the form -N where N can be an integer or arithmetic expression (e.g. -120 is 120 seconds, -30*60 is 1800 seconds or 30 minutes).
     * 
     */
    ...
    public static Builder builder(StreamOnExternalTableAt defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String timestamp;
        public Builder() {}
        public Builder(StreamOnExternalTableAt defaults) {
        ...
        public StreamOnExternalTableAt build() {
            final var _resultValue = new StreamOnExternalTableAt();
