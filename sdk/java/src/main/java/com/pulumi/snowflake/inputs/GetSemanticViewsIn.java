...
public final class GetSemanticViewsIn extends com.pulumi.resources.InvokeArgs {

    public static final GetSemanticViewsIn Empty = new GetSemanticViewsIn();
    ...
    private GetSemanticViewsIn() {}

    private GetSemanticViewsIn(GetSemanticViewsIn $) {
    ...
    public static Builder builder(GetSemanticViewsIn defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSemanticViewsIn();
        }

        public Builder(GetSemanticViewsIn defaults) {
            $ = new GetSemanticViewsIn(Objects.requireNonNull(defaults));
        }
        ...
        public GetSemanticViewsIn build() {
            return $;
        }
    }
