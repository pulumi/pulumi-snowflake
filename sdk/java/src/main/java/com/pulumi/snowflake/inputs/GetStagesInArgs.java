...
public final class GetStagesInArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetStagesInArgs Empty = new GetStagesInArgs();
    ...
    private GetStagesInArgs() {}

    private GetStagesInArgs(GetStagesInArgs $) {
    ...
    public static Builder builder(GetStagesInArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetStagesInArgs defaults) {
            $ = new GetStagesInArgs(Objects.requireNonNull(defaults));
        }
