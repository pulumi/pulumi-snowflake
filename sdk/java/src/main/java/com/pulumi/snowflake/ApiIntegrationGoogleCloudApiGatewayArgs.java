...
public final class ApiIntegrationGoogleCloudApiGatewayArgs extends com.pulumi.resources.ResourceArgs {

    public static final ApiIntegrationGoogleCloudApiGatewayArgs Empty = new ApiIntegrationGoogleCloudApiGatewayArgs();
     ...
     * 
     */
    @Import(name="googleAudience", required=true)
    ...
    private ApiIntegrationGoogleCloudApiGatewayArgs() {}

    private ApiIntegrationGoogleCloudApiGatewayArgs(ApiIntegrationGoogleCloudApiGatewayArgs $) {
    ...
    public static Builder builder(ApiIntegrationGoogleCloudApiGatewayArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApiIntegrationGoogleCloudApiGatewayArgs();
        }

        public Builder(ApiIntegrationGoogleCloudApiGatewayArgs defaults) {
            $ = new ApiIntegrationGoogleCloudApiGatewayArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder googleAudience(Output<String> googleAudience) {
        ...
        public ApiIntegrationGoogleCloudApiGatewayArgs build() {
            if ($.apiAllowedPrefixes == null) {
                throw new MissingRequiredPropertyException("ApiIntegrationGoogleCloudApiGatewayArgs", "apiAllowedPrefixes");
            }
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("ApiIntegrationGoogleCloudApiGatewayArgs", "enabled");
            }
            if ($.googleAudience == null) {
                throw new MissingRequiredPropertyException("ApiIntegrationGoogleCloudApiGatewayArgs", "googleAudience");
            }
            return $;
        }
    }
