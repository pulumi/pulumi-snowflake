...
public class FunctionScala extends com.pulumi.resources.CustomResource {
    ...
    private Output</* @Nullable */ List<FunctionScalaArgument>> arguments;
     ...
     * 
     */
    public Output<Optional<List<FunctionScalaArgument>>> arguments() {
    ...
    private Output</* @Nullable */ List<FunctionScalaImport>> imports;
    ...
    private Output<List<FunctionScalaParameter>> parameters;

    /**
     * @return Outputs the result of `SHOW PARAMETERS IN FUNCTION` for the given function.
     * 
     */
    public Output<List<FunctionScalaParameter>> parameters() {
    ...
    private Output</* @Nullable */ List<FunctionScalaSecret>> secrets;
     ...
     * 
     */
    public Output<Optional<List<FunctionScalaSecret>>> secrets() {
    ...
    private Output<List<FunctionScalaShowOutput>> showOutputs;

    /**
     * @return Outputs the result of `SHOW FUNCTION` for the given function.
     * 
     */
    public Output<List<FunctionScalaShowOutput>> showOutputs() {
     ...
     * 
     */
    public Output<Optional<FunctionScalaTargetPath>> targetPath() {
    ...
    private FunctionScala(java.lang.String name, Output<java.lang.String> id, @Nullable FunctionScalaState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static FunctionScala get(java.lang.String name, Output<java.lang.String> id, @Nullable FunctionScalaState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
