...
public final class StageExternalAzureDescribeOutputFileFormatOrcArgs extends com.pulumi.resources.ResourceArgs {

    public static final StageExternalAzureDescribeOutputFileFormatOrcArgs Empty = new StageExternalAzureDescribeOutputFileFormatOrcArgs();
    ...
    private StageExternalAzureDescribeOutputFileFormatOrcArgs() {}

    private StageExternalAzureDescribeOutputFileFormatOrcArgs(StageExternalAzureDescribeOutputFileFormatOrcArgs $) {
    ...
    public static Builder builder(StageExternalAzureDescribeOutputFileFormatOrcArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StageExternalAzureDescribeOutputFileFormatOrcArgs();
        }

        public Builder(StageExternalAzureDescribeOutputFileFormatOrcArgs defaults) {
            $ = new StageExternalAzureDescribeOutputFileFormatOrcArgs(Objects.requireNonNull(defaults));
        }
        ...
        public StageExternalAzureDescribeOutputFileFormatOrcArgs build() {
            return $;
        }
    }
