...
public final class FunctionArgument {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("FunctionArgument", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("FunctionArgument", "type");
            }
            this.type = type;
            return this;
        }
        public FunctionArgument build() {
            final var _resultValue = new FunctionArgument();
