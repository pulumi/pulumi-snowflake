...
@CustomType
public final class StreamOnViewBefore {
    /**
    ...
    public static Builder builder(StreamOnViewBefore defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String timestamp;
        public Builder() {}
        public Builder(StreamOnViewBefore defaults) {
        ...
        public StreamOnViewBefore build() {
            final var _resultValue = new StreamOnViewBefore();
