...
public final class GetOpenflowDeploymentsLimitArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetOpenflowDeploymentsLimitArgs Empty = new GetOpenflowDeploymentsLimitArgs();
    ...
    private GetOpenflowDeploymentsLimitArgs() {}

    private GetOpenflowDeploymentsLimitArgs(GetOpenflowDeploymentsLimitArgs $) {
        this.from = $.from;
        this.rows = $.rows;
    }
    ...
    public static Builder builder(GetOpenflowDeploymentsLimitArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetOpenflowDeploymentsLimitArgs();
        }

        public Builder(GetOpenflowDeploymentsLimitArgs defaults) {
            $ = new GetOpenflowDeploymentsLimitArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetOpenflowDeploymentsLimitArgs build() {
            if ($.rows == null) {
                throw new MissingRequiredPropertyException("GetOpenflowDeploymentsLimitArgs", "rows");
            }
            return $;
        }
    }
