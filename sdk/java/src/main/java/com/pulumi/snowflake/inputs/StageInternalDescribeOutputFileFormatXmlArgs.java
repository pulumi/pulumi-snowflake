...
public final class StageInternalDescribeOutputFileFormatXmlArgs extends com.pulumi.resources.ResourceArgs {

    public static final StageInternalDescribeOutputFileFormatXmlArgs Empty = new StageInternalDescribeOutputFileFormatXmlArgs();
    ...
    private StageInternalDescribeOutputFileFormatXmlArgs() {}

    private StageInternalDescribeOutputFileFormatXmlArgs(StageInternalDescribeOutputFileFormatXmlArgs $) {
    ...
    public static Builder builder(StageInternalDescribeOutputFileFormatXmlArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StageInternalDescribeOutputFileFormatXmlArgs();
        }

        public Builder(StageInternalDescribeOutputFileFormatXmlArgs defaults) {
            $ = new StageInternalDescribeOutputFileFormatXmlArgs(Objects.requireNonNull(defaults));
        }
        ...
        public StageInternalDescribeOutputFileFormatXmlArgs build() {
            return $;
        }
    }
