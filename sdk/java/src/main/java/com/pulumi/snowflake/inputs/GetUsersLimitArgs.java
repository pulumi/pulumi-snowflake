...
public final class GetUsersLimitArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetUsersLimitArgs Empty = new GetUsersLimitArgs();
    ...
    private GetUsersLimitArgs() {}

    private GetUsersLimitArgs(GetUsersLimitArgs $) {
        this.from = $.from;
        this.rows = $.rows;
    }
    ...
    public static Builder builder(GetUsersLimitArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetUsersLimitArgs();
        }

        public Builder(GetUsersLimitArgs defaults) {
            $ = new GetUsersLimitArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetUsersLimitArgs build() {
            if ($.rows == null) {
                throw new MissingRequiredPropertyException("GetUsersLimitArgs", "rows");
            }
            return $;
        }
    }
