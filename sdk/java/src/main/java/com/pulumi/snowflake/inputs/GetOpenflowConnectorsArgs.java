...
public final class GetOpenflowConnectorsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetOpenflowConnectorsArgs Empty = new GetOpenflowConnectorsArgs();
     ...
     */
    @Import(name="in")
    private @Nullable Output<GetOpenflowConnectorsInArgs> in;

    /**
     * @return IN clause to filter the list of objects
     * 
     */
    public Optional<Output<GetOpenflowConnectorsInArgs>> in() {
     ...
     */
    @Import(name="limit")
    private @Nullable Output<GetOpenflowConnectorsLimitArgs> limit;
     ...
     * 
     */
    public Optional<Output<GetOpenflowConnectorsLimitArgs>> limit() {
    ...
    private GetOpenflowConnectorsArgs() {}

    private GetOpenflowConnectorsArgs(GetOpenflowConnectorsArgs $) {
        this.in = $.in;
        this.like = $.like;
        this.limit = $.limit;
    ...
    public static Builder builder(GetOpenflowConnectorsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetOpenflowConnectorsArgs();
        }

        public Builder(GetOpenflowConnectorsArgs defaults) {
            $ = new GetOpenflowConnectorsArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder in(@Nullable Output<GetOpenflowConnectorsInArgs> in) {
            $.in = in;
            return this;
        }
         ...
         * 
         */
        public Builder in(GetOpenflowConnectorsInArgs in) {
         ...
         * 
         */
        public Builder limit(@Nullable Output<GetOpenflowConnectorsLimitArgs> limit) {
            $.limit = limit;
            return this;
        }
         ...
         * 
         */
        public Builder limit(GetOpenflowConnectorsLimitArgs limit) {
        ...
        public GetOpenflowConnectorsArgs build() {
            return $;
        }
    }
