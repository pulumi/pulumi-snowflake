...
public final class GetStagesIn extends com.pulumi.resources.InvokeArgs {

    public static final GetStagesIn Empty = new GetStagesIn();
    ...
    private GetStagesIn(GetStagesIn $) {
    ...
    public static Builder builder(GetStagesIn defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetStagesIn defaults) {
            $ = new GetStagesIn(Objects.requireNonNull(defaults));
        }
