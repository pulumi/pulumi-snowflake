...
public final class GetServicesIn extends com.pulumi.resources.InvokeArgs {

    public static final GetServicesIn Empty = new GetServicesIn();
    ...
    private GetServicesIn(GetServicesIn $) {
    ...
    public static final class Builder {
        ...
        public Builder(GetServicesIn defaults) {
            $ = new GetServicesIn(Objects.requireNonNull(defaults));
        }
