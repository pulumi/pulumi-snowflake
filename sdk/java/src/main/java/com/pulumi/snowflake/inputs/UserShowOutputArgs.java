...
public final class UserShowOutputArgs extends com.pulumi.resources.ResourceArgs {

    public static final UserShowOutputArgs Empty = new UserShowOutputArgs();
    ...
    private UserShowOutputArgs() {}

    private UserShowOutputArgs(UserShowOutputArgs $) {
    ...
    public static Builder builder(UserShowOutputArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new UserShowOutputArgs();
        }

        public Builder(UserShowOutputArgs defaults) {
            $ = new UserShowOutputArgs(Objects.requireNonNull(defaults));
        }
        ...
        public UserShowOutputArgs build() {
            return $;
        }
    }
