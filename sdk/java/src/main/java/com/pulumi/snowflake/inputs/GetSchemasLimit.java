...
public final class GetSchemasLimit extends com.pulumi.resources.InvokeArgs {

    public static final GetSchemasLimit Empty = new GetSchemasLimit();
    ...
    private GetSchemasLimit() {}

    private GetSchemasLimit(GetSchemasLimit $) {
        this.from = $.from;
        this.rows = $.rows;
    }
    ...
    public static Builder builder(GetSchemasLimit defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetSchemasLimit defaults) {
            $ = new GetSchemasLimit(Objects.requireNonNull(defaults));
        }
        ...
        public GetSchemasLimit build() {
            if ($.rows == null) {
                throw new MissingRequiredPropertyException("GetSchemasLimit", "rows");
            }
            return $;
        }
    }
