...
public final class StageGrantArgs extends com.pulumi.resources.ResourceArgs {

    public static final StageGrantArgs Empty = new StageGrantArgs();
    ...
    public static Builder builder(StageGrantArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(StageGrantArgs defaults) {
            $ = new StageGrantArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param privilege The privilege to grant on the stage. To grant all privileges, use the value `ALL PRIVILEGES`.
         * 
         * @return builder
         * 
         */
        ...
        public StageGrantArgs build() {
            if ($.databaseName == null) {
                throw new MissingRequiredPropertyException("StageGrantArgs", "databaseName");
            }
            if ($.roles == null) {
                throw new MissingRequiredPropertyException("StageGrantArgs", "roles");
            }
            return $;
        }
    }
