...
@CustomType
public final class ProcedurePythonArgument {
    /**
    ...
    public static Builder builder(ProcedurePythonArgument defaults) {
    ...
    public static final class Builder {
        ...
        private String argName;
        public Builder() {}
        public Builder(ProcedurePythonArgument defaults) {
        ...
        public Builder argDataType(String argDataType) {
            if (argDataType == null) {
              throw new MissingRequiredPropertyException("ProcedurePythonArgument", "argDataType");
            }
        ...
        public Builder argName(String argName) {
            if (argName == null) {
              throw new MissingRequiredPropertyException("ProcedurePythonArgument", "argName");
            }
            this.argName = argName;
            return this;
        }
        public ProcedurePythonArgument build() {
            final var _resultValue = new ProcedurePythonArgument();
