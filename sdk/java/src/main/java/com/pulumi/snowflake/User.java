...
import com.pulumi.snowflake.outputs.UserParameter;
import com.pulumi.snowflake.outputs.UserShowOutput;
...
public class User extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="disableMfa", refs={String.class}, tree="[0]")
    private Output</* @Nullable */ String> disableMfa;
     ...
     * 
     */
    public Output<Optional<String>> disableMfa() {
        return Codegen.optional(this.disableMfa);
    }
    /**
    ...
    @Export(name="minsToBypassMfa", refs={Integer.class}, tree="[0]")
    private Output</* @Nullable */ Integer> minsToBypassMfa;

    public Output<Optional<Integer>> minsToBypassMfa() {
        return Codegen.optional(this.minsToBypassMfa);
    }
     ...
     * 
     */
    @Export(name="parameters", refs={List.class,UserParameter.class}, tree="[0,1]")
    private Output<List<UserParameter>> parameters;

    /**
     * @return Outputs the result of `SHOW PARAMETERS IN USER` for the given user.
     * 
     */
    public Output<List<UserParameter>> parameters() {
     ...
     * 
     */
    @Export(name="showOutputs", refs={List.class,UserShowOutput.class}, tree="[0,1]")
    private Output<List<UserShowOutput>> showOutputs;

    /**
     * @return Outputs the result of `SHOW USER` for the given user.
     * 
     */
    public Output<List<UserShowOutput>> showOutputs() {
