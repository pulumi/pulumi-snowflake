...
public final class FileFormatOrcDescribeOutputArgs extends com.pulumi.resources.ResourceArgs {

    public static final FileFormatOrcDescribeOutputArgs Empty = new FileFormatOrcDescribeOutputArgs();
    ...
    private FileFormatOrcDescribeOutputArgs() {}

    private FileFormatOrcDescribeOutputArgs(FileFormatOrcDescribeOutputArgs $) {
        this.id = $.id;
    ...
    public static Builder builder(FileFormatOrcDescribeOutputArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FileFormatOrcDescribeOutputArgs();
        }

        public Builder(FileFormatOrcDescribeOutputArgs defaults) {
            $ = new FileFormatOrcDescribeOutputArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FileFormatOrcDescribeOutputArgs build() {
            return $;
        }
    }
