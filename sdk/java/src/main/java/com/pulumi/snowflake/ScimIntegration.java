...
public class ScimIntegration extends com.pulumi.resources.CustomResource {
     ...
     */
    public ScimIntegration(java.lang.String name) {
     ...
     */
    public ScimIntegration(java.lang.String name, ScimIntegrationArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ScimIntegration(java.lang.String name, ScimIntegrationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("snowflake:index/scimIntegration:ScimIntegration", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ScimIntegration(java.lang.String name, Output<java.lang.String> id, @Nullable ScimIntegrationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("snowflake:index/scimIntegration:ScimIntegration", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static ScimIntegration get(java.lang.String name, Output<java.lang.String> id, @Nullable ScimIntegrationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
