...
@CustomType
public final class ServiceUserShowOutput {
    ...
    public static Builder builder(ServiceUserShowOutput defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String type;
        public Builder() {}
        public Builder(ServiceUserShowOutput defaults) {
        ...
        public ServiceUserShowOutput build() {
            final var _resultValue = new ServiceUserShowOutput();
