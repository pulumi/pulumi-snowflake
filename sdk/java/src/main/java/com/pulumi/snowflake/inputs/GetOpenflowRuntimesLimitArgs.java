...
public final class GetOpenflowRuntimesLimitArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetOpenflowRuntimesLimitArgs Empty = new GetOpenflowRuntimesLimitArgs();
    ...
    private GetOpenflowRuntimesLimitArgs() {}

    private GetOpenflowRuntimesLimitArgs(GetOpenflowRuntimesLimitArgs $) {
        this.from = $.from;
        this.rows = $.rows;
    }
    ...
    public static Builder builder(GetOpenflowRuntimesLimitArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetOpenflowRuntimesLimitArgs();
        }

        public Builder(GetOpenflowRuntimesLimitArgs defaults) {
            $ = new GetOpenflowRuntimesLimitArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetOpenflowRuntimesLimitArgs build() {
            if ($.rows == null) {
                throw new MissingRequiredPropertyException("GetOpenflowRuntimesLimitArgs", "rows");
            }
            return $;
        }
    }
