...
public final class GetTablesLimit extends com.pulumi.resources.InvokeArgs {

    public static final GetTablesLimit Empty = new GetTablesLimit();
    ...
    private GetTablesLimit() {}

    private GetTablesLimit(GetTablesLimit $) {
        this.from = $.from;
        this.rows = $.rows;
    }
    ...
    public static Builder builder(GetTablesLimit defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetTablesLimit defaults) {
            $ = new GetTablesLimit(Objects.requireNonNull(defaults));
        }
        ...
        public GetTablesLimit build() {
            if ($.rows == null) {
                throw new MissingRequiredPropertyException("GetTablesLimit", "rows");
            }
            return $;
        }
    }
