...
public final class GetAuthenticationPoliciesIn extends com.pulumi.resources.InvokeArgs {

    public static final GetAuthenticationPoliciesIn Empty = new GetAuthenticationPoliciesIn();
    ...
    private GetAuthenticationPoliciesIn() {}

    private GetAuthenticationPoliciesIn(GetAuthenticationPoliciesIn $) {
    ...
    public static Builder builder(GetAuthenticationPoliciesIn defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetAuthenticationPoliciesIn();
        }

        public Builder(GetAuthenticationPoliciesIn defaults) {
            $ = new GetAuthenticationPoliciesIn(Objects.requireNonNull(defaults));
        }
        ...
        public GetAuthenticationPoliciesIn build() {
            return $;
        }
    }
