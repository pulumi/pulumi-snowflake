...
public final class FileFormatAvroDescribeOutputArgs extends com.pulumi.resources.ResourceArgs {

    public static final FileFormatAvroDescribeOutputArgs Empty = new FileFormatAvroDescribeOutputArgs();
    ...
    private FileFormatAvroDescribeOutputArgs() {}

    private FileFormatAvroDescribeOutputArgs(FileFormatAvroDescribeOutputArgs $) {
    ...
    public static Builder builder(FileFormatAvroDescribeOutputArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FileFormatAvroDescribeOutputArgs();
        }

        public Builder(FileFormatAvroDescribeOutputArgs defaults) {
            $ = new FileFormatAvroDescribeOutputArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FileFormatAvroDescribeOutputArgs build() {
            return $;
        }
    }
