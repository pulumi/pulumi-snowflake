...
import com.pulumi.snowflake.inputs.GetPasswordPoliciesInArgs;
import com.pulumi.snowflake.inputs.GetPasswordPoliciesLimitArgs;
import com.pulumi.snowflake.inputs.GetPasswordPoliciesOnArgs;
...
public final class GetPasswordPoliciesArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetPasswordPoliciesArgs Empty = new GetPasswordPoliciesArgs();
     ...
     */
    @Import(name="in")
    private @Nullable Output<GetPasswordPoliciesInArgs> in;

    /**
     * @return IN clause to filter the list of objects
     * 
     */
    public Optional<Output<GetPasswordPoliciesInArgs>> in() {
     ...
     */
    @Import(name="limit")
    private @Nullable Output<GetPasswordPoliciesLimitArgs> limit;
     ...
     * 
     */
    public Optional<Output<GetPasswordPoliciesLimitArgs>> limit() {
     ...
     */
    @Import(name="on")
    private @Nullable Output<GetPasswordPoliciesOnArgs> on;

    /**
     * @return Lists the policies that are effective on the specified object.
     * 
     */
    public Optional<Output<GetPasswordPoliciesOnArgs>> on() {
    ...
    private GetPasswordPoliciesArgs() {}

    private GetPasswordPoliciesArgs(GetPasswordPoliciesArgs $) {
        this.in = $.in;
        this.like = $.like;
        this.limit = $.limit;
        this.on = $.on;
    ...
    public static Builder builder(GetPasswordPoliciesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPasswordPoliciesArgs();
        }

        public Builder(GetPasswordPoliciesArgs defaults) {
            $ = new GetPasswordPoliciesArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder in(@Nullable Output<GetPasswordPoliciesInArgs> in) {
            $.in = in;
            return this;
        }
         ...
         * 
         */
        public Builder in(GetPasswordPoliciesInArgs in) {
         ...
         * 
         */
        public Builder limit(@Nullable Output<GetPasswordPoliciesLimitArgs> limit) {
            $.limit = limit;
            return this;
        }
         ...
         * 
         */
        public Builder limit(GetPasswordPoliciesLimitArgs limit) {
         ...
         * 
         */
        public Builder on(@Nullable Output<GetPasswordPoliciesOnArgs> on) {
            $.on = on;
            return this;
        }
         ...
         * 
         */
        public Builder on(GetPasswordPoliciesOnArgs on) {
        ...
        public GetPasswordPoliciesArgs build() {
            return $;
        }
    }
