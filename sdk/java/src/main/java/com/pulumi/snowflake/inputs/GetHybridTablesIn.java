...
public final class GetHybridTablesIn extends com.pulumi.resources.InvokeArgs {

    public static final GetHybridTablesIn Empty = new GetHybridTablesIn();
    ...
    private GetHybridTablesIn() {}

    private GetHybridTablesIn(GetHybridTablesIn $) {
    ...
    public static Builder builder(GetHybridTablesIn defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetHybridTablesIn();
        }

        public Builder(GetHybridTablesIn defaults) {
            $ = new GetHybridTablesIn(Objects.requireNonNull(defaults));
        }
        ...
        public GetHybridTablesIn build() {
            return $;
        }
    }
