...
public final class GetImageRepositoriesInArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImageRepositoriesInArgs Empty = new GetImageRepositoriesInArgs();
    ...
    private GetImageRepositoriesInArgs() {}

    private GetImageRepositoriesInArgs(GetImageRepositoriesInArgs $) {
    ...
    public static Builder builder(GetImageRepositoriesInArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImageRepositoriesInArgs();
        }

        public Builder(GetImageRepositoriesInArgs defaults) {
            $ = new GetImageRepositoriesInArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImageRepositoriesInArgs build() {
            return $;
        }
    }
