...
public final class GetCurrentRoleResult {
    ...
    public static final class Builder {
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetCurrentRoleResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetCurrentRoleResult", "name");
            }
            this.name = name;
            return this;
        }
        public GetCurrentRoleResult build() {
            final var _resultValue = new GetCurrentRoleResult();
            _resultValue.id = id;
