...
@CustomType
public final class ProcedureScalaArgument {
    /**
    ...
    private ProcedureScalaArgument() {}
    /**
     * @return The argument type.
     * 
     */
    ...
    public static Builder builder(ProcedureScalaArgument defaults) {
    ...
    public static final class Builder {
        ...
        private String argName;
        public Builder() {}
        public Builder(ProcedureScalaArgument defaults) {
        ...
        public Builder argDataType(String argDataType) {
            if (argDataType == null) {
              throw new MissingRequiredPropertyException("ProcedureScalaArgument", "argDataType");
            }
        ...
        public Builder argName(String argName) {
            if (argName == null) {
              throw new MissingRequiredPropertyException("ProcedureScalaArgument", "argName");
            }
            this.argName = argName;
            return this;
        }
        public ProcedureScalaArgument build() {
            final var _resultValue = new ProcedureScalaArgument();
