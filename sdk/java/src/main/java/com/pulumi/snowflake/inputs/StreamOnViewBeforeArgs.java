...
public final class StreamOnViewBeforeArgs extends com.pulumi.resources.ResourceArgs {

    public static final StreamOnViewBeforeArgs Empty = new StreamOnViewBeforeArgs();
    ...
    private StreamOnViewBeforeArgs() {}

    private StreamOnViewBeforeArgs(StreamOnViewBeforeArgs $) {
        this.offset = $.offset;
    ...
    public static Builder builder(StreamOnViewBeforeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StreamOnViewBeforeArgs();
        }

        public Builder(StreamOnViewBeforeArgs defaults) {
            $ = new StreamOnViewBeforeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public StreamOnViewBeforeArgs build() {
            return $;
        }
    }
