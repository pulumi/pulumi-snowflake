...
public final class AlertAlertScheduleCron {
    ...
    public static final class Builder {
        ...
        public Builder expression(String expression) {
            if (expression == null) {
              throw new MissingRequiredPropertyException("AlertAlertScheduleCron", "expression");
            }
        ...
        public Builder timeZone(String timeZone) {
            if (timeZone == null) {
              throw new MissingRequiredPropertyException("AlertAlertScheduleCron", "timeZone");
            }
