...
public final class GetUsersLimit extends com.pulumi.resources.InvokeArgs {

    public static final GetUsersLimit Empty = new GetUsersLimit();
    ...
    public static Builder builder(GetUsersLimit defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetUsersLimit defaults) {
            $ = new GetUsersLimit(Objects.requireNonNull(defaults));
        }
        ...
        public GetUsersLimit build() {
            if ($.rows == null) {
                throw new MissingRequiredPropertyException("GetUsersLimit", "rows");
            }
            return $;
        }
    }
