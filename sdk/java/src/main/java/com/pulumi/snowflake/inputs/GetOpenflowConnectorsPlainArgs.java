...
import com.pulumi.snowflake.inputs.GetOpenflowConnectorsIn;
import com.pulumi.snowflake.inputs.GetOpenflowConnectorsLimit;
...
public final class GetOpenflowConnectorsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetOpenflowConnectorsPlainArgs Empty = new GetOpenflowConnectorsPlainArgs();
    ...
    private GetOpenflowConnectorsPlainArgs() {}

    private GetOpenflowConnectorsPlainArgs(GetOpenflowConnectorsPlainArgs $) {
        this.in = $.in;
        this.like = $.like;
        this.limit = $.limit;
    ...
    public static Builder builder(GetOpenflowConnectorsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetOpenflowConnectorsPlainArgs();
        }

        public Builder(GetOpenflowConnectorsPlainArgs defaults) {
            $ = new GetOpenflowConnectorsPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param withDescribe (Default: `true`) Runs DESC OPENFLOW CONNECTOR for each connector returned by SHOW OPENFLOW CONNECTORS. The output of describe is saved to the description field. By default this value is set to true.
         * 
         * @return builder
         * 
         */
        ...
        public GetOpenflowConnectorsPlainArgs build() {
            return $;
        }
    }
