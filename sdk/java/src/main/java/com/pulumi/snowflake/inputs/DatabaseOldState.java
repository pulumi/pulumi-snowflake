...
public final class DatabaseOldState extends com.pulumi.resources.ResourceArgs {

    public static final DatabaseOldState Empty = new DatabaseOldState();
    ...
    private @Nullable Output<DatabaseOldReplicationConfigurationArgs> replicationConfiguration;

    /**
     * @return When set, specifies the configurations for database replication.
     * 
     */
    public Optional<Output<DatabaseOldReplicationConfigurationArgs>> replicationConfiguration() {
        return Optional.ofNullable(this.replicationConfiguration);
    }

    private DatabaseOldState() {}

    private DatabaseOldState(DatabaseOldState $) {
    ...
    public static Builder builder(DatabaseOldState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DatabaseOldState();
        }

        public Builder(DatabaseOldState defaults) {
            $ = new DatabaseOldState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder replicationConfiguration(@Nullable Output<DatabaseOldReplicationConfigurationArgs> replicationConfiguration) {
