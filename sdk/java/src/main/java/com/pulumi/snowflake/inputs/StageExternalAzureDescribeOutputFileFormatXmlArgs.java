...
public final class StageExternalAzureDescribeOutputFileFormatXmlArgs extends com.pulumi.resources.ResourceArgs {

    public static final StageExternalAzureDescribeOutputFileFormatXmlArgs Empty = new StageExternalAzureDescribeOutputFileFormatXmlArgs();
    ...
    private StageExternalAzureDescribeOutputFileFormatXmlArgs() {}

    private StageExternalAzureDescribeOutputFileFormatXmlArgs(StageExternalAzureDescribeOutputFileFormatXmlArgs $) {
    ...
    public static Builder builder(StageExternalAzureDescribeOutputFileFormatXmlArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StageExternalAzureDescribeOutputFileFormatXmlArgs();
        }

        public Builder(StageExternalAzureDescribeOutputFileFormatXmlArgs defaults) {
            $ = new StageExternalAzureDescribeOutputFileFormatXmlArgs(Objects.requireNonNull(defaults));
        }
        ...
        public StageExternalAzureDescribeOutputFileFormatXmlArgs build() {
            return $;
        }
    }
