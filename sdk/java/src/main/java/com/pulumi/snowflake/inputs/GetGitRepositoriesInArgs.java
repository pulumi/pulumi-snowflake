...
public final class GetGitRepositoriesInArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetGitRepositoriesInArgs Empty = new GetGitRepositoriesInArgs();
    ...
    private GetGitRepositoriesInArgs() {}

    private GetGitRepositoriesInArgs(GetGitRepositoriesInArgs $) {
    ...
    public static Builder builder(GetGitRepositoriesInArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetGitRepositoriesInArgs();
        }

        public Builder(GetGitRepositoriesInArgs defaults) {
            $ = new GetGitRepositoriesInArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetGitRepositoriesInArgs build() {
            return $;
        }
    }
