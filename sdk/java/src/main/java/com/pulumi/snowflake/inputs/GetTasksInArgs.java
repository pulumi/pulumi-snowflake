...
public final class GetTasksInArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetTasksInArgs Empty = new GetTasksInArgs();
    ...
    private GetTasksInArgs() {}

    private GetTasksInArgs(GetTasksInArgs $) {
    ...
    public static Builder builder(GetTasksInArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetTasksInArgs defaults) {
            $ = new GetTasksInArgs(Objects.requireNonNull(defaults));
        }
