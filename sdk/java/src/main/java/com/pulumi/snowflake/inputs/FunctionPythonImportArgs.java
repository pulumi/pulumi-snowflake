...
public final class FunctionPythonImportArgs extends com.pulumi.resources.ResourceArgs {

    public static final FunctionPythonImportArgs Empty = new FunctionPythonImportArgs();
    ...
    private FunctionPythonImportArgs() {}

    private FunctionPythonImportArgs(FunctionPythonImportArgs $) {
    ...
    public static Builder builder(FunctionPythonImportArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FunctionPythonImportArgs();
        }

        public Builder(FunctionPythonImportArgs defaults) {
            $ = new FunctionPythonImportArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FunctionPythonImportArgs build() {
            if ($.pathOnStage == null) {
                throw new MissingRequiredPropertyException("FunctionPythonImportArgs", "pathOnStage");
            }
            if ($.stageLocation == null) {
                throw new MissingRequiredPropertyException("FunctionPythonImportArgs", "stageLocation");
            }
            return $;
        }
    }
