...
public final class GetCortexAgentsIn extends com.pulumi.resources.InvokeArgs {

    public static final GetCortexAgentsIn Empty = new GetCortexAgentsIn();
    ...
    private GetCortexAgentsIn() {}

    private GetCortexAgentsIn(GetCortexAgentsIn $) {
    ...
    public static Builder builder(GetCortexAgentsIn defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCortexAgentsIn();
        }

        public Builder(GetCortexAgentsIn defaults) {
            $ = new GetCortexAgentsIn(Objects.requireNonNull(defaults));
        }
        ...
        public GetCortexAgentsIn build() {
            return $;
        }
    }
