...
public final class ProcedureJavaTargetPathArgs extends com.pulumi.resources.ResourceArgs {

    public static final ProcedureJavaTargetPathArgs Empty = new ProcedureJavaTargetPathArgs();
    ...
    private ProcedureJavaTargetPathArgs() {}

    private ProcedureJavaTargetPathArgs(ProcedureJavaTargetPathArgs $) {
    ...
    public static Builder builder(ProcedureJavaTargetPathArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProcedureJavaTargetPathArgs();
        }

        public Builder(ProcedureJavaTargetPathArgs defaults) {
            $ = new ProcedureJavaTargetPathArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ProcedureJavaTargetPathArgs build() {
            if ($.pathOnStage == null) {
                throw new MissingRequiredPropertyException("ProcedureJavaTargetPathArgs", "pathOnStage");
            }
            if ($.stageLocation == null) {
                throw new MissingRequiredPropertyException("ProcedureJavaTargetPathArgs", "stageLocation");
            }
            return $;
        }
    }
