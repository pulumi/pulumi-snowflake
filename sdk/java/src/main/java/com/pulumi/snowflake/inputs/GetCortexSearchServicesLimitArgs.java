...
public final class GetCortexSearchServicesLimitArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetCortexSearchServicesLimitArgs Empty = new GetCortexSearchServicesLimitArgs();
    ...
    private GetCortexSearchServicesLimitArgs() {}

    private GetCortexSearchServicesLimitArgs(GetCortexSearchServicesLimitArgs $) {
        this.from = $.from;
        this.rows = $.rows;
    }
    ...
    public static Builder builder(GetCortexSearchServicesLimitArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCortexSearchServicesLimitArgs();
        }

        public Builder(GetCortexSearchServicesLimitArgs defaults) {
            $ = new GetCortexSearchServicesLimitArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetCortexSearchServicesLimitArgs build() {
            if ($.rows == null) {
                throw new MissingRequiredPropertyException("GetCortexSearchServicesLimitArgs", "rows");
            }
            return $;
        }
    }
