...
public final class UserPublicKeysState extends com.pulumi.resources.ResourceArgs {

    public static final UserPublicKeysState Empty = new UserPublicKeysState();
    ...
    private UserPublicKeysState() {}

    private UserPublicKeysState(UserPublicKeysState $) {
        this.name = $.name;
    ...
    public static Builder builder(UserPublicKeysState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new UserPublicKeysState();
        }

        public Builder(UserPublicKeysState defaults) {
            $ = new UserPublicKeysState(Objects.requireNonNull(defaults));
        }
        ...
        public UserPublicKeysState build() {
            return $;
        }
    }
