...
public final class GetTablesLimitArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetTablesLimitArgs Empty = new GetTablesLimitArgs();
    ...
    private GetTablesLimitArgs() {}

    private GetTablesLimitArgs(GetTablesLimitArgs $) {
        this.from = $.from;
        this.rows = $.rows;
    }
    ...
    public static Builder builder(GetTablesLimitArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetTablesLimitArgs();
        }

        public Builder(GetTablesLimitArgs defaults) {
            $ = new GetTablesLimitArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetTablesLimitArgs build() {
            if ($.rows == null) {
                throw new MissingRequiredPropertyException("GetTablesLimitArgs", "rows");
            }
            return $;
        }
    }
