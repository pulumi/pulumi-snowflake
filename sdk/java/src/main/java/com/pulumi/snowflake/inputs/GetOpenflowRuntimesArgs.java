...
public final class GetOpenflowRuntimesArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetOpenflowRuntimesArgs Empty = new GetOpenflowRuntimesArgs();
     ...
     */
    @Import(name="in")
    private @Nullable Output<GetOpenflowRuntimesInArgs> in;

    /**
     * @return IN clause to filter the list of objects
     * 
     */
    public Optional<Output<GetOpenflowRuntimesInArgs>> in() {
     ...
     */
    @Import(name="limit")
    private @Nullable Output<GetOpenflowRuntimesLimitArgs> limit;
     ...
     * 
     */
    public Optional<Output<GetOpenflowRuntimesLimitArgs>> limit() {
    ...
    private GetOpenflowRuntimesArgs() {}

    private GetOpenflowRuntimesArgs(GetOpenflowRuntimesArgs $) {
        this.in = $.in;
        this.like = $.like;
        this.limit = $.limit;
    ...
    public static Builder builder(GetOpenflowRuntimesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetOpenflowRuntimesArgs();
        }

        public Builder(GetOpenflowRuntimesArgs defaults) {
            $ = new GetOpenflowRuntimesArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder in(@Nullable Output<GetOpenflowRuntimesInArgs> in) {
            $.in = in;
            return this;
        }
         ...
         * 
         */
        public Builder in(GetOpenflowRuntimesInArgs in) {
         ...
         * 
         */
        public Builder limit(@Nullable Output<GetOpenflowRuntimesLimitArgs> limit) {
            $.limit = limit;
            return this;
        }
         ...
         * 
         */
        public Builder limit(GetOpenflowRuntimesLimitArgs limit) {
        ...
        public GetOpenflowRuntimesArgs build() {
            return $;
        }
    }
