...
public final class RoleGrantsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private RoleGrantsArgs() {}

    private RoleGrantsArgs(RoleGrantsArgs $) {
    ...
    public static Builder builder(RoleGrantsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RoleGrantsArgs defaults) {
            $ = new RoleGrantsArgs(Objects.requireNonNull(defaults));
        }
