...
public final class GetListingsLimitArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetListingsLimitArgs Empty = new GetListingsLimitArgs();
    ...
    private GetListingsLimitArgs() {}

    private GetListingsLimitArgs(GetListingsLimitArgs $) {
        this.from = $.from;
        this.rows = $.rows;
    }
    ...
    public static Builder builder(GetListingsLimitArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetListingsLimitArgs();
        }

        public Builder(GetListingsLimitArgs defaults) {
            $ = new GetListingsLimitArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetListingsLimitArgs build() {
            if ($.rows == null) {
                throw new MissingRequiredPropertyException("GetListingsLimitArgs", "rows");
            }
            return $;
        }
    }
