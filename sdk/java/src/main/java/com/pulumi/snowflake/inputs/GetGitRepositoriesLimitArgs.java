...
public final class GetGitRepositoriesLimitArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetGitRepositoriesLimitArgs Empty = new GetGitRepositoriesLimitArgs();
    ...
    private GetGitRepositoriesLimitArgs() {}

    private GetGitRepositoriesLimitArgs(GetGitRepositoriesLimitArgs $) {
        this.from = $.from;
        this.rows = $.rows;
    }
    ...
    public static Builder builder(GetGitRepositoriesLimitArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetGitRepositoriesLimitArgs();
        }

        public Builder(GetGitRepositoriesLimitArgs defaults) {
            $ = new GetGitRepositoriesLimitArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetGitRepositoriesLimitArgs build() {
            if ($.rows == null) {
                throw new MissingRequiredPropertyException("GetGitRepositoriesLimitArgs", "rows");
            }
            return $;
        }
    }
