...
import com.pulumi.snowflake.FailoverGroupGrantArgs;
import com.pulumi.snowflake.Utilities;
import com.pulumi.snowflake.inputs.FailoverGroupGrantState;
...
public class FailoverGroupGrant extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="failoverGroupName", type=String.class, parameters={})
    private Output</* @Nullable */ String> failoverGroupName;

    /**
     * @return The name of the failover group on which to grant privileges.
     * 
     */
    public Output<Optional<String>> failoverGroupName() {
        return Codegen.optional(this.failoverGroupName);
    }
    /**
     ...
     */
    public FailoverGroupGrant(String name) {
        this(name, FailoverGroupGrantArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public FailoverGroupGrant(String name, FailoverGroupGrantArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("snowflake:index/failoverGroupGrant:FailoverGroupGrant", name, args == null ? FailoverGroupGrantArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private FailoverGroupGrant(String name, Output<String> id, @Nullable FailoverGroupGrantState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("snowflake:index/failoverGroupGrant:FailoverGroupGrant", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static FailoverGroupGrant get(String name, Output<String> id, @Nullable FailoverGroupGrantState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
