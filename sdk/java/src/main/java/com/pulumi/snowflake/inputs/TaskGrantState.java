...
public final class TaskGrantState extends com.pulumi.resources.ResourceArgs {

    public static final TaskGrantState Empty = new TaskGrantState();
    ...
    /**
     * @return When this is set to true and a schema*name is provided, apply this grant on all tasks in the given schema. When this is true and no schema*name is provided apply this grant on all tasks in the given database. The task*name field must be unset in order to use on*all. Cannot be used together with on_future.
     * 
     */
    ...
    /**
     * @return When this is set to true and a schema*name is provided, apply this grant on all future tasks in the given schema. When this is true and no schema*name is provided apply this grant on all future tasks in the given database. The task*name field must be unset in order to use on*future. Cannot be used together with on_all.
     * 
     */
    ...
    /**
     * @return The privilege to grant on the current or future task. To grant all privileges, use the value `ALL PRIVILEGES`.
     * 
     */
    ...
    private TaskGrantState() {}

    private TaskGrantState(TaskGrantState $) {
    ...
    public static Builder builder(TaskGrantState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(TaskGrantState defaults) {
            $ = new TaskGrantState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param onAll When this is set to true and a schema*name is provided, apply this grant on all tasks in the given schema. When this is true and no schema*name is provided apply this grant on all tasks in the given database. The task*name field must be unset in order to use on*all. Cannot be used together with on_future.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param onFuture When this is set to true and a schema*name is provided, apply this grant on all future tasks in the given schema. When this is true and no schema*name is provided apply this grant on all future tasks in the given database. The task*name field must be unset in order to use on*future. Cannot be used together with on_all.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param privilege The privilege to grant on the current or future task. To grant all privileges, use the value `ALL PRIVILEGES`.
         * 
         * @return builder
         * 
         */
