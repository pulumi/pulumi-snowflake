...
import com.pulumi.snowflake.inputs.ProcedureJavaState;
import com.pulumi.snowflake.outputs.ProcedureJavaArgument;
import com.pulumi.snowflake.outputs.ProcedureJavaImport;
import com.pulumi.snowflake.outputs.ProcedureJavaParameter;
import com.pulumi.snowflake.outputs.ProcedureJavaSecret;
import com.pulumi.snowflake.outputs.ProcedureJavaShowOutput;
import com.pulumi.snowflake.outputs.ProcedureJavaTargetPath;
 ...
 * 
 */
@ResourceType(type="snowflake:index/procedureJava:ProcedureJava")
public class ProcedureJava extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="arguments", refs={List.class,ProcedureJavaArgument.class}, tree="[0,1]")
    private Output</* @Nullable */ List<ProcedureJavaArgument>> arguments;
     ...
     * 
     */
    public Output<Optional<List<ProcedureJavaArgument>>> arguments() {
     ...
     * 
     */
    @Export(name="imports", refs={List.class,ProcedureJavaImport.class}, tree="[0,1]")
    private Output</* @Nullable */ List<ProcedureJavaImport>> imports;
     ...
     * 
     */
    public Output<Optional<List<ProcedureJavaImport>>> imports() {
     ...
     * 
     */
    @Export(name="parameters", refs={List.class,ProcedureJavaParameter.class}, tree="[0,1]")
    private Output<List<ProcedureJavaParameter>> parameters;

    /**
     * @return Outputs the result of `SHOW PARAMETERS IN PROCEDURE` for the given procedure.
     * 
     */
    public Output<List<ProcedureJavaParameter>> parameters() {
     ...
     * 
     */
    @Export(name="secrets", refs={List.class,ProcedureJavaSecret.class}, tree="[0,1]")
    private Output</* @Nullable */ List<ProcedureJavaSecret>> secrets;

    /**
     * @return Assigns the names of [secrets](https://docs.snowflake.com/en/sql-reference/sql/create-secret) to variables so that you can use the variables to reference the secrets when retrieving information from secrets in handler code. Secrets you specify here must be allowed by the [external access integration](https://docs.snowflake.com/en/sql-reference/sql/create-external-access-integration) specified as a value of this CREATE FUNCTION command’s EXTERNAL*ACCESS*INTEGRATIONS parameter.
     * 
     */
    public Output<Optional<List<ProcedureJavaSecret>>> secrets() {
     ...
     * 
     */
    @Export(name="showOutputs", refs={List.class,ProcedureJavaShowOutput.class}, tree="[0,1]")
    private Output<List<ProcedureJavaShowOutput>> showOutputs;

    /**
     * @return Outputs the result of `SHOW PROCEDURE` for the given procedure.
     * 
     */
    public Output<List<ProcedureJavaShowOutput>> showOutputs() {
     ...
     * 
     */
    @Export(name="targetPath", refs={ProcedureJavaTargetPath.class}, tree="[0]")
    private Output</* @Nullable */ ProcedureJavaTargetPath> targetPath;

    /**
     * @return Use the fully qualified name of the method or function for the stored procedure. This is typically in the following form `com.my_company.my_package.MyClass.myMethod` where `com.my_company.my_package` corresponds to the package containing the object or class: `package com.my_company.my_package;`.
     * 
     */
    public Output<Optional<ProcedureJavaTargetPath>> targetPath() {
     ...
     */
    public ProcedureJava(java.lang.String name) {
        this(name, ProcedureJavaArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public ProcedureJava(java.lang.String name, ProcedureJavaArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ProcedureJava(java.lang.String name, ProcedureJavaArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("snowflake:index/procedureJava:ProcedureJava", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ProcedureJava(java.lang.String name, Output<java.lang.String> id, @Nullable ProcedureJavaState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("snowflake:index/procedureJava:ProcedureJava", name, state, makeResourceOptions(options, id), false);
    }

    private static ProcedureJavaArgs makeArgs(ProcedureJavaArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? ProcedureJavaArgs.Empty : args;
    }
     ...
     */
    public static ProcedureJava get(java.lang.String name, Output<java.lang.String> id, @Nullable ProcedureJavaState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
