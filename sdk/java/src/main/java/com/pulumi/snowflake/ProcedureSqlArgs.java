...
public final class ProcedureSqlArgs extends com.pulumi.resources.ResourceArgs {

    public static final ProcedureSqlArgs Empty = new ProcedureSqlArgs();
    ...
    private ProcedureSqlArgs() {}

    private ProcedureSqlArgs(ProcedureSqlArgs $) {
    ...
    public static Builder builder(ProcedureSqlArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProcedureSqlArgs();
        }

        public Builder(ProcedureSqlArgs defaults) {
            $ = new ProcedureSqlArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ProcedureSqlArgs build() {
            if ($.database == null) {
                throw new MissingRequiredPropertyException("ProcedureSqlArgs", "database");
            }
            if ($.procedureDefinition == null) {
                throw new MissingRequiredPropertyException("ProcedureSqlArgs", "procedureDefinition");
            }
            if ($.returnType == null) {
                throw new MissingRequiredPropertyException("ProcedureSqlArgs", "returnType");
            }
            if ($.schema == null) {
                throw new MissingRequiredPropertyException("ProcedureSqlArgs", "schema");
            }
            return $;
        }
    }
