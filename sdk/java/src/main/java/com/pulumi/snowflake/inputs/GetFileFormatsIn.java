...
public final class GetFileFormatsIn extends com.pulumi.resources.InvokeArgs {

    public static final GetFileFormatsIn Empty = new GetFileFormatsIn();
    ...
    private GetFileFormatsIn() {}

    private GetFileFormatsIn(GetFileFormatsIn $) {
    ...
    public static Builder builder(GetFileFormatsIn defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFileFormatsIn();
        }

        public Builder(GetFileFormatsIn defaults) {
            $ = new GetFileFormatsIn(Objects.requireNonNull(defaults));
        }
