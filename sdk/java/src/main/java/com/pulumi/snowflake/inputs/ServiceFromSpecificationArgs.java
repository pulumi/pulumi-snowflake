...
public final class ServiceFromSpecificationArgs extends com.pulumi.resources.ResourceArgs {

    public static final ServiceFromSpecificationArgs Empty = new ServiceFromSpecificationArgs();
    ...
    private ServiceFromSpecificationArgs() {}

    private ServiceFromSpecificationArgs(ServiceFromSpecificationArgs $) {
        this.file = $.file;
        this.path = $.path;
        this.stage = $.stage;
        this.text = $.text;
    ...
    public static Builder builder(ServiceFromSpecificationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceFromSpecificationArgs();
        }

        public Builder(ServiceFromSpecificationArgs defaults) {
            $ = new ServiceFromSpecificationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ServiceFromSpecificationArgs build() {
            return $;
        }
    }
