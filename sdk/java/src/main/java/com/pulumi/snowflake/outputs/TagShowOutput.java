...
@CustomType
public final class TagShowOutput {
    ...
    public Optional<String> onConflict() {
    ...
    public static Builder builder(TagShowOutput defaults) {
    ...
    public static final class Builder {
        ...
        public TagShowOutput build() {
            final var _resultValue = new TagShowOutput();
