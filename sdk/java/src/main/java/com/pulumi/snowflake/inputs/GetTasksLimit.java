...
public final class GetTasksLimit extends com.pulumi.resources.InvokeArgs {

    public static final GetTasksLimit Empty = new GetTasksLimit();
    ...
    private GetTasksLimit() {}

    private GetTasksLimit(GetTasksLimit $) {
        this.from = $.from;
        this.rows = $.rows;
    }
    ...
    public static Builder builder(GetTasksLimit defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetTasksLimit defaults) {
            $ = new GetTasksLimit(Objects.requireNonNull(defaults));
        }
        ...
        public GetTasksLimit build() {
            if ($.rows == null) {
                throw new MissingRequiredPropertyException("GetTasksLimit", "rows");
            }
            return $;
        }
    }
