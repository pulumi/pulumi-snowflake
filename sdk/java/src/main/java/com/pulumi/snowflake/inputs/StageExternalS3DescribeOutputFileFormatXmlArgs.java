...
public final class StageExternalS3DescribeOutputFileFormatXmlArgs extends com.pulumi.resources.ResourceArgs {

    public static final StageExternalS3DescribeOutputFileFormatXmlArgs Empty = new StageExternalS3DescribeOutputFileFormatXmlArgs();
    ...
    private StageExternalS3DescribeOutputFileFormatXmlArgs() {}

    private StageExternalS3DescribeOutputFileFormatXmlArgs(StageExternalS3DescribeOutputFileFormatXmlArgs $) {
    ...
    public static Builder builder(StageExternalS3DescribeOutputFileFormatXmlArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StageExternalS3DescribeOutputFileFormatXmlArgs();
        }

        public Builder(StageExternalS3DescribeOutputFileFormatXmlArgs defaults) {
            $ = new StageExternalS3DescribeOutputFileFormatXmlArgs(Objects.requireNonNull(defaults));
        }
        ...
        public StageExternalS3DescribeOutputFileFormatXmlArgs build() {
            return $;
        }
    }
