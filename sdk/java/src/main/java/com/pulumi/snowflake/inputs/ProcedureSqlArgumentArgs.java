...
public final class ProcedureSqlArgumentArgs extends com.pulumi.resources.ResourceArgs {

    public static final ProcedureSqlArgumentArgs Empty = new ProcedureSqlArgumentArgs();
    ...
    private ProcedureSqlArgumentArgs() {}

    private ProcedureSqlArgumentArgs(ProcedureSqlArgumentArgs $) {
    ...
    public static Builder builder(ProcedureSqlArgumentArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProcedureSqlArgumentArgs();
        }

        public Builder(ProcedureSqlArgumentArgs defaults) {
            $ = new ProcedureSqlArgumentArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ProcedureSqlArgumentArgs build() {
            if ($.argDataType == null) {
                throw new MissingRequiredPropertyException("ProcedureSqlArgumentArgs", "argDataType");
            }
            if ($.argName == null) {
                throw new MissingRequiredPropertyException("ProcedureSqlArgumentArgs", "argName");
            }
            return $;
        }
    }
