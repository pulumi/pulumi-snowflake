...
public final class GetListingsLimit extends com.pulumi.resources.InvokeArgs {

    public static final GetListingsLimit Empty = new GetListingsLimit();
    ...
    private GetListingsLimit() {}

    private GetListingsLimit(GetListingsLimit $) {
        this.from = $.from;
        this.rows = $.rows;
    }
    ...
    public static Builder builder(GetListingsLimit defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetListingsLimit();
        }

        public Builder(GetListingsLimit defaults) {
            $ = new GetListingsLimit(Objects.requireNonNull(defaults));
        }
        ...
        public GetListingsLimit build() {
            if ($.rows == null) {
                throw new MissingRequiredPropertyException("GetListingsLimit", "rows");
            }
            return $;
        }
    }
