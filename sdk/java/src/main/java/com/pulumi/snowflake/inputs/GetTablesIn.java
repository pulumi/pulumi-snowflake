...
public final class GetTablesIn extends com.pulumi.resources.InvokeArgs {

    public static final GetTablesIn Empty = new GetTablesIn();
    ...
    private GetTablesIn(GetTablesIn $) {
    ...
    public static Builder builder(GetTablesIn defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetTablesIn defaults) {
            $ = new GetTablesIn(Objects.requireNonNull(defaults));
        }
