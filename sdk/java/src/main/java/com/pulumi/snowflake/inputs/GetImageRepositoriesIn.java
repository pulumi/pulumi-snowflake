...
public final class GetImageRepositoriesIn extends com.pulumi.resources.InvokeArgs {

    public static final GetImageRepositoriesIn Empty = new GetImageRepositoriesIn();
    ...
    private GetImageRepositoriesIn() {}

    private GetImageRepositoriesIn(GetImageRepositoriesIn $) {
    ...
    public static Builder builder(GetImageRepositoriesIn defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImageRepositoriesIn();
        }

        public Builder(GetImageRepositoriesIn defaults) {
            $ = new GetImageRepositoriesIn(Objects.requireNonNull(defaults));
        }
        ...
        public GetImageRepositoriesIn build() {
            return $;
        }
    }
