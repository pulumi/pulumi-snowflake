...
import com.pulumi.snowflake.ServiceArgs;
import com.pulumi.snowflake.Utilities;
import com.pulumi.snowflake.inputs.ServiceState;
import com.pulumi.snowflake.outputs.ServiceDescribeOutput;
import com.pulumi.snowflake.outputs.ServiceFromSpecification;
import com.pulumi.snowflake.outputs.ServiceFromSpecificationTemplate;
import com.pulumi.snowflake.outputs.ServiceShowOutput;
 ...
 * 
 */
@ResourceType(type="snowflake:index/service:Service")
public class Service extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="describeOutputs", refs={List.class,ServiceDescribeOutput.class}, tree="[0,1]")
    private Output<List<ServiceDescribeOutput>> describeOutputs;

    /**
     * @return Outputs the result of `DESCRIBE SERVICE` for the given service.
     * 
     */
    public Output<List<ServiceDescribeOutput>> describeOutputs() {
     ...
     * 
     */
    @Export(name="fromSpecification", refs={ServiceFromSpecification.class}, tree="[0]")
    private Output</* @Nullable */ ServiceFromSpecification> fromSpecification;
     ...
     * 
     */
    public Output<Optional<ServiceFromSpecification>> fromSpecification() {
     ...
     * 
     */
    @Export(name="fromSpecificationTemplate", refs={ServiceFromSpecificationTemplate.class}, tree="[0]")
    private Output</* @Nullable */ ServiceFromSpecificationTemplate> fromSpecificationTemplate;
     ...
     * 
     */
    public Output<Optional<ServiceFromSpecificationTemplate>> fromSpecificationTemplate() {
     ...
     * 
     */
    @Export(name="showOutputs", refs={List.class,ServiceShowOutput.class}, tree="[0,1]")
    private Output<List<ServiceShowOutput>> showOutputs;

    /**
     * @return Outputs the result of `SHOW SERVICES` for the given service.
     * 
     */
    public Output<List<ServiceShowOutput>> showOutputs() {
    ...
    public Service(java.lang.String name, ServiceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("snowflake:index/service:Service", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Service(java.lang.String name, Output<java.lang.String> id, @Nullable ServiceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("snowflake:index/service:Service", name, state, makeResourceOptions(options, id), false);
    }
