...
public final class GetTablesInArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetTablesInArgs Empty = new GetTablesInArgs();
    ...
    private GetTablesInArgs() {}

    private GetTablesInArgs(GetTablesInArgs $) {
    ...
    public static Builder builder(GetTablesInArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetTablesInArgs defaults) {
            $ = new GetTablesInArgs(Objects.requireNonNull(defaults));
        }
