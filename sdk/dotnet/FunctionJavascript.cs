...
namespace Pulumi.Snowflake
{
    ...
    /// {
    ///     // Minimal
    ///     var minimal = new Snowflake.Index.FunctionJavascript("minimal", new()
    ///     {
    ///         Database = test.Name,
    ...
    public partial class FunctionJavascript : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("arguments")]
        public Output<ImmutableArray<Outputs.FunctionJavascriptArgument>> Arguments { get; private set; } = null!;
        ...
        /// </summary>
        [Output("parameters")]
        public Output<ImmutableArray<Outputs.FunctionJavascriptParameter>> Parameters { get; private set; } = null!;
        ...
        /// </summary>
        [Output("showOutputs")]
        public Output<ImmutableArray<Outputs.FunctionJavascriptShowOutput>> ShowOutputs { get; private set; } = null!;
        ...
        /// <summary>
        /// Create a FunctionJavascript resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public FunctionJavascript(string name, FunctionJavascriptArgs args, CustomResourceOptions? options = null)
            : base("snowflake:index/functionJavascript:FunctionJavascript", name, args ?? new FunctionJavascriptArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FunctionJavascript(string name, Input<string> id, FunctionJavascriptState? state = null, CustomResourceOptions? options = null)
            : base("snowflake:index/functionJavascript:FunctionJavascript", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FunctionJavascript Get(string name, Input<string> id, FunctionJavascriptState? state = null, CustomResourceOptions? options = null)
        {
            return new FunctionJavascript(name, id, state, options);
        }
    }

    public sealed class FunctionJavascriptArgs : global::Pulumi.ResourceArgs
    {
        [Input("arguments")]
        private InputList<Inputs.FunctionJavascriptArgumentArgs>? _arguments;

        /// <summary>
        /// List of the arguments for the function. Consult the [docs](https://docs.snowflake.com/en/sql-reference/sql/create-function#all-languages) for more details.
        /// </summary>
        public InputList<Inputs.FunctionJavascriptArgumentArgs> Arguments
        {
            get => _arguments ?? (_arguments = new InputList<Inputs.FunctionJavascriptArgumentArgs>());
        ...
        public FunctionJavascriptArgs()
        {
        }
        public static new FunctionJavascriptArgs Empty => new FunctionJavascriptArgs();
    }

    public sealed class FunctionJavascriptState : global::Pulumi.ResourceArgs
    {
        [Input("arguments")]
        private InputList<Inputs.FunctionJavascriptArgumentGetArgs>? _arguments;

        /// <summary>
        /// List of the arguments for the function. Consult the [docs](https://docs.snowflake.com/en/sql-reference/sql/create-function#all-languages) for more details.
        /// </summary>
        public InputList<Inputs.FunctionJavascriptArgumentGetArgs> Arguments
        {
            get => _arguments ?? (_arguments = new InputList<Inputs.FunctionJavascriptArgumentGetArgs>());
            set => _arguments = value;
        }
        ...
        [Input("parameters")]
        private InputList<Inputs.FunctionJavascriptParameterGetArgs>? _parameters;

        /// <summary>
        /// Outputs the result of `SHOW PARAMETERS IN FUNCTION` for the given function.
        /// </summary>
        public InputList<Inputs.FunctionJavascriptParameterGetArgs> Parameters
        {
            get => _parameters ?? (_parameters = new InputList<Inputs.FunctionJavascriptParameterGetArgs>());
        ...
        [Input("showOutputs")]
        private InputList<Inputs.FunctionJavascriptShowOutputGetArgs>? _showOutputs;

        /// <summary>
        /// Outputs the result of `SHOW FUNCTION` for the given function.
        /// </summary>
        public InputList<Inputs.FunctionJavascriptShowOutputGetArgs> ShowOutputs
        {
            get => _showOutputs ?? (_showOutputs = new InputList<Inputs.FunctionJavascriptShowOutputGetArgs>());
        ...
        public FunctionJavascriptState()
        {
        }
        public static new FunctionJavascriptState Empty => new FunctionJavascriptState();
    }
}
