...
namespace Pulumi.Snowflake.Inputs
{
    ...
    public sealed class ServiceFromSpecificationTemplateGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.ServiceFromSpecificationTemplateUsingGetArgs>? _usings;

        /// <summary>
        /// List of the specified template variables and the values of those variables.
        /// </summary>
        public InputList<Inputs.ServiceFromSpecificationTemplateUsingGetArgs> Usings
        {
            get => _usings ?? (_usings = new InputList<Inputs.ServiceFromSpecificationTemplateUsingGetArgs>());
            set => _usings = value;
        }

        public ServiceFromSpecificationTemplateGetArgs()
        {
        }
        public static new ServiceFromSpecificationTemplateGetArgs Empty => new ServiceFromSpecificationTemplateGetArgs();
    }
}
