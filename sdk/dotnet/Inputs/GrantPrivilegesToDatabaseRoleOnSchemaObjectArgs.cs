...
namespace Pulumi.Snowflake.Inputs
{
    ...
    public sealed class GrantPrivilegesToDatabaseRoleOnSchemaObjectArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Configures the privilege to be granted on all objects in either a database or schema.
        /// </summary>
        [Input("all")]
        public Input<Inputs.GrantPrivilegesToDatabaseRoleOnSchemaObjectAllArgs>? All { get; set; }

        /// <summary>
        /// Configures the privilege to be granted on future objects in either a database or schema.
        /// </summary>
        [Input("future")]
        public Input<Inputs.GrantPrivilegesToDatabaseRoleOnSchemaObjectFutureArgs>? Future { get; set; }
        ...
        /// </summary>
        [Input("inherited")]
        public Input<Inputs.GrantPrivilegesToDatabaseRoleOnSchemaObjectInheritedArgs>? Inherited { get; set; }
        ...
        public GrantPrivilegesToDatabaseRoleOnSchemaObjectArgs()
        {
        }
        public static new GrantPrivilegesToDatabaseRoleOnSchemaObjectArgs Empty => new GrantPrivilegesToDatabaseRoleOnSchemaObjectArgs();
    }
}
