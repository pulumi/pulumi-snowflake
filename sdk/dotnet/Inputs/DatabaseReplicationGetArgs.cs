...
namespace Pulumi.Snowflake.Inputs
{
    ...
    public sealed class DatabaseReplicationGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("enableToAccounts", required: true)]
        private InputList<Inputs.DatabaseReplicationEnableToAccountGetArgs>? _enableToAccounts;

        /// <summary>
        /// Entry to enable replication and optionally failover for a given account identifier.
        /// </summary>
        public InputList<Inputs.DatabaseReplicationEnableToAccountGetArgs> EnableToAccounts
        {
            get => _enableToAccounts ?? (_enableToAccounts = new InputList<Inputs.DatabaseReplicationEnableToAccountGetArgs>());
        ...
        public DatabaseReplicationGetArgs()
        {
        }
        public static new DatabaseReplicationGetArgs Empty => new DatabaseReplicationGetArgs();
    }
}
