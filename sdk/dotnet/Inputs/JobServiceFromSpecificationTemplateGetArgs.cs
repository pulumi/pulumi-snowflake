...
namespace Pulumi.Snowflake.Inputs
{
    ...
    public sealed class JobServiceFromSpecificationTemplateGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.JobServiceFromSpecificationTemplateUsingGetArgs>? _usings;

        /// <summary>
        /// List of the specified template variables and the values of those variables.
        /// </summary>
        public InputList<Inputs.JobServiceFromSpecificationTemplateUsingGetArgs> Usings
        {
            get => _usings ?? (_usings = new InputList<Inputs.JobServiceFromSpecificationTemplateUsingGetArgs>());
            set => _usings = value;
        }

        public JobServiceFromSpecificationTemplateGetArgs()
        {
        }
        public static new JobServiceFromSpecificationTemplateGetArgs Empty => new JobServiceFromSpecificationTemplateGetArgs();
    }
}
