...
namespace Pulumi.Snowflake.Inputs
{
    ...
    public sealed class GrantOwnershipOnGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Configures the privilege to be granted on all objects in either a database or schema.
        /// </summary>
        [Input("all")]
        public Input<Inputs.GrantOwnershipOnAllGetArgs>? All { get; set; }

        /// <summary>
        /// Configures the privilege to be granted on all objects in either a database or schema.
        /// </summary>
        [Input("future")]
        public Input<Inputs.GrantOwnershipOnFutureGetArgs>? Future { get; set; }
        ...
        public GrantOwnershipOnGetArgs()
        {
        }
        public static new GrantOwnershipOnGetArgs Empty => new GrantOwnershipOnGetArgs();
    }
}
