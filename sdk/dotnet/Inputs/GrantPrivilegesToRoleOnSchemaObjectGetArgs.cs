...
namespace Pulumi.Snowflake.Inputs
{
    ...
    public sealed class GrantPrivilegesToRoleOnSchemaObjectGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Configures the privilege to be granted on all objects in eihter a database or schema.
        /// </summary>
        [Input("all")]
        public Input<Inputs.GrantPrivilegesToRoleOnSchemaObjectAllGetArgs>? All { get; set; }

        /// <summary>
        /// Configures the privilege to be granted on future objects in eihter a database or schema.
        /// </summary>
        [Input("future")]
        public Input<Inputs.GrantPrivilegesToRoleOnSchemaObjectFutureGetArgs>? Future { get; set; }
        ...
        public GrantPrivilegesToRoleOnSchemaObjectGetArgs()
        {
        }
        public static new GrantPrivilegesToRoleOnSchemaObjectGetArgs Empty => new GrantPrivilegesToRoleOnSchemaObjectGetArgs();
    }
}
