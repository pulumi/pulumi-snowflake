...
namespace Pulumi.Snowflake.Inputs
{
    ...
    public sealed class GrantPrivilegesToRoleOnSchemaObjectArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Configures the privilege to be granted on all objects in eihter a database or schema.
        /// </summary>
        [Input("all")]
        public Input<Inputs.GrantPrivilegesToRoleOnSchemaObjectAllArgs>? All { get; set; }

        /// <summary>
        /// Configures the privilege to be granted on future objects in eihter a database or schema.
        /// </summary>
        [Input("future")]
        public Input<Inputs.GrantPrivilegesToRoleOnSchemaObjectFutureArgs>? Future { get; set; }
        ...
        public GrantPrivilegesToRoleOnSchemaObjectArgs()
        {
        }
        public static new GrantPrivilegesToRoleOnSchemaObjectArgs Empty => new GrantPrivilegesToRoleOnSchemaObjectArgs();
    }
}
