...
namespace Pulumi.Snowflake
{
    ...
    public partial class User : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("showOutputs")]
        public Output<ImmutableArray<Outputs.UserShowOutput>> ShowOutputs { get; private set; } = null!;
    ...
    public sealed class UserArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("middleName")]
        private Input<string>? _middleName;
        ...
        public Input<string>? MiddleName
        {
            ...
            {
                var emptySecret = Output.CreateSecret(0);
                _middleName = Output.Tuple<Input<string>?, int>(value, emptySecret).Apply(t => t.Item1);
            }
        }
    ...
    public sealed class UserState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("parameters")]
        private InputList<Inputs.UserParameterGetArgs>? _parameters;

        /// <summary>
        /// Outputs the result of `SHOW PARAMETERS IN USER` for the given user.
        /// </summary>
        public InputList<Inputs.UserParameterGetArgs> Parameters
        {
            get => _parameters ?? (_parameters = new InputList<Inputs.UserParameterGetArgs>());
        ...
        [Input("showOutputs")]
        private InputList<Inputs.UserShowOutputGetArgs>? _showOutputs;

        /// <summary>
        /// Outputs the result of `SHOW USER` for the given user.
        /// </summary>
        public InputList<Inputs.UserShowOutputGetArgs> ShowOutputs
        {
            get => _showOutputs ?? (_showOutputs = new InputList<Inputs.UserShowOutputGetArgs>());
