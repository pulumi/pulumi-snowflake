...
namespace Pulumi.Snowflake
{
    public static class GetResourceMonitors
    {
        ...
        public static Task<GetResourceMonitorsResult> InvokeAsync(InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetResourceMonitorsResult>("snowflake:index/getResourceMonitors:getResourceMonitors", InvokeArgs.Empty, options.WithVersion());
    }
