...
namespace Pulumi.Snowflake
{
    ...
    public partial class StageGrant : global::Pulumi.CustomResource
    {
        ...
        public StageGrant(string name, StageGrantArgs args, CustomResourceOptions? options = null)
            : base("snowflake:index/stageGrant:StageGrant", name, args ?? new StageGrantArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StageGrant(string name, Input<string> id, StageGrantState? state = null, CustomResourceOptions? options = null)
            : base("snowflake:index/stageGrant:StageGrant", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static StageGrant Get(string name, Input<string> id, StageGrantState? state = null, CustomResourceOptions? options = null)
        {
