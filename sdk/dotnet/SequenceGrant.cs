...
namespace Pulumi.Snowflake
{
    ...
    public partial class SequenceGrant : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("sequenceName")]
        public Output<string?> SequenceName { get; private set; } = null!;
        ...
        public SequenceGrant(string name, SequenceGrantArgs args, CustomResourceOptions? options = null)
            : base("snowflake:index/sequenceGrant:SequenceGrant", name, args ?? new SequenceGrantArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SequenceGrant(string name, Input<string> id, SequenceGrantState? state = null, CustomResourceOptions? options = null)
            : base("snowflake:index/sequenceGrant:SequenceGrant", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SequenceGrant Get(string name, Input<string> id, SequenceGrantState? state = null, CustomResourceOptions? options = null)
        {
