...
namespace Pulumi.Snowflake
{
    ...
    /// ```
    /// </summary>
    [SnowflakeResourceType("snowflake:index/fileFormatParquet:FileFormatParquet")]
    public partial class FileFormatParquet : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("binaryAsText")]
        public Output<string?> BinaryAsText { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.FileFormatParquetDescribeOutput>> DescribeOutputs { get; private set; } = null!;
        ...
        /// </summary>
        [Output("showOutputs")]
        public Output<ImmutableArray<Outputs.FileFormatParquetShowOutput>> ShowOutputs { get; private set; } = null!;
        ...
        /// </summary>
        [Output("useLogicalType")]
        public Output<string?> UseLogicalType { get; private set; } = null!;
        ...
        /// </summary>
        [Output("useVectorizedScanner")]
        public Output<string?> UseVectorizedScanner { get; private set; } = null!;


        /// <summary>
        /// Create a FileFormatParquet resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public FileFormatParquet(string name, FileFormatParquetArgs args, CustomResourceOptions? options = null)
            : base("snowflake:index/fileFormatParquet:FileFormatParquet", name, args ?? new FileFormatParquetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FileFormatParquet(string name, Input<string> id, FileFormatParquetState? state = null, CustomResourceOptions? options = null)
            : base("snowflake:index/fileFormatParquet:FileFormatParquet", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FileFormatParquet Get(string name, Input<string> id, FileFormatParquetState? state = null, CustomResourceOptions? options = null)
        {
            return new FileFormatParquet(name, id, state, options);
        }
    }

    public sealed class FileFormatParquetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Default: fallback to Snowflake default - uses special value that cannot be set in the configuration manually (`Default`)) Boolean that specifies whether to interpret columns with no defined logical data type as UTF-8 text. Available options are: "true" or "false". When the value is not set in the configuration the provider will put "default" there which means to use the Snowflake default for this value.
        /// </summary>
        ...
        public FileFormatParquetArgs()
        {
        }
        public static new FileFormatParquetArgs Empty => new FileFormatParquetArgs();
    }

    public sealed class FileFormatParquetState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Default: fallback to Snowflake default - uses special value that cannot be set in the configuration manually (`Default`)) Boolean that specifies whether to interpret columns with no defined logical data type as UTF-8 text. Available options are: "true" or "false". When the value is not set in the configuration the provider will put "default" there which means to use the Snowflake default for this value.
        /// </summary>
        ...
        private InputList<Inputs.FileFormatParquetDescribeOutputGetArgs>? _describeOutputs;

        /// <summary>
        /// Outputs the result of `DESCRIBE FILE FORMAT` for this file format.
        /// </summary>
        public InputList<Inputs.FileFormatParquetDescribeOutputGetArgs> DescribeOutputs
        {
            get => _describeOutputs ?? (_describeOutputs = new InputList<Inputs.FileFormatParquetDescribeOutputGetArgs>());
        ...
        [Input("showOutputs")]
        private InputList<Inputs.FileFormatParquetShowOutputGetArgs>? _showOutputs;

        /// <summary>
        /// Outputs the result of `SHOW FILE FORMATS` for this file format.
        /// </summary>
        public InputList<Inputs.FileFormatParquetShowOutputGetArgs> ShowOutputs
        {
            get => _showOutputs ?? (_showOutputs = new InputList<Inputs.FileFormatParquetShowOutputGetArgs>());
        ...
        public FileFormatParquetState()
        {
        }
        public static new FileFormatParquetState Empty => new FileFormatParquetState();
    }
}
