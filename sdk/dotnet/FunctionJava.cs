...
{
    [SnowflakeResourceType("snowflake:index/functionJava:FunctionJava")]
    public partial class FunctionJava : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("arguments")]
        public Output<ImmutableArray<Outputs.FunctionJavaArgument>> Arguments { get; private set; } = null!;
        ...
        /// </summary>
        [Output("imports")]
        public Output<ImmutableArray<Outputs.FunctionJavaImport>> Imports { get; private set; } = null!;
        ...
        /// </summary>
        [Output("parameters")]
        public Output<ImmutableArray<Outputs.FunctionJavaParameter>> Parameters { get; private set; } = null!;
        ...
        /// </summary>
        [Output("secrets")]
        public Output<ImmutableArray<Outputs.FunctionJavaSecret>> Secrets { get; private set; } = null!;

        /// <summary>
        /// Outputs the result of `SHOW FUNCTION` for the given function.
        /// </summary>
        [Output("showOutputs")]
        public Output<ImmutableArray<Outputs.FunctionJavaShowOutput>> ShowOutputs { get; private set; } = null!;
        ...
        /// </summary>
        [Output("targetPath")]
        public Output<Outputs.FunctionJavaTargetPath?> TargetPath { get; private set; } = null!;
        ...
        public FunctionJava(string name, FunctionJavaArgs args, CustomResourceOptions? options = null)
            : base("snowflake:index/functionJava:FunctionJava", name, args ?? new FunctionJavaArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FunctionJava(string name, Input<string> id, FunctionJavaState? state = null, CustomResourceOptions? options = null)
            : base("snowflake:index/functionJava:FunctionJava", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FunctionJava Get(string name, Input<string> id, FunctionJavaState? state = null, CustomResourceOptions? options = null)
        {
            return new FunctionJava(name, id, state, options);
        }
    }

    public sealed class FunctionJavaArgs : global::Pulumi.ResourceArgs
    {
        [Input("arguments")]
        private InputList<Inputs.FunctionJavaArgumentArgs>? _arguments;

        /// <summary>
        /// List of the arguments for the function. Consult the
        /// [docs](https://docs.snowflake.com/en/sql-reference/sql/create-function#all-languages) for more details.
        /// </summary>
        public InputList<Inputs.FunctionJavaArgumentArgs> Arguments
        {
            get => _arguments ?? (_arguments = new InputList<Inputs.FunctionJavaArgumentArgs>());
        ...
        [Input("imports")]
        private InputList<Inputs.FunctionJavaImportArgs>? _imports;
        ...
        /// Consult the [docs](https://docs.snowflake.com/en/sql-reference/sql/create-function#java).
        /// </summary>
        public InputList<Inputs.FunctionJavaImportArgs> Imports
        {
            get => _imports ?? (_imports = new InputList<Inputs.FunctionJavaImportArgs>());
            set => _imports = value;
        }
        ...
        [Input("secrets")]
        private InputList<Inputs.FunctionJavaSecretArgs>? _secrets;
        ...
        /// this CREATE FUNCTION command’s EXTERNAL_ACCESS_INTEGRATIONS parameter.
        /// </summary>
        public InputList<Inputs.FunctionJavaSecretArgs> Secrets
        {
            get => _secrets ?? (_secrets = new InputList<Inputs.FunctionJavaSecretArgs>());
            set => _secrets = value;
        }
        ...
        /// </summary>
        [Input("targetPath")]
        public Input<Inputs.FunctionJavaTargetPathArgs>? TargetPath { get; set; }
        ...
        public FunctionJavaArgs()
        {
        }
        public static new FunctionJavaArgs Empty => new FunctionJavaArgs();
    }

    public sealed class FunctionJavaState : global::Pulumi.ResourceArgs
    {
        [Input("arguments")]
        private InputList<Inputs.FunctionJavaArgumentGetArgs>? _arguments;

        /// <summary>
        /// List of the arguments for the function. Consult the
        /// [docs](https://docs.snowflake.com/en/sql-reference/sql/create-function#all-languages) for more details.
        /// </summary>
        public InputList<Inputs.FunctionJavaArgumentGetArgs> Arguments
        {
            get => _arguments ?? (_arguments = new InputList<Inputs.FunctionJavaArgumentGetArgs>());
            set => _arguments = value;
        }
        ...
        [Input("imports")]
        private InputList<Inputs.FunctionJavaImportGetArgs>? _imports;
        ...
        /// Consult the [docs](https://docs.snowflake.com/en/sql-reference/sql/create-function#java).
        /// </summary>
        public InputList<Inputs.FunctionJavaImportGetArgs> Imports
        {
            get => _imports ?? (_imports = new InputList<Inputs.FunctionJavaImportGetArgs>());
            set => _imports = value;
        }
        ...
        [Input("parameters")]
        private InputList<Inputs.FunctionJavaParameterGetArgs>? _parameters;

        /// <summary>
        /// Outputs the result of `SHOW PARAMETERS IN FUNCTION` for the given function.
        /// </summary>
        public InputList<Inputs.FunctionJavaParameterGetArgs> Parameters
        {
            get => _parameters ?? (_parameters = new InputList<Inputs.FunctionJavaParameterGetArgs>());
        ...
        [Input("secrets")]
        private InputList<Inputs.FunctionJavaSecretGetArgs>? _secrets;
        ...
        /// this CREATE FUNCTION command’s EXTERNAL_ACCESS_INTEGRATIONS parameter.
        /// </summary>
        public InputList<Inputs.FunctionJavaSecretGetArgs> Secrets
        {
            get => _secrets ?? (_secrets = new InputList<Inputs.FunctionJavaSecretGetArgs>());
            set => _secrets = value;
        }

        [Input("showOutputs")]
        private InputList<Inputs.FunctionJavaShowOutputGetArgs>? _showOutputs;

        /// <summary>
        /// Outputs the result of `SHOW FUNCTION` for the given function.
        /// </summary>
        public InputList<Inputs.FunctionJavaShowOutputGetArgs> ShowOutputs
        {
            get => _showOutputs ?? (_showOutputs = new InputList<Inputs.FunctionJavaShowOutputGetArgs>());
        ...
        /// </summary>
        [Input("targetPath")]
        public Input<Inputs.FunctionJavaTargetPathGetArgs>? TargetPath { get; set; }
        ...
        public FunctionJavaState()
        {
        }
        public static new FunctionJavaState Empty => new FunctionJavaState();
    }
}
