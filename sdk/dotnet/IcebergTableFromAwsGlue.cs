...
namespace Pulumi.Snowflake
{
    ...
    /// ```
    /// </summary>
    [SnowflakeResourceType("snowflake:index/icebergTableFromAwsGlue:IcebergTableFromAwsGlue")]
    public partial class IcebergTableFromAwsGlue : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<ImmutableArray<Outputs.IcebergTableFromAwsGlueDescribeOutput>> DescribeOutputs { get; private set; } = null!;
        ...
        /// </summary>
        [Output("parameters")]
        public Output<ImmutableArray<Outputs.IcebergTableFromAwsGlueParameter>> Parameters { get; private set; } = null!;
        ...
        /// </summary>
        [Output("showOutputs")]
        public Output<ImmutableArray<Outputs.IcebergTableFromAwsGlueShowOutput>> ShowOutputs { get; private set; } = null!;
        ...
        public IcebergTableFromAwsGlue(string name, IcebergTableFromAwsGlueArgs args, CustomResourceOptions? options = null)
            : base("snowflake:index/icebergTableFromAwsGlue:IcebergTableFromAwsGlue", name, args ?? new IcebergTableFromAwsGlueArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IcebergTableFromAwsGlue(string name, Input<string> id, IcebergTableFromAwsGlueState? state = null, CustomResourceOptions? options = null)
            : base("snowflake:index/icebergTableFromAwsGlue:IcebergTableFromAwsGlue", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static IcebergTableFromAwsGlue Get(string name, Input<string> id, IcebergTableFromAwsGlueState? state = null, CustomResourceOptions? options = null)
        {
            return new IcebergTableFromAwsGlue(name, id, state, options);
        }
    }

    public sealed class IcebergTableFromAwsGlueArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Default: fallback to Snowflake default - uses special value that cannot be set in the configuration manually (`Default`)) Specifies whether Snowflake should periodically refresh the Iceberg table metadata from the AWS Glue catalog. Available options are: "true" or "false". When the value is not set in the configuration the provider will put "default" there which means to use the Snowflake default for this value.
        /// </summary>
        ...
        public IcebergTableFromAwsGlueArgs()
        {
        }
        public static new IcebergTableFromAwsGlueArgs Empty => new IcebergTableFromAwsGlueArgs();
    }

    public sealed class IcebergTableFromAwsGlueState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Default: fallback to Snowflake default - uses special value that cannot be set in the configuration manually (`Default`)) Specifies whether Snowflake should periodically refresh the Iceberg table metadata from the AWS Glue catalog. Available options are: "true" or "false". When the value is not set in the configuration the provider will put "default" there which means to use the Snowflake default for this value.
        /// </summary>
        ...
        private InputList<Inputs.IcebergTableFromAwsGlueDescribeOutputGetArgs>? _describeOutputs;

        /// <summary>
        /// Outputs the result of `DESCRIBE ICEBERG TABLE` for the given Iceberg table.
        /// </summary>
        public InputList<Inputs.IcebergTableFromAwsGlueDescribeOutputGetArgs> DescribeOutputs
        {
            get => _describeOutputs ?? (_describeOutputs = new InputList<Inputs.IcebergTableFromAwsGlueDescribeOutputGetArgs>());
        ...
        [Input("parameters")]
        private InputList<Inputs.IcebergTableFromAwsGlueParameterGetArgs>? _parameters;

        /// <summary>
        /// Outputs the result of `SHOW PARAMETERS IN ICEBERG TABLE` for the given Iceberg table.
        /// </summary>
        public InputList<Inputs.IcebergTableFromAwsGlueParameterGetArgs> Parameters
        {
            get => _parameters ?? (_parameters = new InputList<Inputs.IcebergTableFromAwsGlueParameterGetArgs>());
        ...
        [Input("showOutputs")]
        private InputList<Inputs.IcebergTableFromAwsGlueShowOutputGetArgs>? _showOutputs;

        /// <summary>
        /// Outputs the result of `SHOW ICEBERG TABLES` for the given Iceberg table. Note that this value will be only recomputed whenever values of fields affecting the output change.
        /// </summary>
        public InputList<Inputs.IcebergTableFromAwsGlueShowOutputGetArgs> ShowOutputs
        {
            get => _showOutputs ?? (_showOutputs = new InputList<Inputs.IcebergTableFromAwsGlueShowOutputGetArgs>());
            set => _showOutputs = value;
        }

        public IcebergTableFromAwsGlueState()
        {
        }
        public static new IcebergTableFromAwsGlueState Empty => new IcebergTableFromAwsGlueState();
    }
}
